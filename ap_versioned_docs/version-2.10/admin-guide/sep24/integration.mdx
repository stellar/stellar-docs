...
### Quotes and Fees {#quotes-and-fees}
...
## Securing Platform API {#securing-platform-api}
...
## Making JSON-RPC Requests {#making-json-rpc-requests}
...
## Updating Deposit Transaction Via JSON-RPC {#updating-deposit-transaction-via-json-rpc}
...
### Ready to Receive Funds {#ready-to-receive-funds}
...
### Processing KYC Information {#processing-kyc-information}
...
### Waiting For User Funds {#waiting-for-user-funds}
...
### Sending Onchain Funds {#sending-onchain-funds}
...
### Sending Payment Via Custody Service {#sending-payment-via-custody-service}
...
### Sending Refund Via Custody Service {#sending-refund-via-custody-service}
...
### Expired Transaction {#expired-transaction}
...
### On-Hold Transaction {#on-hold-transaction}
...
## Updating Withdrawal Transaction Via JSON-RPC {#updating-withdrawal-transaction-via-json-rpc}
...
### Ready to Receive Funds {#ready-to-receive-funds-1}
...
### Offchain Funds Sent {#offchain-funds-sent}
...
### Offchain Funds Available {#offchain-funds-available}
...
### Offchain Funds Pending {#offchain-funds-pending}
...
### Sending Refund Via Custody Service {#sending-refund-via-custody-service-1}
...
### Transaction Error {#transaction-error-1}
...
### Expired Transaction {#expired-transaction-1}
...
### On-Hold Transaction {#on-hold-transaction-1}
...
### Transaction Recovery {#transaction-recovery-1}
...
## Tracking Stellar Transactions {#tracking-stellar-transactions}
