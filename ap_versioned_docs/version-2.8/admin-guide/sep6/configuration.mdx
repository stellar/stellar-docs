...
## Enable Programmatic Deposits & Withdrawals {#enable-programmatic-deposits--withdrawals}
...
### Modify a Stellar Info File {#modify-a-stellar-info-file}
...
### Modify the Assets Configuration File {#modify-the-assets-configuration-file}
...
### Managing Distribution Accounts {#managing-distribution-accounts}
...
### Enable Callbacks to the Business Server {#enable-callbacks-to-the-business-server}
...
## Test With the Demo Wallet {#test-with-the-demo-wallet}
