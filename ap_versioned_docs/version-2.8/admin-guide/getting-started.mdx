...
### Changing Port of the Platform Server {#changing-port-of-the-platform-server}
...
### Specify Your Service's Assets {#specify-your-services-assets}
...
### Configure Platform API Authentication {#configure-platform-api-authentication}
...
### Passing JVM flags {#passing-jvm-flags}
