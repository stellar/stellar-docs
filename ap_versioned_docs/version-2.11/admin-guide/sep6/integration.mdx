...
## Updating Deposit (Exchange) Transaction Via JSON-RPC {#updating-deposit-exchange-transaction-via-json-rpc}
...
### Verifying KYC Information {#verifying-kyc-information}
...
## Updating Withdrawal (Exchange) Transaction Via JSON-RPC {#updating-withdrawal-exchange-transaction-via-json-rpc}
