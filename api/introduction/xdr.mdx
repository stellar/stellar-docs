...
In Horizon, you will only encounter XDR when [posting](../resources/transactions/post.mdx) and [getting](../resources/transactions/single.mdx) transactions and in the [ledger](../resources/ledgers/index.mdx) header.
