...
In Horizon, you will only encounter XDR when [posting](../resources/submit-a-transaction.api.mdx) and [getting](../resources/retrieve-a-transaction.api.mdx) transactions and in the [ledger](../resources/ledgers/index.mdx) header.
