...
For operations that aren't in this list, you can usually refer to their corresponding entries in the [List of Operations](../../../../docs/fundamentals-and-concepts/list-of-operations) which will enumerate the failure cases and corresponding result codes.
