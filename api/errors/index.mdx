...
There are two categories of errors: [HTTP Status Codes](./http-status-codes/index.mdx) and [Result Codes](./result-codes/index.mdx). Result Codes only follow a Transaction Failed (400) HTTP Status Code.
