...
- `EVENT_BROKER_TYPE`: Specifies the type of event broker to be used. Options: "KAFKA", "SCHEDULER", "NONE". Defaults to "Kafka".
...
- `EVENT_BROKER_TYPE` - The type of event broker to use. Options: "KAFKA", "SCHEDULER", "NONE". Default: "KAFKA".
