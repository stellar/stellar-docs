...
## SDP Core Service {#sdp-core-service}
...
#### General Messaging Configuration {#general-messaging-configuration}
...
#### Dashboard Authentication Configuration {#dashboard-authentication-configuration}
...
### Event Broker and Scheduled Jobs Configuration {#event-broker-and-scheduled-jobs-configuration}
...
## Transaction Submission Service (TSS) {#transaction-submission-service-tss}
...
### Operational Configuration {#operational-configuration-1}
...
### Stellar Configuration {#stellar-configuration-1}
...
#### Channel Accounts Configuration {#channel-accounts-configuration}
...
#### Distribution Accounts Configuration {#distribution-accounts-configuration}
