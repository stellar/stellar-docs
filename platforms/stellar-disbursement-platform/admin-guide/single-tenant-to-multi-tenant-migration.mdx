...
## Preparing for the Migrations {#preparing-for-the-migrations}

### Halt the Single-Tenant Version 🚧 {#halt-the-single-tenant-version-}
...
### Remove Channel Accounts 🧹 {#remove-channel-accounts-}
...
### Database Backup & Setup 💾 {#database-backup--setup-}
...
#### Event Broker vs Scheduled Jobs {#event-broker-vs-scheduled-jobs}
...
#### Anchor Platform Version {#anchor-platform-version}
...
### Seggregation of Funds {#seggregation-of-funds}
...
#### Database Migrations & Population {#database-migrations--population}
...
### Executing Initial Database Migrations {#executing-initial-database-migrations}
...
#### Starting the SDP API server {#starting-the-sdp-api-server}
...
#### Posting to the Admin API {#posting-to-the-admin-api}
