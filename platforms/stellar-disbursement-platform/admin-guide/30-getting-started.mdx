...
> Note: please make sure to update the appropriate configuration on the Anchor Platform side, according with the [Anchor Platform Integration Points](anchor-platform-integration-points#manual-synchronization-of-custom-assets-and-wallets) guide.
