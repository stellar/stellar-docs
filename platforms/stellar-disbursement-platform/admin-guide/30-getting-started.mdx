...
Since version [`3.0.0`](https://github.com/stellar/stellar-disbursement-platform-backend/releases/tag/3.0.0), users can pay directly to Stellar wallet addresses rather than directing the users through the registration flow. This is useful for organizations that are paying receivers who already have Stellar wallets and don't need to create a new one.
