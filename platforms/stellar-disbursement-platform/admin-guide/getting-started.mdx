...
## Create and Fund a Host Distribution Account {#create-and-fund-a-host-distribution-account}
...
## Run the SDP Locally {#run-the-sdp-locally}
...
#### Stellar Accounts {#stellar-accounts}
...
## Create Your First Disbursement {#create-your-first-disbursement}
...
## Initiate SEP-24 Webflow {#initiate-sep-24-webflow}
...
## Next Up: Updating Application Secrets {#next-up-updating-application-secrets}
...
### Email and SMS Messages {#email-and-sms-messages}
...
#### Twilio Email (Send Grid) Configuration {#twilio-email-send-grid-configuration}
...
#### AWS SMS Configuration {#aws-sms-configuration}
...
#### AWS Email Configuration {#aws-email-configuration}
...
### Custom Assets and Wallets {#custom-assets-and-wallets}
...
### Wallet Address Registration {#wallet-address-registration}
