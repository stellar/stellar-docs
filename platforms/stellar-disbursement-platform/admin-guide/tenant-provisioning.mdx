...
### `base_url`, and `sdp_ui_base_url` {#base_url-and-sdp_ui_base_url}
...
### `owner_email`, `owner_first_name`, and `owner_last_name` {#owner_email-owner_first_name-and-owner_last_name}
...
## Fetching Tenants {#fetching-tenants}
...
## Updating Tenants {#updating-tenants}
