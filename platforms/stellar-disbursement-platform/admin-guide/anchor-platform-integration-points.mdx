...
## Role of the Anchor Platform in SDP {#role-of-the-anchor-platform-in-sdp}
...
## Steps for Configuring SDP-AnchorPlatform Integration {#steps-for-configuring-sdp-anchorplatform-integration}
...
## Manual Synchronization of Custom Assets and Wallets {#manual-synchronization-of-custom-assets-and-wallets}
