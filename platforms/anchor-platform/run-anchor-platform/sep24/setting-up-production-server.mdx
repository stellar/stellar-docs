...
To switch to Stellar's public (mainnet) network, all you have to do is change the network [passphrase](../../../../docs/encyclopedia/network-passphrases) (for authenticating requests) and [Horizon URL](https://horizon.stellar.org/).
