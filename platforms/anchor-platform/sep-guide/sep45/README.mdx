...
1. The **Client** requests a unique challenge from the **Server** which includes a list of authorization entries XDR-encoded string
...
6. The **Client** signs the authorization entry where `credentials.address.address` is the **Client Account** using the secret key of the signer for the **Client Account**
