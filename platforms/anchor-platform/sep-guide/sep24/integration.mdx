...
The payment processing system periodically checks if the trustline was configured. If it was, it may send a payment and change the status of the transaction to `pending_stellar`.
