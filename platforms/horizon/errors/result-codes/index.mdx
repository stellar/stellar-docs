...
There are three types of Result Codes: [Transaction Result Codes](./transactions.mdx), [Operation Result Codes](./operations.mdx), and [Operation-Specific Result Codes](./operation-specific/index.mdx).
...
| [Operation-Specific Result Codes](./operation-specific/index.mdx) | Errors specific to each operation type. |
