...
<iframe
  src="https://drive.google.com/file/d/tbd/preview"
  width="640"
  height="360"
  allow="autoplay"
></iframe>
...
1. Piyal demonstrated that Freighter has been integrated with [Soroswap](https://soroswap.finance/) to offer swap within the Freighter UI. The swap service was previously served by Stellar Dex.
...
4. The Router SDK finds the optimal path for the swap in terms of swap cost. 
