...
We are close to completing the implementation of Protocol 23 CAPs, the next step in the CAP lifecycle is voting by the Core CAP team. In this protocol meeting an update was provided on the CAPs and any final questions from the community was answered.
