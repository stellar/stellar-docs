...
**RWA market cap** — $2 billion at the time of the meeting, up from approximately $1.5 billion at the end of Q1 2026. That is nearly a 100% jump quarter over quarter and a 3x increase year over year from the $500 million mark in Q1 2025. The biggest single-quarter move across any metric in the report.
...
The Stellar Agents hackathon on DoraHacks just wrapped, with around 600 hackers submitting over 260 projects. The hackathon was focused on agentic payments using XRO-2 and MPP — the two protocols covered in the previous developer meeting. What the hackathon showed is what happens when you put those primitives in the hands of 600 builders from around the world.
...
The live explorer at [stellar8004.com](https://stellar8004.com) lets you browse registered agents, check reputation scores, interact with them, and leave feedback. Registered agents can also advertise XRO-2 and MPP payment support in their metadata, so agents can be discovered and paid per query in USDC.
...
Highlighted as one of the most polished projects from the CDMX hackathon, Talos is an autonomous agent corporation framework. It lets you create sub-agents and orchestrate them to act as corporate employees: dedicated agents for GTM strategy, marketing campaigns, engineering lead hiring, and so on. The payment layer runs on XRO-2. If you have worked with Paperclip or similar autonomous agent setups before, the mental model will be familiar. One of the most common questions at the CDMX hackathon was how to use AI to steer an entire project or company — Talos is one of the more complete answers that came out of that event.
