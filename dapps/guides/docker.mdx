...
To illustrate the process, let's take an example from our [Example Crowdfund Dapp](https://github.com/stellar/soroban-example-dapp/tree/main). In order to build the Docker image, you utilize a command that is encapsulated within our Makefile:
