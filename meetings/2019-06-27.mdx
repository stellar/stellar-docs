...
- CAP-15 and CAP-21 move to _Accepted_ today (after this meeting), barring no new concerns.
- CAP-21 moves back to _Draft_ in order to resolve CAP-22 prior to acceptance.
...
- [Original mailing-list discussion](https://groups.google.com/g/stellar-dev/c/va9Y7lkP4uI/m/K2W_AkvzCQAJ)
