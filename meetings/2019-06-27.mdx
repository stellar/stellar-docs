...
- [CAP-0015](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0015.md) and **CAP-0021** move to _Accepted_ today (after this meeting), barring no new concerns.
- **CAP-0021** moves back to _Draft_ in order to resolve [CAP-0022](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0022.md) prior to acceptance.
