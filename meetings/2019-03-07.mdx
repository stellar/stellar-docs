...
- [CAP-17: Update `LastModifiedLedgerSeq` If and Only If LedgerEntry is Modified](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0017.md) (Jonathan Jove)
...
- [CAP-8: Self Identified Pre-Auth Transaction](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0008.md) (Jeremy Rubin)
- [CAP-9: Linear/Exterior Immutable Accounts](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0009.md) (Jeremy Rubin)
...
- Current proposals:
  ...
  - [CAP-15: Bump Fee Extension](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0015.md) (OrbitLens)
