...
description: "This overview highlights Horizon API, Soroban RPC, and validator operations."
...
3. [Ongoing discussion](https://github.com/stellar/stellar-protocol/discussions/1480) about safely evicting and later restoring persistent contract state in [CAP-0057](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0057.md) by archiving it in Stellar’s History Archive and generating cryptographic proofs during preflight, without introducing a new storage system.
