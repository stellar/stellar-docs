...
- [CAP-19: Future-upgradable TransactionEnvelope type](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0019.md) is moving to Accepted.
...
- [CAP-20: Bucket Initial Entries](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0020.md) implementation is mostly there.

### Agenda

- [CAP-15: Bump Fee Extension](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0015.md): Modified to utilize [CAP-19: Future-upgradable TransactionEnvelope type](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0019.md). Goal is to bring it to a vote, or enumerate what is needed to make it pass.
