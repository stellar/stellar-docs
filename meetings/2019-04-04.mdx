...
- David to put together a list of constraints and concerns blocking [CAP-15](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0015.md) from moving forward with Nico.
