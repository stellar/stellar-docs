...
- There was initial discussion of going back to [SEP-16: Account Transfer Permissionless Payment Protocol (atp3)](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0016.md).
...
- David to put together a list of constraints and concerns blocking [CAP-15: Bump Fee Extension](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0015.md) from moving forward with Nico.
