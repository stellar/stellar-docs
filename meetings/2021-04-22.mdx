...
This meeting introduced two draft proposals—CAP-0037 and CAP-0038—both aiming to add constant-product liquidity pools to Stellar so that users can provide or consume liquidity without maintaining standing orders on the orderbook.
...
- [CAP-0037 – Automated Market Makers (Draft Proposal)](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0037.md)
- [CAP-0037 Discussion Thread](https://groups.google.com/g/stellar-dev/c/Ofb2KXwzva0/m/LLcUKWFmBwAJ)
- [CAP-0038 – Automated Market Makers (Draft Proposal)](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0038.md)
- [CAP-0038 Discussion Thread](https://groups.google.com/g/stellar-dev/c/NLE-nprRPtc/m/GHlmlE7ABwAJ)
