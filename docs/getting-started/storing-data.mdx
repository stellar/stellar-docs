...
entry's TTL is not periodically extended, the entry will eventually become "archived". You can learn more about this in the [State Archival](../fundamentals-and-concepts/state-archival.mdx) document.
