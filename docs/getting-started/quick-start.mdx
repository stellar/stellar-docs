...
:::caution The `soroban-sdk` is in early development. Report issues [here](https://github.com/stellar/rs-soroban-sdk/issues/new/choose). :::
...
:::info Hyphens in Rust crate names are replaced by underscores in code and generated file names, so `first-project` is outputted as `first_project.wasm`. :::
