...
To see the current status of Mainnet and Testnet, please see the [Stellar.org Dashboard](https://dashboard.stellar.org/) and the [Stellar Status](https://status.stellar.org/) for network and service uptime.
