...
sidebar_position: 10
title: Networks
description: The shared Stellar networks
---
...
| Soroban RPC | Please check our our [ecosystem providers] | https://soroban-testnet.stellar.org | https://rpc-futurenet.stellar.org |
| Friendbot API | N/A | https://friendbot.stellar.org | https://friendbot-futurenet.stellar.org |
| Validator(s) | `core-live-a.stellar.org` `core-live-b.stellar.org` `core-live-c.stellar.org` | `core-live-testnet.stellar.org` | `core-live-futurenet.stellar.org` |
