...
**_RPC Historical Access is a new option for those looking to retrieve full ledger history. Currently, only [getLedgers](https://developers.stellar.org/docs/data/apis/rpc/api-reference/methods/getLedgers) RPC method supports this feature. You can choose one of the providers above, or create your own getLedgers archive by following [these steps](https://developers.stellar.org/docs/data/apis/rpc/admin-guide/data-lake-integration)
