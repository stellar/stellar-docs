...
- Avoid the added overhead of directly interacting with [Stellar Core](../../validators), whose primary focus is performance and therefore provides a very limited API
- Avoid the added overhead of storing way more data than your application actually needs, as would be the case when running [Horizon](./horizon)
