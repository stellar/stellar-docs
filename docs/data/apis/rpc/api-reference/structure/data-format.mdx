...
In the Stellar network, transactions are encoded using a standardized protocol called [External Data Representation](/docs/learn/encyclopedia/data-format/xdr) (XDR).
