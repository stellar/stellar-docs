---
hide_title: true
description: Returns ledger entries for one or more provided LedgerKey values.
---
...
Suppose we've deployed the [`increment` example contract](../../../../../build/smart-contracts/getting-started/storing-data) and want to find out what value is stored in the `COUNTER` ledger key. To build the key:
