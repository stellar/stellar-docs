...
The source of truth should always be the XDR defined in the protocol. `LedgerKey`s are a union type defined in [Stellar-ledger-entries.x](https://github.com/stellar/stellar-xdr/blob/v23.0/Stellar-ledger-entries.x#L548). There are 10 different forms a ledger key can take:

{/* ⚠ missing specific reference pages */}
...
3. **Offer:** defines an offer made on the SDEX orderbook (see [Liquidity on Stellar](../../../../../learn/fundamentals/liquidity-on-stellar-sdex-liquidity-pools.mdx#orderbook))
...
6. **Liquidity Pool:** defines the configuration of a native constant liquidity pool between two assets (see [Liquidity on Stellar](../../../../../learn/fundamentals/liquidity-on-stellar-sdex-liquidity-pools.mdx#amms))
