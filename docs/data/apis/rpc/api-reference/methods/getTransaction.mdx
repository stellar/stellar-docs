...
(The following transaction hash is a random one I picked from the latest at the time of writing this doc) ![Lab Gettransaction RPC Screenshot](/assets/api/rpc/gettransaction.gif)
