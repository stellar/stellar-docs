...
| --- | --- | --- | --- | --- | --- |
| Horizon API Service | 4 vCPU | 16 GB | 100 GB SSD >= 3K IOPS | [c5d.xlarge] | [n4-standard-4](https://cloud.google.com/compute/docs/general-purpose-machines#n4-standard) |
...
| Node Type | CPU | RAM | Disk | AWS SKU | Google Cloud SKU |
| --- | --- | --- | --- | --- | --- |
| Horizon PostgreSQL | 4 vCPU | 32 GB | 2 TB\* SSD (NVMe or Direct Attached Storage) >= 7K IOPS | [i4g.xlarge](https://aws.amazon.com/ec2/instance-types/i4g) | [c3-highmem-8](https://cloud.google.com/compute/docs/general-purpose-machines#c3_machine_types) |
