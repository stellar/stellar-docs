...
The `StateChange` interface has 9 implementations. You must use inline fragments (`... on TypeName`) to access fields specific to each type. See the [Data Types](../structure/types.mdx#state-change-types) reference for the full list of implementations and their fields.
