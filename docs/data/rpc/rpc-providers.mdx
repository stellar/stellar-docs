...
SDF will not be providing a publicly available RPC endpoint for Mainnet. Developers should select an ecosystem provider that works for their project before migrating to Mainnet. In some cases, projects may choose to [run their own RPC instance](./admin-guide/README.mdx).
...
If you are interested in running your own RPC, please checkout [this page](./admin-guide/README.mdx).
