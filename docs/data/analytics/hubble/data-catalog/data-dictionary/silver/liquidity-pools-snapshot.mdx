...
| type | Mechanism that calculates pricing and division of shares for the pool. | STRING | constant_product | Yes | Initially only constant product pools are supported. Learn more at [Cap-38](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0038.md). |
