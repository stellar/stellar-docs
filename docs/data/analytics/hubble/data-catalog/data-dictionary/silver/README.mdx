...
1. Daily Snapshot Frequency: Snapshots run on a daily basis, meaning they capture inter-day changes, but not multiple changes that occur within the same day.

2. Potential Data Gaps: Most of the time, the data is correct and captures the day-to-day changes accurately. However, there can be cases where not all inter-day changes were captured, usually due to backfill issues or missing snapshot runs.
