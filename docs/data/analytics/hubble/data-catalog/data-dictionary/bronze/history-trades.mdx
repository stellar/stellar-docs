...
| selling_liquidity_pool_id_strkey | The unique StrKey (`L...`) identifier for a liquidity pool if the trade was executed against a liquidity pool instead of the orderbook. | string |  | No |  |
