...
| total_byte_size_of_live_soroban_state | The total size in bytes of the live Soroban state as of this ledger. | integer |  | No | Protocol 23 successor to `total_byte_size_of_bucket_list`. |
