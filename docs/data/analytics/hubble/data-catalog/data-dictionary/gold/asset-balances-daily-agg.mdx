...
| contract_balance | The sum of contract balance for a given asset. | FLOAT |  | No |  |
| total_accounts_with_contract_balance | The count of positive contract balance holders for a given asset. | INTEGER |  | No |  |
| total_accounts_with_trustline | The count of accounts holding a trustline for a given asset, including accounts with a zero balance. | INTEGER |  | No |  |
