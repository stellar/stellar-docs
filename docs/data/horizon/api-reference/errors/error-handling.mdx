...
- Transaction fees are also a safe adjustment. If you get a `tx_insufficient_fee` error, refer to the [Insufficient Fees and Surge Pricing](/docs/data/horizon/api-reference/errors/error-handling#insufficient-fees-and-surge-pricing) section later in this document.
