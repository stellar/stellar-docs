...
## Error Handling for Queries {#error-handling-for-queries}
...
## Error Handling for Transaction Submissions {#error-handling-for-transaction-submissions}
...
### Request Adjustments {#request-adjustments}
...
### Polling and Retrying Transactions {#polling-and-retrying-transactions}
...
#### Synchronous Transaction Submission {#synchronous-transaction-submission}
...
### Example: Using Time Bounds {#example-using-time-bounds}
...
### Example: Invalid Sequence Numbers {#example-invalid-sequence-numbers}
...
## Managing specific Errors {#managing-specific-errors}
...
### Insufficient fees and surge pricing {#insufficient-fees-and-surge-pricing}
