...
The single account endpoint provides information on a specific [account](../../../learn/fundamentals/stellar-data-structures/accounts.mdx). The balances section in the response will also list all the trustlines this account has established, including trustlines that haven’t been authorized yet.
