...
In Horizon, you will only encounter XDR when [posting](../submit-a-transaction.api.mdx) and [getting](../retrieve-a-transaction.api.mdx) transactions and in the [ledger](../resources/ledgers/README.mdx) header.
...
You can decode this XDR in the Stellar Lab’s [XDR page](https://www.stellar.org/laboratory#xdr-viewer).
