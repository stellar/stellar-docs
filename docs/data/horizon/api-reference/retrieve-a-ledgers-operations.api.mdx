...
This endpoint returns successful [operations](resources/operations/README.mdx) in a specific [ledger](../../../learn/fundamentals/stellar-data-structures/ledgers.mdx).
