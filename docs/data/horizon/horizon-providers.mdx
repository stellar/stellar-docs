...
\*_Please note that Blockdaemon provides full historical data on its Horizon. Please note that Blockdaemon combines Horizon and RPC in the same endpoint._
