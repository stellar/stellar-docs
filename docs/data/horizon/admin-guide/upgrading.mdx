...
### Assess current installation {#assess-current-installation}
...
### Determine the target version for upgrade {#determine-the-target-version-for-upgrade}
...
### Confirming the upgrade on single ingestion instance first {#confirming-the-upgrade-on-single-ingestion-instance-first}
...
### Upgrade all remaining instances {#upgrade-all-remaining-instances}
