...
## Multiple Instance Deployment {#multiple-instance-deployment}
...
### Ingestion Role Instance {#ingestion-role-instance}
...
### API Role Instance {#api-role-instance}
...
### Transaction Submission Role Instance {#transaction-submission-role-instance}
...
### `HISTORY_RETENTION_COUNT` {#history_retention_count}
...
## Passing Configurations to Horizon {#passing-configurations-to-horizon}
...
## Initialize Horizon Database {#initialize-horizon-database}
...
### Optional Postgres Configurations {#optional-postgres-configurations}
