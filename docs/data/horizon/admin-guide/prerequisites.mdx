...
## Single Instance Deployment Model {#single-instance-deployment-model}
...
#### Horizon Compute Instance: {#horizon-compute-instance}
...
#### PostgreSQL Database Server Compute Instance: {#postgresql-database-server-compute-instance}
