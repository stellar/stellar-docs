...
The `captiveStellarCoreBackend` can now be used to retrieve ledger data within a specified range. For detailed usage, refer to the [code samples](https://developers.stellar.org/docs/data/ingest-library/examples)
