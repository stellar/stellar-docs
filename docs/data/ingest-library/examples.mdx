...
The examples listed here might require a local instance of captive-core. At a minimum, you will need a `stellar-core` binary that has been compiled for your platform. Refer "admin guide" for more details.
