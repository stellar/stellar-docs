...
Additionally, even some information that is currently available from [Horizon](../apis/horizon/README.mdx) will also require indexing services in the future, as Horizon will be deprecated.
...
- [Horizon](../apis/horizon/README.mdx): as mentioned above, Horizon will soon be deprecated, but for now it is the only way to get some of this data.
