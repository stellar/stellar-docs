...
- [Goldsky]: one of the currently-most-loved options on Ethereum for this use-case. Goldsky provides [two main products](https://docs.goldsky.com/subgraph-vs-mirror):
  ...
  2. **Mirror**, also called **Pipelines**: a highly efficient tool to Extract, Transform, & Load (ETL) data into your own database. Goldsky Mirrors already support Stellar; learn more at [their documentation](https://docs.goldsky.com/chains/stellar).
...
While often referred to as _indexing_, you can also think of this category as _analytics_. Learn more in the [analytics documentation](../analytics/README.mdx) for solutions custom-tailored to this use-case.
