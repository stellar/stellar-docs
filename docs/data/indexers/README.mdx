...
<!--
# Backchannel: Leaving this commented-out because it's useful behind-the-scenes info, but not currently relevant for most readers of this page.
- [Goldsky]: mostly focused on indexer-use-case-#2 (see below), but has also expressed interest in potentially offering an API service specifically for Stellar. It's unclear if or when this might happen. This is something they've done in an ad-hoc way for other networks.
-->

- [OBSRVR]: a home-grown Stellar-native offering, providing both RPC services and [Obsrvr Gateway](https://www.withobsrvr.com/products/gateway), promising "powerful APIs for real-time data fetching, transaction processing, and easy integration into existing systems." <!-- Backchannel: The current maturity of this offering is hard to determine, as verification email never arrived. -->
...
- [The Graph]: one of the earliest and most popular-at-the-time options on Ethereum. They now offer three main products:
  ...
  The Graph offers <!-- Backchannel: [early-stage](https://github.com/streamingfast/substreams/issues/693) --> Stellar support for Substreams, with no current plans to expand Subgraph or Token API support to Stellar.
...
- [Goldsky]: one of the currently-most-loved options on Ethereum for this use-case. Goldsky provides [two main products](https://docs.goldsky.com/subgraph-vs-mirror):
  ...
  2. **Mirror**, also called **Pipelines**: a highly efficient tool to Extract, Transform, & Load (ETL) data into your own database. Goldsky Mirrors [already support Stellar](https://docs.goldsky.com/chains/stellar). <!-- Backchannel: As of Q4 2025, Goldsky is working closely with SDF to make their core Stellar datasets more accurate and useful. -->
...
- [SubQuery]: Decentralized Indexer SDK, Decentralized RPCs, & AI Apps. Supports 300+ chains; claims to be 3.9x faster than The Graph. The most direct and aggressive challenger to The Graph's decentralized model. Differentiates on speed and multi-chain support. <!-- Backchannel: Current Stellar support is so-so, with some early adopters leaving for Goldsky due to unoptimized RPC calls running up large bills with RPC providers. -->
...
- [Space and Time]: one challenge with most indexing approaches is the reintroduction of trusted 3rd parties into what is otherwise a verifiable, trustless software stack. Space and Time aims to fix this with "Proof of Indexing" and "Proof of SQL", using Zero-Knowledge proofs to offer tamper-proof computation for enterprises and dapps. Space and Time's Stellar [launched](https://www.spaceandtime.io/blog/space-and-time-enables-new-sophisticated-financial-apps-for-the-stellar-ecosystem) in Q4 2025.
...
While often referred to as _indexing,_ you can also think of this category as _analytics._ See the [analytics documentation](../../data/analytics) for solutions custom-tailored to this use-case.
