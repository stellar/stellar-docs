...
## 2. A Container Runtime (Recommended)
...
- An instance like AWS EC2 or GCP VM
- An OCI complaint container runtime installed on your instance, like Docker ([Docker installation guide](https://docs.docker.com/engine/install/)).
