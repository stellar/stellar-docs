...
2. **Rename and Update the Configuration**
   ...
   - **Key Settings Include:**
     ...
     - **Core Config (Optional)**
       ...
       If you wish to disable any of these parameters you can specify a custom core.cfg file to use that will override the default core parameters used with the Stellar Network specified in the `network` parameter.
