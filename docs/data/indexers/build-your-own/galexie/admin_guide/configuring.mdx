...
- Learn more about `core.cfg` quorum-set configuration in the [Choosing Your Quorum Set section](../../../../../validators/admin-guide/configuring.mdx#choosing-your-quorum-set).
