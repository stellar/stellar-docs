...
The Ingest SDK is currently a part of the [Stellar Go Repo](https://github.com/stellar/go), which includes several packages in addition to the ingest library. You will need to include the following in the `go.mod` file in your codebase.
