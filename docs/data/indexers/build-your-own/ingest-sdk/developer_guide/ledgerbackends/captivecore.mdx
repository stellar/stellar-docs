...
Using captive Core requires stellar-core binary to be installed. Since stellar-core is resource-intensive, it has specific hardware requirements outlined here: [Hardware Requirements](/docs/validators/admin-guide/prerequisites#hardware-requirements).
