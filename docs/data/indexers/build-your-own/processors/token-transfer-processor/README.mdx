...
Learn more about operational modes in the [Modes of Operation](#modes-of-operation) section.
...
The chronological ordering is critical for applications that need to maintain accurate balance tracking or audit trails. For detailed information about how events are ordered, learn more in the [Event Ordering](#event-ordering) section.
