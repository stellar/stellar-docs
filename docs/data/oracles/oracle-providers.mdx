...
Learn more in the [Band Protocol documentation](https://docs.bandchain.org) or visit the [Band Protocol GitHub repository](https://github.com/bandprotocol/band-std-reference-contracts-soroban).
