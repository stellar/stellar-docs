...
| Clustered Field(s) | source_account, transaction_id, type |
| Documentation | [dbt docs](https://hubble-261722.appspot.com/#!/source/source.stellar_dbt_public.crypto_stellar.history_operations) |
