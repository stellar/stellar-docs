...
| --- | --- |
| Primary Key(s) |  |
| Natural Key(s) | liquidity_pool_id, last_modified_ledger, ledger_entry_change |
| Partition Field(s) | batch_run_date (MONTH partition) |
| Clustered Field(s) | liquidity_pool_id, last_modified_ledger, asset_a_id, asset_b_id |
| Documentation | [dbt docs](https://hubble-261722.appspot.com/#!/source/source.stellar_dbt_public.crypto_stellar.liquidity_pools) |
