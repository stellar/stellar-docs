...
| Clustered Field(s) | contract_id, last_modified_ledger |
| Documentation | [dbt docs](https://hubble-261722.appspot.com/#!/source/source.stellar_dbt_public.crypto_stellar.contract_data) |
