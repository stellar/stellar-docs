...
| Clustered Field(s) | ledger_sequence, account, successful |
| Documentation | [dbt docs](https://hubble-261722.appspot.com/#!/source/source.stellar_dbt_public.crypto_stellar.history_transactions) |
