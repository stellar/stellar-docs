...
## Create a Report in Looker Studio {#create-a-report-in-looker-studio}

### Attach Data Sources to Looker Studio {#attach-data-sources-to-looker-studio}
...
### Create a New Report (Dashboard) {#create-a-new-report-dashboard}
...
### Use Custom SQL to Create a Chart {#use-custom-sql-to-create-a-chart}
...
### Applying a Global Filter {#applying-a-global-filter}
