...
<<<<<<<< HEAD:docs/data/hubble/optimizing-queries.mdx
Let’s say you wanted to profile the [types of operations](../../learn/fundamentals/transactions/list-of-operations.mdx) submitted to the Stellar Network monthly.
========
