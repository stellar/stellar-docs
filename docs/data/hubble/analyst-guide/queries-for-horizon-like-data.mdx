...
[Horizon](../../horizon/README.mdx) and [RPC](../../rpc/README.mdx) both provide API endpoints to retrieve data from the Stellar network. The following example queries retrieve the same data by using Hubble with the added benefit of being able to return historical data.

## Accounts {#accounts}

[horizon/accounts](../../horizon/api-reference/resources/accounts/README.mdx)
...
### General account information and XLM balance {#general-account-information-and-xlm-balance}
...
### Non-XLM asset balance information {#non-xlm-asset-balance-information}
...
### Account signer information {#account-signer-information}
...
### Retrieve an Account’s Transactions {#retrieve-an-accounts-transactions}
...
### Retrieve an Account’s Operations {#retrieve-an-accounts-operations}
...
### Retrieve an Account’s Payments {#retrieve-an-accounts-payments}
...
### Retrieve an Account’s Effects {#retrieve-an-accounts-effects}
...
### Retrieve an Account’s Offers {#retrieve-an-accounts-offers}
...
### Retrieve an Account’s Trades {#retrieve-an-accounts-trades}
...
[horizon/assets](../../horizon/api-reference/resources/assets/README.mdx)
...
### Getting Stellar Asset Contract Information for an Asset {#getting-stellar-asset-contract-information-for-an-asset}
...
### List All Claimable Balances {#list-all-claimable-balances}
...
### Retrieve a Claimable Balance {#retrieve-a-claimable-balance}
...
### Retrieve Related Operations and Transactions {#retrieve-related-operations-and-transactions}
...
[horizon/effects](../../horizon/api-reference/resources/effects/README.mdx)
...
### List All Ledgers {#list-all-ledgers}
...
### Retrieve a Ledger’s Transactions and Operations {#retrieve-a-ledgers-transactions-and-operations}
...
### Retrieve a Ledger’s Payments {#retrieve-a-ledgers-payments}
...
### List Liquidity Pools {#list-liquidity-pools}
...
### Retrieve a Liquidity Pool {#retrieve-a-liquidity-pool}
...
### Retrieve a Liquidity Pool’s Transactions and Operations {#retrieve-a-liquidity-pools-transactions-and-operations}
...
### Retrieve a Liquidity Pool’s Related Trades {#retrieve-a-liquidity-pools-related-trades}
...
### Retrieve an Offer {#retrieve-an-offer}
...
### Retrieve an Offer’s Trades {#retrieve-an-offers-trades}
...
[horizon/operations](../../horizon/api-reference/resources/operations/README.mdx)
...
### Retrieve an Operation {#retrieve-an-operation}
...
### Retrieve an Operation’s Effects {#retrieve-an-operations-effects}
...
[horizon/trades](../../horizon/api-reference/resources/trades/README.mdx)
...
[horizon/transactions](../../horizon/api-reference/resources/transactions/README.mdx)
...
### Retrieve a Transaction’s Operations {#retrieve-a-transactions-operations}
...
## Trade Aggregations {#trade-aggregations}
...
### List Trade Aggregations {#list-trade-aggregations}
...
### Retrieve Fee Stats {#retrieve-fee-stats}
...
### Contract Data Entries {#contract-data-entries}
...
### Contract Code Entries {#contract-code-entries}
