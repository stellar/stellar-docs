...
## [Analytical Platforms](../tools/developer-tools/analytical-platforms.mdx)

Analytical Platforms are specialized tools that process and make Stellar network data easy to use for analytics and dashboarding. The Stellar network data is loaded into database tables for large data analytics using SQL.

Analytical platforms are an easy, cost-effective choice for users. Check out several available analytical platforms for the Stellar network in our [Tools section](../tools/developer-tools/analytical-platforms.mdx).
