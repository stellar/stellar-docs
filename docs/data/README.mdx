...
To help you select the best product for your needs, please see which user journey fits you the best:

- [Analytics](#analytics) - Analyze historical data
- [Data Indexers](#dataindexers) - Quick access to curated data
- [APIs/RPCs](#apisrpcs) - Live streams of data
- [SDKs](#sdks) - Custom data processing pipelines

## Analytics

This section is for anyone that wants to do analysis on historical data such as year over year trend analysis. You essentially want access to an OLAP system.

- Full historical view of data
- Curated, normalized, and denormalized data
- Not concerned with real-time data

The main products that will be used:

- [Hubble](./hubble/README.mdx)
- [Ecosystem Data Indexers](./data-indexers/indexer-providers.mdx)

## Data Indexers

This section is for anyone that wants to create their own data index that you can host and provide to the rest of the ecosystem or use for your own application. You are trying to make your own [etherscan.io](https://etherscan.io/)

- Access to raw data to transform as you see fit
- You need both real-time data and historical data
...
This section is for anyone that wants to create their own application. This application can include Stellar network data as well as off-chain data. You essentially want a series of endpoints that you can use to build a new application.
