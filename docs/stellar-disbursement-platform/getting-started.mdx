...
In this guide, we'll help you set up your local workstation with a complete end-to-end development environment using pre-defined docker-compose files, the Stellar demo wallet, and USDC on Stellar's test network.
...
- create an SDP users
- set up a receiver account to accept funds
