...
In this guide, we'll help you set up your local workstation with a complete end-end development environment using docker-compose, Stellar demo-wallet, USDC on Stellar, and Stellar Testnet. Let’s bring up all the services.

Disclaimer: USDC and the Demo Wallet are used in the following walk-through demo as an example asset and wallet, though they are not the only options.
