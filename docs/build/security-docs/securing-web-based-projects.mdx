...
You must build your authentication securely if you have logins for users. The best way to do this is to use something off the shelf. Both [Ruby on Rails](https://auth0.com/blog/five-ruby-gems-for-authentication-and-authorization/#Authentication-Gems) and Django have robust, built-in authentication schemes.
