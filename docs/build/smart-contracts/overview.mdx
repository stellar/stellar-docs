...
:::tip[Prerequsite] To begin writing contracts, you must have:
...
_Learn more in the [Environment Concepts section](../../learn/encyclopedia/contract-development/environment-concepts.mdx)_.
