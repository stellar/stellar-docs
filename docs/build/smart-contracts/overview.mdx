...
For a comprehensive introduction to Stellar smart contracts, view the [Smart Contract Learn Section](../../learn/fundamentals/stellar-data-structures/contracts.mdx).
