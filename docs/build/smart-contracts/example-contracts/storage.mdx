...
sidebar_position: 9
title: Storage
description: Use storage to retain the value of a counter in an incrementer smart contract.
---
...
The [increment example](https://github.com/stellar/soroban-examples/tree/v23.0.0/increment) demonstrates how to call a contract from another contract.
...
If you have [`stellar-cli`](../getting-started/setup.mdx#install-the-stellar-cli) installed, you can deploy the contract, and invoke the contract function.
