...
#### Creating a Custom `POOL` Token for LP Shares {#creating-a-custom-pool-token-for-lp-shares}
...
#### Token Transfers to/from the LP Contract {#token-transfers-tofrom-the-lp-contract}
