...
[open-in-github-codespaces] https://github.com/codespaces/new?repo=stellar/soroban-examples&editor=web [open-in-code-anywhere] https://app.codeanywhere.com/#https://github.com/stellar/soroban-examples [liquidity pool example]: https://github.com/stellar/soroban-examples/tree/v22.0.1/liquidity_pool [source code]: https://github.com/stellar/soroban-examples/blob/v22.0.1/liquidity_pool/src/lib.rs#L143
