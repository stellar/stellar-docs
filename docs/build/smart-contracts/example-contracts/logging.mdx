...
Logs are not a substitute for step-through debugging. Rust tests for Soroban can be step-through debugged in your Rust-enabled IDE. Learn more in [testing].

:::

:::caution

Logs are not accessible by dapps and other applications. Learn more in the [events example] for how to produce structured events.
