...
If you have [`stellar-cli`](../getting-started/setup.mdx#install-the-stellar-cli) installed, you can deploy the contract and invoke its functions. Specify the `-v` option to enable verbose logs.
