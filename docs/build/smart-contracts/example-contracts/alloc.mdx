---
title: Allocator
description: Use the allocator feature in the SDK. The lightweight bump-pointer allocator can be used to emulate heap memory allocation in a Wasm smart contract.
sidebar_position: 80
---
