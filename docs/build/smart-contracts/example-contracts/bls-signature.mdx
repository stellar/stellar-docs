...
It is good to have a understanding of how a contract account works, but it is not required.
...
[account example]: https://github.com/stellar/soroban-examples/tree/v23.0.0/account
