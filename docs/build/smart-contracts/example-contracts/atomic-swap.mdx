---
title: Atomic Swap
description: Swap two tokens between two authorized parties atomically using the auth framework; the requested minimum price must be respected for both parties.
sidebar_position: 90
---
The [atomic swap example](https://github.com/stellar/soroban-examples/tree/v23.0.0/atomic_swap) swaps two tokens between two authorized parties atomically while following the limits they set.
...
Open the [`atomic_swap/src/test.rs`](https://github.com/stellar/soroban-examples/tree/v23.0.0/atomic_swap/src/test.rs) file to follow along.
