...
[open-in-github-codespaces] https://github.com/codespaces/new?repo=stellar/soroban-examples&editor=web [open-in-code-anywhere] https://app.codeanywhere.com/#https://github.com/stellar/soroban-examples [example demonstrates]: https://github.com/stellar/soroban-examples/tree/v22.0.1/hello_world [other example]: ../getting-started/setup.mdx
