...
Quick note about what this [example demonstrates](https://github.com/stellar/soroban-examples/tree/v23.0.0/hello_world). Maybe it's also based on some [other example](../getting-started/setup.mdx).
...
If you have [`stellar-cli`](../getting-started/setup.mdx#install-the-stellar-cli) installed, you can invoke contract functions using it.
