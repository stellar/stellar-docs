...
Learn more in the [tests](#tests) for an example of uploading the contract code programmatically. For the actual on-chain installation see the general deployment [tutorial](../../smart-contracts/getting-started/deploy-to-testnet.mdx).

### Authorization

:::info

For introduction to Soroban authorization learn more in the [auth tutorial](./auth.mdx).
