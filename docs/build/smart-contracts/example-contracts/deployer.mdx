---
title: Deployer
description: Deploy a smart contract on behalf of any other address using the SDK `deployer()` and initialize it atomically.
sidebar_position: 70
---
...
The [deployer example](https://github.com/stellar/soroban-examples/tree/v23.0.0/deployer) demonstrates how to deploy contracts using a contract.
...
If you have [`stellar-cli`](../getting-started/setup.mdx#install-the-stellar-cli) installed, you can invoke the contract function to deploy the test contract.
