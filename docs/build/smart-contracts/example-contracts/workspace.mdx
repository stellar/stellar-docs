...
### Contract A Interface: The Trait {#contract-a-interface-the-trait}
...
### Contract A: The Logic {#contract-a-the-logic}
...
### Contract B: The Invocation {#contract-b-the-invocation}
