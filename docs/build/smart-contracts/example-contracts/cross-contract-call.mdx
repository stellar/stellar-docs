...
description: Perform a cross contract call by invoking another contract using its contract ID.
---
...
The [cross contract call example](https://github.com/stellar/soroban-examples/tree/v23.0.0/cross_contract) demonstrates how to call a contract from another contract.
...
If you have [`stellar-cli`](../getting-started/setup.mdx#install-the-stellar-cli) installed, you can invoke contract functions. Both contracts must be deployed.
