...
### Contract A: The Contract to be Called {#contract-a-the-contract-to-be-called}
...
### Contract B: The Contract doing the Calling {#contract-b-the-contract-doing-the-calling}
...
## Build the Contracts {#build-the-contracts}
