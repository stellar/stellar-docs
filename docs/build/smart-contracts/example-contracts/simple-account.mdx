...
description: Walk through the simple Soroban account example to see how __check_auth can be implemented with one key.
sidebar_position: 15
---
...
1. Finish the [Setup](../getting-started/setup.mdx) checklist to install the Stellar CLI, Rust target, and required environment variables.
...
3. If you prefer not to install anything locally, launch the repo in [GitHub Codespaces](https://github.com/codespaces/new?repo=stellar/soroban-examples&editor=web) or [Codeanywhere](https://app.codeanywhere.com/#https://github.com/stellar/soroban-examples).
...
- [Complex account example](./complex-account.mdx) – adds multisig support and spend limits.
