...
sidebar_position: 50
title: Auth
description: Implement authentication and authorization into your smart contract using the Soroban Host-managed auth framework.
---
...
The [auth example](https://github.com/stellar/soroban-examples/tree/v23.0.0/auth) demonstrates how to implement authentication and authorization using the Soroban Host-managed auth framework.

This example is an extension of the [storing data example](../getting-started/storing-data.mdx).
...
Open the [`auth/src/test.rs`](https://github.com/stellar/soroban-examples/tree/v23.0.0/auth/src/test.rs) file to follow along.
...
If you have [`stellar-cli`](../getting-started/setup.mdx#install-the-stellar-cli) installed, you can invoke functions on the contract.
