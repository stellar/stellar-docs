...
[open-in-github-codespaces] https://github.com/codespaces/new?repo=stellar/soroban-examples&editor=web [open-in-code-anywhere] https://app.codeanywhere.com/#https://github.com/stellar/soroban-examples [storing data example]: ../getting-started/storing-data.mdx [auth example]: https://github.com/stellar/soroban-examples/tree/v22.0.1/auth
...
[Authorization documentation](../../../learn/encyclopedia/security/authorization.mdx) provides more details on how Soroban auth framework works.
