---
title: Custom Types
description: Define the data structures that can be stored on the ledger or used as inputs and outputs to contract invocations. They can be either structs or enums.
sidebar_position: 20
---
...
The [custom types example](https://github.com/stellar/soroban-examples/tree/v23.0.0/custom_types) demonstrates how to define your own data structures that can be stored on the ledger, or used as inputs and outputs to contract invocations. This example is an extension of the [storing data example](../getting-started/storing-data.mdx).
...
If you have [`stellar-cli`](../getting-started/setup.mdx#install-the-stellar-cli) installed, you can [deploy](../getting-started/deploy-to-testnet) and invoke contract function.
