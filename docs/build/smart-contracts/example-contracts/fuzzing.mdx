...
## Background: Fuzz Testing and Rust {#background-fuzz-testing-and-rust}
...
## Fuzz Testing Setup {#fuzz-testing-setup}
...
## A Simple Fuzz Test {#a-simple-fuzz-test}
...
## Interpreting `cargo-fuzz` Output {#interpreting-cargo-fuzz-output}
...
## Accepting Soroban Types as Input with the `SorobanArbitrary` Trait {#accepting-soroban-types-as-input-with-the-sorobanarbitrary-trait}
...
## A More Complex Fuzz Test {#a-more-complex-fuzz-test}
...
## Converting a Fuzz Test to a Property Test {#converting-a-fuzz-test-to-a-property-test}
