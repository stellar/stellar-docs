...
[open-in-github-codespaces] https://github.com/codespaces/new?repo=stellar/soroban-examples&editor=web [open-in-code-anywhere] https://app.codeanywhere.com/#https://github.com/stellar/soroban-examples [fuzzing example]: https://github.com/stellar/soroban-examples/tree/v22.0.1/fuzzing [`cargo-fuzz`]: https://docs.rs/cargo-fuzz [`arbitrary`]: https://docs.rs/arbitrary [`proptest`]: https://docs.rs/proptest [`proptest-arbitrary-interop`]: https://docs.rs/proptest-arbitrary-interop [timelock example]: https://github.com/stellar/soroban-examples/tree/v22.0.1/timelock
...
[contract's manifest]: https://github.com/stellar/soroban-examples/tree/v22.0.1/fuzzing/Cargo.toml
[fuzzing crate's manifest]: https://github.com/stellar/soroban-examples/tree/v22.0.1/fuzzing/fuzz/Cargo.toml
