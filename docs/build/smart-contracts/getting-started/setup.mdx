...
- **Rust toolchain v1.84.0 or higher** - The `wasm32v1-none` target requires Rust v1.84.0+. To check your version:
...
- **An editor that supports Rust** - See [Configure an editor](#configure-an-editor) below
- **Stellar CLI** - See [Install the Stellar CLI](#install-the-stellar-cli) below
