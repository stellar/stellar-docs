...
Stellar smart contracts are small programs written in the [Rust] programming language. :::tip[Prerequsite] To build and develop contracts you need the following:
...
Many editors support Rust, check out [Rust tools](https://www.rust-lang.org/tools) to know how to configure your editor

Here are the tools to you need to configure your editor:

1. [Visual Studio Code](https://code.visualstudio.com) as code editor.
...
:::card The latest stable release is [v{latestVersion}](https://github.com/stellar/stellar-cli/releases/latest). :::
