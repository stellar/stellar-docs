...
Stellar smart contracts are small programs written in the [Rust](https://www.rust-lang.org) programming language.
...
For other methods of installing [Rust](https://www.rust-lang.org), see: https://www.rust-lang.org/tools/install
