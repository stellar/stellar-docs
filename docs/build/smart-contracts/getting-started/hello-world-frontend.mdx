...
pagination_next: build/apps/tutorials/dapp-frontend
---
...
This example shows one way of creating a binding between a contract and a frontend, for a more comprehensive guide see the [Build a Dapp Frontend](../../apps/tutorials/dapp-frontend.mdx) documentation.
