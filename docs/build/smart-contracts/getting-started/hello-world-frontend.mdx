...
This example shows one way of creating a binding between a contract and a frontend. [Scaffold Stellar](../../../tools/scaffold-stellar.mdx) is a developer toolkit for building decentralized applications (dApps) and smart contracts on the Stellar blockchain, integrated with a frontend application. And for a more comprehensive guide to Dapp frontends, see the [Build a Dapp Frontend](../../apps/dapp-frontend.mdx) documentation.
