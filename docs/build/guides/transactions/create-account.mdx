...
(async function main() {
  try {
    const response = await server.requestFunds(parent.publicKey());
...
String FRIENDBOT_URL = "https://friendbot.stellar.org/?addr=";
String TESTNET_USDC_ISSUER = "GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5";
