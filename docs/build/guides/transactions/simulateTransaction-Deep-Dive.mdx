...
[Common `simulateTransaction` Errors, and more information can be found here.](https://developers.stellar.org/docs/learn/encyclopedia/errors-and-debugging/debugging-errors#1-simulate-transaction)
