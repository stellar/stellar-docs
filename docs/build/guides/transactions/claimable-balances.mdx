...
func main() {
	...
	fmt.Println("\nFunding account...")
	err = fundAccount(rpcClient, A.Address())
	panicIf(err)
...
func main() {
	...
	if len(resp.Entries) > 0 {
		...
		fmt.Printf("Number of claimants: %d\n", len(claimableBalance.Claimants))
...
func main() {
	...
	if CLAIMANT_SECRET == "PASTE_CLAIMANT_SECRET_HERE" {
		log.Fatal("Please paste the claimant secret key")
	}
