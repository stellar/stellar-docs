...
- For high risk calls, require the end user plus a policy signer; reject if either is missing.
...
- See these patterns applied in the [smart wallet examples](./smart-wallets/examples.mdx).
