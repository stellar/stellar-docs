...
- Explore reference implementations and libraries:
  - [OpenZeppelin Smart Account](https://docs.openzeppelin.com/stellar-contracts/accounts/smart-account) — modular signer/policy framework in [OpenZeppelin Stellar contracts](https://github.com/OpenZeppelin/stellar-contracts/)
  - [Smart Account Kit](https://github.com/kalepail/smart-account-kit) — TypeScript SDK for deploying and signing with smart accounts
