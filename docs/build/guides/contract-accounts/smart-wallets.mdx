...
- **OpenZeppelin Smart Account**: modular smart account framework for Stellar. Separates signers, context rules, and policies (multisig, spending limits) so you can mix and match authorization logic without rewriting the account.
