...
- [Contract authorization starter guide](../auth/contract-authorization.mdx) and [Authorization fundamentals](../../learn/fundamentals/contract-development/authorization/)
