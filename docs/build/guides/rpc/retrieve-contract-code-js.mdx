---
title: Retrieve a contract code ledger entry using the JavaScript SDK
hide_table_of_contents: true
description: Retrieve a contract code ledger entry using the JavaScript SDK.
---
