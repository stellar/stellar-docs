...
use soroban_sdk::{contract, contractimpl, contracttype, Address, BytesN, ContractExecutable, Env};
...
When upgrading a contract, the key function used is `env.deployer().update_current_contract`, which takes a [`ContractExecutable`](https://docs.rs/soroban-sdk/latest/soroban_sdk/enum.ContractExecutable.html) wrapping the Wasm hash of the new contract as a parameter. Here's a step-by-step breakdown of how this process works:
