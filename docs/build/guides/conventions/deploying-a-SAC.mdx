...
- `serialized_asset`is the Stellar `Asset` XDR serialized to bytes. Refer to `[soroban_sdk::xdr::Asset]` [XDR](https://github.com/stellar/rs-soroban-sdk/blob/main/soroban-sdk/src/xdr.rs)
