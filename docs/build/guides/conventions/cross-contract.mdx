...
## Contract as a dependency {#contract-as-a-dependency}
...
## Making a cross-contract call {#making-a-cross-contract-call}
...
## Depending on another contract {#depending-on-another-contract}
