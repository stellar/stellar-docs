...
description: Use a macro provided in the Rust SDK to write structured metadata and use the tools available to read and display this information to users.
---
