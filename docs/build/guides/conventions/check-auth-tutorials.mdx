...
## Tutorial 1: time based restriction on token transfers {#tutorial-1-time-based-restriction-on-token-transfers}
...
#### Setting time limits {#setting-time-limits}
...
#### Authorization policy verification {#authorization-policy-verification}
...
## Tutorial 2: implementing a smart wallet (WebAuthn) {#tutorial-2-implementing-a-smart-wallet-webauthn}
...
#### Contract structure and imports {#contract-structure-and-imports-1}
...
#### CustomAccountInterface implementation {#customaccountinterface-implementation}
...
#### Written explanation of code {#written-explanation-of-code}
