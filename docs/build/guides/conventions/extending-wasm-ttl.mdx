...
The code below uses Nodejs environment but same concept can also be applied in the browser using freighter wallet or using any other [Stellar SDK](/docs/tools/sdks/library).
...
Read more about the [Extend Footprint TTL operation](https://developers.stellar.org/docs/learn/encyclopedia/storage/state-archival#extendfootprintttlop) operation here.
