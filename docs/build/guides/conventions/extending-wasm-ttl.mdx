...
Read more about the Extend Footprint TTL operation [here](https://developers.stellar.org/docs/learn/encyclopedia/storage/state-archival#extendfootprintttlop).
