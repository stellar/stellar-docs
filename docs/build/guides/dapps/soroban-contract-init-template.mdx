...
## Search GitHub for other Soroban templates {#search-github-for-other-soroban-templates}
...
## Make your own template {#make-your-own-template}
...
### But first, how are these projects organized? {#but-first-how-are-these-projects-organized}
...
### 1. Initialize an NPM project {#1-initialize-an-npm-project}
...
### 3. Copy in the `initialize.js` script {#3-copy-in-the-initializejs-script}
...
#### A. `devDependencies` {#a-devdependencies}
...
#### E. `src/contracts/util.ts` {#e-srccontractsutilts}
...
### 6. Wait. Should the template actually use the contracts? {#6-wait-should-the-template-actually-use-the-contracts}
...
### 7. Make it as complex as you want! {#7-make-it-as-complex-as-you-want}
