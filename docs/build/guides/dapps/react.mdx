...
This guide will demonstrate how an [example crowdfund dapp](https://github.com/stellar/soroban-example-dapp) frontend was developed with React. While much of the code is specific to this project, the principles demonstrated should be educational enough to get you started.
...
Let's look at a component from the the [example crowdfund dapp](https://github.com/stellar/soroban-example-dapp), the [`MintButton` component](https://github.com/stellar/soroban-example-dapp/blob/07504b922bc75a48e5220711aea2cb4962f90367/components/molecules/form-pledge/index.tsx#L27):
