...
## Why managing state archival is important for applications {#why-managing-state-archival-is-important-for-applications}
...
## Methods of implementing state archival on the client side {#methods-of-implementing-state-archival-on-the-client-side}

### 1. Extending TTL from the smart contract {#1-extending-ttl-from-the-smart-contract}
...
#### Using the Extend TTL method in your Contract {#using-the-extend-ttl-method-in-your-contract}
...
### 2. Restoring archived data {#2-restoring-archived-data}
...
#### Step 1: Set up the SDK and Freighter {#step-1-set-up-the-sdk-and-freighter}
...
#### Step 2: Create a helper function for restoration {#step-2-create-a-helper-function-for-restoration}
...
#### Step 3: Use the helper function in your dapp {#step-3-use-the-helper-function-in-your-dapp}
...
#### Step 4: Handling contract instance restoration {#step-4-handling-contract-instance-restoration}
