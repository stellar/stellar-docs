...
### The role of frontend in Stellar dapps {#the-role-of-frontend-in-stellar-dapps}
...
### Importance of user interface and user experience {#importance-of-user-interface-and-user-experience}
...
### Setup HTTPS on Localhost {#setup-https-on-localhost}
...
### Installing Stellar SDK and other dependencies {#installing-stellar-sdk-and-other-dependencies}
...
## 3. Building basic interface elements {#3-building-basic-interface-elements}
...
### Implementing forms and inputs {#implementing-forms-and-inputs}
...
### Designing responsive layouts with Tailwind CSS {#designing-responsive-layouts-with-tailwind-css}
...
## 4. Basic Concepts of Soroban Contracts {#4-basic-concepts-of-soroban-contracts}
...
## 5. Integrating with Stellar blockchain {#5-integrating-with-stellar-blockchain}
...
### Setting up the Stellar SDK {#setting-up-the-stellar-sdk}
...
### Interacting with the Stellar network {#interacting-with-the-stellar-network}
...
### Reading events from the Stellar network {#reading-events-from-the-stellar-network}
...
## 6. Using Typescript Bindings {#6-using-typescript-bindings}
...
### How to create the bindings library {#how-to-create-the-bindings-library}
...
#### Scenario 1: I have the Contract ID but no code {#scenario-1-i-have-the-contract-id-but-no-code}
...
#### Scenario 2: I have the code {#scenario-2-i-have-the-code}
...
### SendTransaction and GetTransaction {#sendtransaction-and-gettransaction}
