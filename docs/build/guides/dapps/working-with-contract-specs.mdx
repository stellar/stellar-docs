...
For this guide, we will focus on the [Java](/docs/tools/sdks/client-sdks.mdx#java-sdk), [Python](/docs/tools/sdks/client-sdks.mdx#python-sdk), and [PHP](/docs/tools/sdks/client-sdks.mdx#php-sdk) SDKs for reference, but the concepts can also be applied to other languages.
