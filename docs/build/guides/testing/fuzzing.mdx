...
3. Run the fuzz coverage command that'll execute the corpus and write coverage data to the coverage directory.
...
To get code coverage of regular Rust tests, see [Code Coverage].
