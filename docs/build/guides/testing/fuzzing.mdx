...
For a full detailed example, learn more in the [fuzzing example].

:::

:::info

There is another tool for fuzzing Rust code, `cargo-afl`. Learn more in the [Rust Fuzz book] for a tutorial for how to use it.
...
To measure code coverage of regular Rust tests, learn more in the [Code Coverage section].
...
[Code Coverage section]: code-coverage.mdx
