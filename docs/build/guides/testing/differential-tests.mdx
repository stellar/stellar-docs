...
All contracts built with the Rust Soroban SDK have a form of differential testing built-in and enabled by default. Learn more in [Differential Testing with Test Snapshots].
