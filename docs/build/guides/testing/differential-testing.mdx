    ...
    assert_eq!(
        {
            ...
            client.increment();
            client.increment();
            client.increment() // Compare the result of the third increment with...
        },
        {
            ...
            client.increment();
            client.increment();
            client.increment() // ...the result of the third increment from the local version.
        },
    );
}
```
...
[integration tests]: integration-test.mdx
