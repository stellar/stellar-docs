...
Test snapshots are one tool for performing differential testing. Learn more in the [Differential Testing section] for other ways.
...
[Differential Testing section]: ./differential-tests.mdx
