...
Mutation testing is another form of coverage testing. See [Mutation Testing](mutation-testing.mdx).
...
Measuring code coverage in fuzz tests requires different tooling. See [Fuzzing](fuzzing.mdx).
