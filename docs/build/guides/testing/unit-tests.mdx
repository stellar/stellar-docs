...
Tests are written in Rust, alongside the contract. Same tools. Same APIs. Same SDK. No context switching! Use your favorite Rust tools, like the predicates library, fuzzing toolchain, or a step-through-debugger that you'd use for any Rust code.
