...
The [Soroban Rust SDK](../../../tools/sdks/contract-sdks.mdx#soroban-rust-sdk) makes it just as easy to integration test by providing utilities for testing against real contracts fetched from mainnet, testnet, or the local file system.
