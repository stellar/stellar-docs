...
For a deeper understanding of how authorization works, learn more in the [Security](../../../learn/fundamentals/contract-development/authorization.mdx) section.
...
That snippet highlights the key inputs: contract address, payload, signature, and authorization tree. For the full tests, learn more in the [Simple Account example](../../smart-contracts/example-contracts/simple-account.mdx); the Complex Account doc includes multisig and policy coverage.
...
Learn more about authorization details provided in `set_auths()` in the [Stellar Transactions](../../../learn/fundamentals/contract-development/contract-interactions/stellar-transaction.mdx) documentation.
