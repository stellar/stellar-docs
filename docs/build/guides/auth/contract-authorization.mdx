...
View the smart contract examples to see how `__check_auth()` could be implemented. The [contract account example](https://github.com/stellar/soroban-examples/tree/main/account) is a good starting point.
