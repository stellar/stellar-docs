...
## Query Events from Stellar RPC {#query-events-from-stellar-rpc}
...
## Store Events in the Database {#store-events-in-the-database}
...
## Run the Script with Cron {#run-the-script-with-cron}
