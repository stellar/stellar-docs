---
title: Stellar Asset Contract (SAC) Deployment from a Contract
sidebar_label: "Deploy a Stellar Asset Contract (SAC) from within a contract"
hide_table_of_contents: true
description: This is a step-by-step guide to help you deploy an SAC from within a smart contract on Stellar.
---
