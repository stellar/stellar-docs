...
This contract gets deployed, and the address might be (for example) `CBCGKTU6CD25S2E7SEMJ72MQUL4XEGAXAJ43GQE3HSYOZKZ4C4LOH756`. We can now set the SAC `Admin` address to this contract:
