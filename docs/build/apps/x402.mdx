...
The [OpenZeppelin Relayer](https://github.com/OpenZeppelin/relayer-plugin-x402-facilitator) is enabled as an x402 Facilitator on Stellar, allowing relayed and sponsored flows for x402 payments.
