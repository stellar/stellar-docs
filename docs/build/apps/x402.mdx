...
:::note Freighter Mobile does not currently support x402; use the Freighter browser extension. Mobile support is planned for a future release. :::

## x402 Facilitator

The [OpenZeppelin Relayer](https://github.com/OpenZeppelin/relayer-plugin-x402-) is enabled as an x402 Facilitator on Stellar, allowing relayed and sponsored flows for x402 payments.
