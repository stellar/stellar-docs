...
## The Ingestion SDK packages {#the-ingestion-sdk-packages}
...
## Ingestion project setup {#ingestion-project-setup}
...
### Ledger Metadata Export Pipeline {#ledger-metadata-export-pipeline}
...
#### Determine the Datastore {#determine-the-datastore}
...
#### Exporting network metadata to Datastore {#exporting-network-metadata-to-datastore}
...
### Ledger Metadata Consumer Pipeline {#ledger-metadata-consumer-pipeline}
