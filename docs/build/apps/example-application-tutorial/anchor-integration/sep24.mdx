...
**Source:** [`github.com/stellar/basic-payment-app/routes/dashboard/transfers/+page.svelte`](https://github.com/stellar/basic-payment-app/blob/main/src/routes/dashboard/transfers/+page.svelte)
