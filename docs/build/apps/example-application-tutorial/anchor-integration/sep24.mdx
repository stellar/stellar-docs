...
## Find the anchor's `TRANSFER_SERVER_SEP0024` {#find-the-anchors-transfer_server_sep0024}
...
## The user clicks "deposit" or "withdraw" {#the-user-clicks-deposit-or-withdraw}
...
## Retrieve the interactive URL {#retrieve-the-interactive-url}
...
## Launch the popup window and listen for a callback {#launch-the-popup-window-and-listen-for-a-callback}
...
## (Sometimes) Send a Stellar payment {#sometimes-send-a-stellar-payment}
