...
## Find the anchor's `TRANSFER_SERVER` {#find-the-anchors-transfer_server}
...
## Display interactive elements {#display-interactive-elements}
...
## A special SEP-6 modal component {#a-special-sep-6-modal-component}
...
### Launching the SEP-6 modal {#launching-the-sep-6-modal}
...
### Modal step 1: Transfer details {#modal-step-1-transfer-details}
...
### Modal step 2: Gather KYC information {#modal-step-2-gather-kyc-information}
...
### Modal step 3: Put KYC fields and report status {#modal-step-3-put-kyc-fields-and-report-status}
...
### Modal step 4: Submit transfer {#modal-step-4-submit-transfer}
...
### (Sometimes) Modal step 5: Send a Stellar payment {#sometimes-modal-step-5-send-a-stellar-payment}
