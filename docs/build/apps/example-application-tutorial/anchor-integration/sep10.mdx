...
## Prompt for authentication {#prompt-for-authentication}
...
## Requesting a challenge transaction {#requesting-a-challenge-transaction}
...
## Sign and submit the challenge transaction {#sign-and-submit-the-challenge-transaction}
...
## About the `webAuthStore` store {#about-the-webauthstore-store}
