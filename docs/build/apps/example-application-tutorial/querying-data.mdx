...
## fetchRecentPayments {#fetchrecentpayments}
...
## fetchAssetsWithHomeDomains {#fetchassetswithhomedomains}
...
## findStrictSendPaths {#findstrictsendpaths}
...
## findStrictReceivePaths {#findstrictreceivepaths}
...
## Query Stellar Expert {#query-stellar-expert}
