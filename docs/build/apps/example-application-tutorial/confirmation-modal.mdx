...
### Wrapping the rest of our app in the modal {#wrapping-the-rest-of-our-app-in-the-modal}
...
### Creating a reusable modal Svelte component {#creating-a-reusable-modal-svelte-component}
...
### Trigger the modal component at signup {#trigger-the-modal-component-at-signup}
...
### Customizing confirmation and rejection behavior {#customizing-confirmation-and-rejection-behavior}
