...
### Creating the `walletStore` store {#creating-the-walletstore-store}
...
### Creating the account on the Stellar network {#creating-the-account-on-the-stellar-network}
...
### Using the `walletStore` store {#using-the-walletstore-store}
