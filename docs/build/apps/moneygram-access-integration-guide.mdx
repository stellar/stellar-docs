...
### Stellar Reference Token {#stellar-reference-token}
...
### Installing the Wallet SDK {#installing-the-wallet-sdk}
...
## Custodial vs. Non-Custodial Applications {#custodial-vs-non-custodial-applications}
...
### Source & Destination of Funds {#source--destination-of-funds}
...
## Generate Stellar Keypairs {#generate-stellar-keypairs}
...
## Listen for the Close Notification {#listen-for-the-close-notification}
...
## Send or Receive Funds {#send-or-receive-funds}
...
### Poll Until MoneyGram is Ready {#poll-until-moneygram-is-ready}
...
## Fetch the Reference Number {#fetch-the-reference-number}
