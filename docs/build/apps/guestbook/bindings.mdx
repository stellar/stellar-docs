...
You can always customize this script to suit your needs. Check out the source code here (which has been documented with comments). Or, you can see the officially maintained version in the `soroban-template-astro` repository, as well.
