...
## Get Anchor Information {#get-anchor-information}
...
### 2. Still processing, or denied {#2-still-processing-or-denied}
...
### 3. Needs more KYC info {#3-needs-more-kyc-info}
...
## Providing KYC info {#providing-kyc-info}
...
## Start a withdrawal {#start-a-withdrawal}
...
### Tracking Transaction {#tracking-transaction}
...
### Fetching Transaction {#fetching-transaction}
