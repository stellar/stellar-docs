...
### Building Basic Transactions {#building-basic-transactions}
...
#### Modify Assets (Trustlines) {#modify-assets-trustlines}
...
#### Fund Testnet Account {#fund-testnet-account}
...
### Building Advanced Transactions {#building-advanced-transactions}
...
#### Sponsor Operations {#sponsor-operations}
...
### Using XDR to Send Transaction Data {#using-xdr-to-send-transaction-data}
...
## Accessing Horizon SDK {#accessing-horizon-sdk}
