...
The wallet SDK provides some extra functionality on top of the existing [Horizon SDK](/docs/tools/sdks). For interaction with the Stellar network, the wallet SDK covers only the basics used in a typical wallet flow. For more advanced use cases, the underlying [Horizon SDK](/docs/tools/sdks) should be used instead.
...
- [SEP-10](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0010.md): explored on [Stellar Authentication](/docs/build/apps/wallet/sep10) section
- [SEP-24](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0024.md): explored on [Hosted Deposit and Withdrawal](/docs/build/apps/wallet/sep24) section
- [SEP-6](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0006.md): explored on [Programmatic Deposit and Withdrawal](/docs/build/apps/wallet/sep6) section
- [SEP-12](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0012.md): explored on [Providing KYC info](/docs/build/apps/wallet/sep6#providing-kyc-info) subsection
- [SEP-38](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0038.md): explored on [Quote](/docs/build/apps/wallet/sep38) section

Besides the SEPs supported by the anchor class the wallet SDK also has support for the [SEP-7](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0007.md) protocol which is explored on [URI Scheme to facilitate delegated signing](/docs/build/apps/wallet/sep7) section.
