...
Note that the account created above will match the first criteria. If 2-3 schema were used, then second criteria would match. (In 2-3 schema, 3 servers are used and 2 of them are enough to recover key. This is a recommended approach.)
