...
The [Stellar Disbursement Platform](../../platforms/stellar-disbursement-platform/README.mdx) team is also experimenting with smart wallet implementations. In a feature branch, they've implemented a smart wallet contract that can also be used.
