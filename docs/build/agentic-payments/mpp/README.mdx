...
- **Stellar data**: Mercury by Xycloo Labs (full-history Soroban events and transactions) and Stellar Indexer by Creit Tech (classic liquidity pools and live Soroban contract storage), indexed data that Horizon and RPC do not provide.
- **AI models**: Anthropic Claude and OpenAI APIs.
