...
Secp256r1 support, in turn, further enables something extremely exciting: passkeys! The ability to sign transactions and access accounts with a passkey rather than using secret keys or seed phrases is a **huge** step forward in easing usability in blockchain without sacrificing security.
