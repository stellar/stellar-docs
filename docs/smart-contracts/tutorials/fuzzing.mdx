...
<head>
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/guides/testing/fuzz-testing"
  />
</head>
...
This is a fuzzing failure, indicating a bug in either the fuzzer or the program.
...
Depending on how your system is set up, you may or may not have this problem.
...
[`Error`]: https://docs.rs/soroban-sdk/latest/soroban_sdk/struct.Error.html
