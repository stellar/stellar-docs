---
title: As a dapp developer, prompt Freighter to sign transactions
...
1. Follow the setup instructions to [connect to the Futurenet](./connect-futurenet.mdx), if required during development.
