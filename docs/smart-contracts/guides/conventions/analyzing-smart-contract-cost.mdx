...
## Factors that influence smart contract cost:
...
Use events to store data that do not need to be accessed frequently. This reduces the number of storage operations and the cost of running your smart contract.
