...
**NB**: for this example , navigate to `contracts` and `deployer` and run the command `stellar contract build` to generate the target files.

3. Run Tests:

In the `deployer`, run the following command:
...
This will return the deployer address: `CBD33O4PTDMV7H7SLI4WM4CPC2PY47LT4MP3ICT7ITO7AKTZUYOJN6PR`.
