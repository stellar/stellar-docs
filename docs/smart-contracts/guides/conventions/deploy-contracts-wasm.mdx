---
title: Deploy a contract from installed Wasm bytecode using code
...
The [deployer example](https://github.com/stellar/soroban-examples/tree/v20.0.0/deployer) demonstrates how to deploy contracts using a contract.
