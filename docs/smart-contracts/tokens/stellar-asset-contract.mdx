...
[here](../../learn/smart-contract-internals/contract-interactions/stellar-transaction.mdx). The resulting token will have a
...
See the [authorization overview](../../learn/smart-contract-internals/authorization.mdx) and
