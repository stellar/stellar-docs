...
See the [authorization overview](../../learn/encyclopedia/security/authorization.mdx) and [auth example](../example-contracts/auth.mdx) for general information about authorization in Soroban.
