...
The Stellar network already has liquidity pool functionality built right in to the core protocol. [Learn more here](../../learn/encyclopedia/liquidity-on-stellar-sdex-liquidity-pools.mdx).
...
[installed]: ../getting-started/deploy-to-testnet.mdx#deploy
