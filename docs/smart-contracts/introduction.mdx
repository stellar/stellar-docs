...
Contracts are developed using a software development kit (SDK). The [Soroban SDK](../tools/sdks/library#soroban-rust-sdk) consists of a Rust crate and a command-line tool.
...
Invoke a Soroban contract by submitting a transaction that contains the new operation: [`InvokeHostFunctionOp`](../learn/fundamentals/list-of-operations#invoke-host-function).
