...
Join the discussion, ask questions, and share your own work with smart wallets in the [Stellar Developer Discord](https://discord.gg/stellardev) in the `#passkey` channel.
...
- Use the [app](https://superpeach.pages.dev/)
...
- Ask in the `#passkey` channel on [Discord](https://discord.gg/stellardev) for an access token
