...
Right now, the wallet that best supports Soroban is [Freighter](../guides/freighter/connect-futurenet.mdx). It is available as a Firefox Add-on, as well as extensions for Chrome and Brave. Go ahead and [install it now](https://freighter.app).
...
- Learn more about the [internal architecture and design](../../learn/smart-contract-internals/README.mdx) of Soroban.
