...
**Threshold**: Medium **Result**: `InvokeHostFunctionResult` **Parameters**:
...
**Threshold**: Medium **Result**: `ExtendFootprintTTLResult` **Parameters**:
...
**Threshold**: Medium **Result**: `RestoreFootprintResult` **Parameters**:
