...
Learn more about asset codes in the [Naming an Asset section](../../issuing-assets/control-asset-access#naming-an-asset)
...
The Soroban CLI can deploy a Stellar Asset Contract (SAC) for a Stellar asset that allows any Soroban smart contract to interact with that asset. Deploying the SAC for a Stellar asset enables that asset for use with smart contracts.
