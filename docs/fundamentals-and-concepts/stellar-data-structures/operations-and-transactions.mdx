...
In the Stellar network, transactions are encoded using a standardized protocol called External Data Representation (XDR). You can read more about this in our [XDR Encyclopedia Entry](../../encyclopedia/xdr).
