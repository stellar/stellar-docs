...
This documentation will walk you through how to build a wallet with the Wallet SDK (recommended) or an exmaple payment application with the JS Stellar SDK.
