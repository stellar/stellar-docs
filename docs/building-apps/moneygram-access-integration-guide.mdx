...
// First we create an anchor object to work with the anchor you are integrating
// with. In this case MoneyGram's Testnet server: "extstellar.moneygram.com"
...
// Finally, we authenticate using your wallet's SIGNING_KEY secret.
const authKey = SigningKeypair.fromSecret("WALLET_SIGNING_KEY_SECRET");
