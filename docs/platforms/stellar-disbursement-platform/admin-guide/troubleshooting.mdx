...
The distribution account must have sufficient XLM to cover the payment amount plus transaction fees. If your organization has more than one, check the account named in the payment's **Account** column.
