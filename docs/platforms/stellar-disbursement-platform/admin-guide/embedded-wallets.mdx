...
![Creating a disbursement with Embedded Wallet selected](/assets/sdp/embedded-wallets/disbursement.png)
...
![Invitation to create an embedded wallet with passkey](/assets/sdp/embedded-wallets/invitation.png)
...
![Verification prompt after wallet creation](/assets/sdp/embedded-wallets/verification.png)
