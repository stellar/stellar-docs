...
![Creating a disbursement with Embedded Wallet selected](/assets/sdp/embedded-wallet-disbursement.png)
...
![Invitation to create an embedded wallet with passkey](/assets/sdp/embedded-wallet-invitation.png)
...
![Verification prompt after wallet creation](/assets/sdp/embedded-wallet-verification.png)
