...
![Circle Configuration Banner](/assets/sdp/user-interface/circle-configuration-banner.png)
...
![Circle Configuration SDP Screenshot](/assets/sdp/user-interface/circle-configuration.png)
