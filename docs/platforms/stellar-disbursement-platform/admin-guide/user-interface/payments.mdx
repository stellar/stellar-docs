...
The list is scoped to the distribution account currently selected in the [account picker](./account-picker.mdx). You see the payments sent from that account.
