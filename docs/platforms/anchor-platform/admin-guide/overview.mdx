...
The Anchor Platform is the easiest and fastest way to deploy [anchor services](../../../learn/fundamentals/anchors.mdx) compatible with [Stellar Ecosystem Proposals (SEPs)](https://github.com/stellar/stellar-protocol/tree/master/ecosystem).
