...
Anchor Platform will only send events to clients listed in the client configuration. See the [client configuration documentation](../../sep-guide/sep10/README.mdx#config-with-client-attribution) for more information.
