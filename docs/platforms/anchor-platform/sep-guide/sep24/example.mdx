...
Run this with the platform server and database and initiate a new transaction with the [demo wallet](https://demo-wallet.stellar.org). Then, we'll send the token to our server.
...
The code for web UI can be found [here](https://github.com/stellar/sep24-reference-ui)

The code for the backend is a part of the Anchor Platform, and is available as a [submodule](https://github.com/stellar/java-stellar-anchor-sdk/tree/develop/kotlin-reference-server).
