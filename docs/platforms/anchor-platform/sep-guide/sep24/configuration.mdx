...
Next, let's modify `stellar.toml` file created [earlier](../sep1/README.mdx). Wallets need to know that SEP-24 functionality is supported by your business, and they also need to know all currencies you support.
...
The information provided for the `assets` value closely maps to the information that will be exposed to the wallet application using the [`GET /info`](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0024.md#info) SEP-24 endpoint. The Anchor Platform also uses this information to validate requests made to your service.
...
[![Demo Wallet Connected Anchor Platform](/assets/ap/anchor-platform-sep24-demo-wallet.png)](/assets/ap/anchor-platform-sep24-demo-wallet.png)
...
[![Demo Wallet Initiating Transaction](/assets/ap/anchor-platform-sep24-demo-wallet-widget.png)](/assets/ap/anchor-platform-sep24-demo-wallet-widget.png)
