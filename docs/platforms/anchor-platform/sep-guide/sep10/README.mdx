...
For the complete specification, learn more at [SEP-0010: Stellar Web Authentication](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0010.md).
...
**Testing Your Configuration**: You can test SEP-10 authentication using curl and Stellar CLI. Learn more about Stellar CLI in the [Stellar CLI documentation](../../../../tools/cli/README.mdx).
