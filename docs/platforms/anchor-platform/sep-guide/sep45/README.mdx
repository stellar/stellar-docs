...
For the complete specification, see [SEP-0045: Stellar Web Authentication for Contract Accounts](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0045.md).
...
An implementation of the SEP-45 contract is provided in the [Anchor Platform repository](https://github.com/stellar/anchor-platform/tree/main/soroban/contracts/web-auth). An instance of this contract is deployed at `CD3LA6RKF5D2FN2R2L57MWXLBRSEWWENE74YBEFZSSGNJRJGICFGQXMX` on testnet.

## Enable SEP-45

SEP-45 requires integration with Stellar RPC to simulate transactions. The Anchor Platform can connect to the Stellar RPC server of your choice. You can use a public Stellar RPC provider, or you can run your own. A list of public providers can be found [here](/docs/data/apis/rpc/providers.mdx).
...
| `STELLAR_NETWORK_RPC_URL` | _Required_ | The URL of the Stellar RPC server used to simulate transactions. You can use a public provider or run your own. A list of public providers can be found [here](/docs/data/apis/rpc/providers.mdx). |
...
| `SEP45_WEB_AUTH_CONTRACT_ID` | _Required_ | The contract ID of the SEP-45 contract. This contract must implement the `web_auth_verify` function as described in the [SEP-45 specification](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0045.md). |
...
`WEB_AUTH_CONTRACT_ID` - The contract ID of the SEP-45 contract. This is the contract that will be used to construct the challenge. The contract must implement the `web_auth_verify` function as described in the [SEP-45 specification](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0045.md). This should match `SEP45_WEB_AUTH_CONTRACT_ID`.
