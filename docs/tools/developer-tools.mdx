...
Auto-generated comprehensive reference documentation is available [here](https://github.com/stellar/soroban-tools/blob/main/docs/soroban-cli-full-docs.md).
...
[Okashi](https://soroban.stellar.org/docs/developer-tools)
...
Learn classic Stellar operations using code or the Laboratory in a gamified experience where you complete a series of increasingly difficult challenges.

### [Dapps Challenge](https://soroban.stellar.org/dapps)

A hands-on experience where you’ll experiment with Soroban's smart contracts environment, a Rust SDK, a CLI, and an RPC server. Learn how to write, test, and deploy smart contracts on Futurenet.

### [Fast, Cheap and 0ut 0f Control (FCA00C)](https://fastcheapandoutofcontrol.com/)

Learn smart contract development with three gamified series: the Soroban tutorial, RPCiege, and an asteroids console game.

### [Scaffold Soroban](https://soroban.stellar.org/dapps/scaffold-soroban)

A series of dapp demonstration videos that show basic Soroban functionalities in a structured, easy-to-follow manner, primarily focusing on how to construct and deploy Soroban contract invocations.
