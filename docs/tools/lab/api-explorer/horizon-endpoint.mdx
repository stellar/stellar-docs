...
When I click the **Submit** button, the endpoint returns the records of payments (learn more in the [api reference](../../../data/apis/horizon/api-reference/get-payments-by-account-id.api.mdx)../../../data/apis/horizon/api-reference/resources/payments/object.mdx) that were submitted successfully in the account in `JSON` format.
