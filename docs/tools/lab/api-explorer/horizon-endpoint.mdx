...
![Lab Horizon Lab Screenshot](/assets/lab/horizon/endpoints.png)
...
![Lab Horizon Docs](/assets/lab/horizon/view-docs.png)
...
![Lab Horizon Single Account](/assets/lab/single-account.png)
...
![Lab Horizon Single Account Response](/assets/lab/single-account-response.png)
...
![Lab Horizon Assets](/assets/lab/horizon/assets.png)

Let's inquire about one of the most popular assets on the Stellar network: Circle's USDC. To do this, enter `USDC` as the Asset Code and `GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN` as the Asset Issuer.

![Lab Horizon Assets](/assets/lab/horizon/assets-usdc.png)

When I click the **Submit** button, the `/assets` endpoint returns the `USDC` asset details in `JSON` format.

![Lab Horizon Assets](/assets/lab/horizon/assets-usdc-response.png)
