...
RPC URL is required to view the contract information. You can update or set the RPC URL in the network selector in the top right corner. See [RPC Providers](https://developers.stellar.org/docs/data/apis/rpc/providers).

:::

![Lab: Contract Explorer](/assets/lab/lab-contract-explorer.jpeg)
...
In the code editor, you can view the `README.md` file of the smart contract repository. You can further explore the code by opening it in a Dev Container, Codeanywhere, or by using the GitHub link (see the dropdown in the top right cornercorner of the editor view).
