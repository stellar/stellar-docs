...
OpenZeppelin Relayer is an open source framework for submitting Stellar transactions. Its Channels plugin adds parallel submission and automatic fee bumping. You can run both yourself, or you can use [Stellar Channels](https://docs.openzeppelin.com/relayer/guides/stellar-channels-guide), the managed service OpenZeppelin operates on top of them, where OpenZeppelin runs the pool of channel accounts and covers the fees under a fair use policy.
