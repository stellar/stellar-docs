...
Please also note, some macros such as `pausible` and `upgradable` also exist in the OpenZeppelin for Stellar Library: https://github.com/OpenZeppelin/stellar-contracts.

## OpenZeppelin Stellar Contracts and Extensions Crates

Coming soon. For now, plesae refer to the OpenZeppelin for Stellar Contracts Library: https://github.com/OpenZeppelin/stellar-contracts.
