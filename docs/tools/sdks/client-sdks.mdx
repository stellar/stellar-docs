...
- `stellar-xdr` – [Code](https://github.com/stellar/rs-stellar-xdr) | [Docs](https://docs.rs/stellar-xdr)
  ...
  Provides [XDR](../../learn/fundamentals/data-format/xdr) encode/decode and the reference implementation of [XDR-JSON](../../learn/fundamentals/data-format/xdr-json.mdx). **Maintained by SDF.**
