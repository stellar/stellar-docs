...
For other AI coding tools like Cursor, Windsurf, or Aider, you can use [OpenSkills](https://github.com/numman-ali/openskills)—a universal CLI that brings the Agent Skills system to any AI coding agent.
