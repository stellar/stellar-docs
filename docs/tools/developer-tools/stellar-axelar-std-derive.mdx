...
Please note for `Pausible`, and `Upgradable`, we recommend using OpenZeppelin's fully audited implementations here: https://github.com/OpenZeppelin/stellar-contracts.
