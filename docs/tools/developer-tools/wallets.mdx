...
Learn more in the [NEAR Intents docs](https://docs.near.org/chain-abstraction/intents/overview).
...
Learn more in the [DFNS docs](https://docs.dfns.co/d/api-docs/wallets/broadcast-transaction/stellar).
