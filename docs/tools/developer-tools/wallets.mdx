...
Stellar AppKit is also being extended with:

- **React Native, LynxJS, and Flutter** integrations
- **Walletless authentication** with social login and passkeys
- Built-in **KYC and compliance** capabilities
- A longer-term zero-knowledge-based compliance architecture for verifying requirements such as KYC status, age, and jurisdiction eligibility while minimizing sensitive data exposure
...
Follow this [guide](https://docs.privy.io/wallets/wallets/create/create-a-wallet) to create a Stellar wallet.
