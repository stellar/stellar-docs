...
These implementations will be released throughout the year, ensuring that Stellar developers have access to extensible contract options. All contracts and extensions are audited by OpenZeppelin’s security team, enhancing security and reliability of the contracts.
