...
Quickstart can operate in different network modes, and you need to decide which mode is suitable for your purpose before starting the container. The four available network modes are **_local_**, **_testnet_**, **_futurenet_** and **_pubnet_** (mainnet).
...
**Network Passphrase**<br /> The default network passphrase of the local network is:
...
**Root Account**<br /> The root account of the network is fixed to:
