...
**RWA (ERC-3643) Token**
The RWA token extends the standard fungible token functionality with regulatory features required for security tokens, including:
- Features:
...
- Components:
  ...
  - **Signers**: List of authorized signers (delegated address, or external
      signers)
  - **Policies**: Enforcement module attached to context rules
  - **Verifiers**: Trust contracts that validate signatures on behalf of smart
      accounts
