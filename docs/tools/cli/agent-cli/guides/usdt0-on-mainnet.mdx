...
USDT0 is a classic Stellar asset with a Stellar Asset Contract. Its supply is unified with USDT on other chains, minted and burned on Stellar by a LayerZero OFT contract. It is live on mainnet only. [USDT0 on Stellar](pathname:///launch/usdt0) is the source of truth for these values.
