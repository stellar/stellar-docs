...
On the [public network](../fundamentals-and-concepts/networks.mdx), where live users make live transactions, your next step would be to acquire XLM, which you can do by consulting our [section on lumens](https://stellar.org/learn/lumens). Because this tutorial runs on the [test network](../fundamentals-and-concepts/networks.mdx), you can get 10,000 test XLM from Friendbot, which is a friendly account funding tool.
