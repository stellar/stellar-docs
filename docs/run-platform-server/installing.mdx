...
To install Horizon, you have choices, we recommend the following for target infrastructure:
...
Refer to the list of [Horizon releases](https://github.com/stellar/go/releases) and [Core releases](https://github.com/stellar/stellar-core/releases). Copy the binaries to host PATH. **TODO - can we have prebuilt Core bins for amd/arm posted on GH releases for same ease of use as Horizon?**
