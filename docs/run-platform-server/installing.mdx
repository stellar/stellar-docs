...
- containerized:
  - non-Helm Chart, if the target envrironment for container to run does not support Helm chart usage, run the prebuilt docker image [dockerhub.com/stellar/stellar-horizon](https://hub.docker.com/r/stellar/stellar-horizon).
