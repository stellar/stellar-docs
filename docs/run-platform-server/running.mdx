...
Once you have [established the Horizon database](./configuring.mdx#initialize-horizon-atabase) and have [setup the horizon runtime on host](./configuring.mdx#pre-requisites), you're ready to run Horizon.
