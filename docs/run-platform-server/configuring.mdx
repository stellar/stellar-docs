...
In this scalable deployment variant, multiple instances of `stellar-horizon` will be running, each performing a subset of the roles.
...
Depending on how Horizon was installed, the method you perform to configure will differ:
