...
| **Horizon API** | [Multiple providers available](../data/apis/api-providers.mdx) | https://horizon-testnet.stellar.org | https://horizon-futurenet.stellar.org |
| **Stellar RPC** | [Third-party providers only](../data/apis/api-providers.mdx) | `https://soroban-testnet.stellar.org` | `https://rpc-futurenet.stellar.org` |
