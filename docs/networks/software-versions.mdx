...
| Freighter | `n/a` | `n/a` |
| Laboratory | `n/a` | `n/a` |
| Futurenet Network Passphrase | `Test SDF Future Network ; October 2022` | `n/a` |
| Testnet Network Passphrase | `Test SDF Network ; September 2015` | `n/a` |
| Mainnet Network Passphrase | `Public Global Stellar Network ; September 2015` | `n/a` |
