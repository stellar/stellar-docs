...
- Spec shaking v2 (`experimental_spec_shaking_v2`): The `export` argument on `#[contracttype]`, `#[contracterror]`, and `#[contractevent]` is deprecated; type visibility is now determined by reachability from the contract boundary. See the [SDK migration guide](https://docs.rs/soroban-sdk/latest/soroban_sdk/_migrating/v27_export/index.html).
...
- BN254 Elliptic Curve Operations: [CAP-79](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0079.md)
- Poseidon/Poseidon2 Hash Functions: [CAP-75](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0075.md)
