...
## Protocol 23 (Testnet only, Jul 17, 2025)
...
| --- | --- | --- |
| XDR | `v23.0` | `?` |
| Rust XDR | `23.0.0-rc.2` | `?` |
| Soroban Environment | `23.0.0-rc.2` | `?` |
| Stellar Core | `23.0.0rc4` | `debian: stellar-core_23.0.0-2587.rc4` |
| Soroban Rust SDK | `23.0.0-rc.2.2` | `?` |
| Stellar CLI | `23.0.0` | `rust crate: 23.0.0` |
| Stellar RPC | `v23.0.0-rc.2` | `?` |
| Stellar Horizon | `v23.0.0-rc2` | `debian - stellar-horizon_23.0.0~rc2-508`. |
| Stellar Quickstart | `main` | `?` |
