...
| XDR                        | `todo`                              |
| Rust XDR                   | `todo`                              |
| Soroban Environment        | `todo`                              |
| Stellar Core               | `stellar-core_23.0.0-2587.rc4`      |
| Soroban Rust SDK           | `todo`                              |
| Stellar CLI                | `todo`                              |
| Stellar RPC                | `v23.0.0-rc.2`                      |
| Stellar Horizon            | `stellar-horizon_23.0.0~rc2-508`    |
| Stellar Quickstart         | `todo`                              |
| Stellar JS Stellar Base    | `v14.0.0-rc.2`                      |
| Stellar JS Stellar SDK     | `v14.0.0-rc.3`                      |
| Freighter                  | `todo`                              |
