...
Ensure you have followed the [pre-requisite](./installation.mdx#helm-chart-installation) of installing the Helm cli tool and adding the Stellar chart repo to helm client, now deploy core to the cluster with chart:
...
--set global.image:core:tag=19.13.1-1454.c5b96ca08.focal \
