...
Tier 1 organizations are the organizations that are members of minimal quorums in the core of the Stellar network. This is an emergent property of the Stellar network that depends on the configurations of all the validators in the Stellar network.
