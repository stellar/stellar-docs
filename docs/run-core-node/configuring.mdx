...
Use the `NETWORK_PASSPHRASE` field to specify whether your node connects to the [testnet](../encyclopedia/testnet.mdx) or the public network. Your choices:

- `NETWORK_PASSPHRASE="Test SDF Network ; September 2015"`
- `NETWORK_PASSPHRASE="Public Global Stellar Network ; September 2015"`

For more about the Network Passphrase and how it works, check out the [glossary entry](../encyclopedia/network-passphrase.mdx).

## Validating

By default, Stellar Core isn't set up to validate. If you want your node to be a [Basic Validator](./index.mdx#basic-validator) or a [Full Validator](index.mdx#full-validator), you need to configure it to do so, which means preparing it to take part in [SCP](../encyclopedia/scp.mdx) and sign messages pledging that the network agrees to a particular transaction set.
