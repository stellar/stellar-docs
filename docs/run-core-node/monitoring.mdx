...
- `network` is the [network passphrase](../encyclopedia/network-passphrase.mdx) that this core instance is using to decide whether to connect to the testnet or the public network
