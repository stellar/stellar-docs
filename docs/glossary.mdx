...
See the [Assets section](./fundamentals-and-concepts/stellar-data-structures/assets) to learn more.
...
The fee the network charges per operation in a transaction. When the network is in surge pricing mode, the base fee varies based on an auction mechanism. When it's not, the base fee defaults to the network's minimum base fee, currently at 100 stroops per operation.
...
Learn more in our [Lumens section](./fundamentals-and-concepts/lumens#base-reserves).
...
See the [Clawback](./encyclopedia/clawbacks.mdx) Encyclopedia Entry for more information.
...
Learn more in our [Liquidity on Stellar](./encyclopedia/liquidity-on-stellar-sdex-liquidity-pools#sdex) Encyclopedia Entry.
...
Learn more in the [Ledgers section](./fundamentals-and-concepts/stellar-data-structures/ledgers).
...
Learn more about lumens in our [Lumens section](./fundamentals-and-concepts/lumens).
...
Learn more in our [Lumens section](./fundamentals-and-concepts/lumens#minimum-balance).

### Network capacity

The maximum number of operations per ledger, as determined by validator vote. Currently 1,000 operations for the pubnet and 100 operations for the testnet.
...
Learn more in our [Operations and Transactions](./fundamentals-and-concepts/stellar-data-structures/operations-and-transactions) section.
...
Learn more in our [Liquidity on Stellar: SDEX and Liquidity Pools Encyclopedia Entry](./encyclopedia/liquidity-on-stellar-sdex-liquidity-pools#orders).

### Orderbook

A record of outstanding orders on the Stellar network.

Learn more in our [Liquidity on Stellar: SDEX and Liquidity Pools Encyclopedia Entry](./encyclopedia/liquidity-on-stellar-sdex-liquidity-pools#order-books).
...
The Pubnet and Testnet each have their own unique passphrase, which are used to validate signatures on a given transaction.

Learn more about network passphrases in the [Network Passphrases Encyclopedia Entry](./encyclopedia/network-passphrases).
...
See the [Operation and Transaction Validity section](./fundamentals-and-concepts/stellar-data-structures/operations-and-transactions#preconditions) for more information.
...
Read more in our [Testnet & Pubnet section](./fundamentals-and-concepts/testnet-and-pubnet).
...
Learn more in our [SEPs section](./fundamentals-and-concepts/stellar-ecosystem-proposals).
...
See our [SCP section](./fundamentals-and-concepts/stellar-consensus-protocol) to learn more.
...
Read more about operation thresholds in the [Operations and Transactions section](./fundamentals-and-concepts/stellar-data-structures/operations-and-transactions#operations).

Learn more about quorum set validators in our [Stellar Consensus Protocol section](./fundamentals-and-concepts/stellar-consensus-protocol).
...
Read more about time bounds in our [Operation and Transaction Validity section](./fundamentals-and-concepts/stellar-data-structures/operations-and-transactions#transaction-and-operation-validity).

### Transaction

A group of 1 to 100 operations that modify the ledger state.

Read more in the [Operations and Transactions section](./fundamentals-and-concepts/stellar-data-structures/operations-and-transactions#transactions).
...
Learn more in our [Lumens section](./fundamentals-and-concepts/lumens#transaction-fees).
