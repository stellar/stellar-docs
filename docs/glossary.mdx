...
Learn more in our [SDEX, Liquidity Pools, and Path Payments Encyclopedia Entry](./encyclopedia/liquidity-on-stellar-sdex-liquidity-pools#sdex).
...
A core object that holds information to identify a specific ledgerEntry.
...
Learn more in our [Accounts section](./fundamentals-and-concepts/accounts#trustlines).
