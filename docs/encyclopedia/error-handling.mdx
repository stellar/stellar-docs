...
|---|---|---|
|`FAILED`|-1|One of the operations failed (see [List of Operations](#) for errors)|
...
|`INSUFFICIENT_BALANCE`|-7|Fee would bring account below minimum balance; see our section on [Lumens](#) for more info|
|`NO_ACCOUNT`|-8|Source account not found|
|`INSUFFICIENT_FEE`|-9|Fee is too small; see our section on [Lumens](#) for more info|
