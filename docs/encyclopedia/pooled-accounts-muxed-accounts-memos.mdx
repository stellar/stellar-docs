...
Note that many ecosystem products and services used memos in the past for this, but using muxed accounts is the current best practice. Memos can be used for other purposes, to learn more about this see the [Memos Encyclopedia Entry](#).
