...
You can set up an anchor by using the SDF-maintained [Anchor Platform](../anchoring-assets/anchor-platform.mdx), which is the easiest way to deploy an anchor service compatible with Stellar Ecosystem Proposals (SEPs).
