...
Learn more about signature weights in the [Signature and Multisig Encyclopedia Entry](../encyclopedia/signatures-and-multisig).

See how to do this in step five of the [Issuing an Asset Tutorial](./issuing-assets-tutorial).
