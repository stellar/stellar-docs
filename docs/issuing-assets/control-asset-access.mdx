...
Learn more about signature weights in the [Signature and Multisig Encyclopedia Entry](https://developers.stellar.org/docs/encyclopedia/signatures-multisig).

See how to do this in step five of the [Issuing an Asset Tutorial](https://developers.stellar.org/docs/issuing-assets/how-to-issue-an-asset).
