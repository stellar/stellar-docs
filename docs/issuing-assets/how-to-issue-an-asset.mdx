...
While anyone can create an asset, there may be real-world [compliance](../issuing-assets/anatomy-of-an-asset.mdx#compliance) implications relevant to your use case.
