...
1. [**Horizon Nodes**](../data/horizon/README.mdx) can be used for submitting transactions, as well as exposing a REST API service to query and retrieve network state.
2. [**Stellar RPC Nodes**](../data/rpc/README.mdx) can be used for simulating and/or submitting transactions, as well as exposing an RPC service to query and retrieve current network state.
...
## Node Setup Process {#node-setup-process}
...
#### Validating, no public archive {#validating-no-public-archive}
...
#### Validating, offers public archive {#validating-offers-public-archive}
