...
:::tip SCF Validator Awards

The [Stellar Community Fund Validator Awards Program](https://communityfund.stellar.org/validator-awards) can help offset startup costs. Phase 1 provides $6,000 in XLM to cover running 3 validators with history archives for 3 months. Phase 2 provides $12,000 for an additional 6 months. Applications are evaluated on your infrastructure plan, cost scoping, operational capability, and motivation.
...
You should also monitor your nodes' visibility on [Stellarbeat](https://stellarbeat.io), which other validators and SDF use to assess uptime and quorum health.
...
| [Stellarbeat](https://stellarbeat.io) | Public validator uptime and quorum monitoring |
...
- [ ] Verify your nodes appear correctly on [Stellarbeat](https://stellarbeat.io)
...
- [ ] Apply for [SCF Validator Awards](https://communityfund.stellar.org/validator-awards) if applicable
- [ ] Maintain 99.9%+ uptime for 3+ months, visible on Stellarbeat
...
| Stellarbeat | [stellarbeat.io](https://stellarbeat.io) |
| SCF Validator Awards | [communityfund.stellar.org/validator-awards](https://communityfund.stellar.org/validator-awards) |
