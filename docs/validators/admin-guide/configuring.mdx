...
## Choosing Your Quorum Set {#choosing-your-quorum-set}
...
### Validator Discovery {#validator-discovery}
...
### Home Domains Array {#home-domains-array}
...
### Validator Quality {#validator-quality}
...
### Automatic Quorum Set Generation {#automatic-quorum-set-generation}
...
### Quorum and Overlay Network {#quorum-and-overlay-network}
...
### Impact of Validator Quality on Nomination {#impact-of-validator-quality-on-nomination}
...
#### Validator Nomination Weight Example {#validator-nomination-weight-example}
