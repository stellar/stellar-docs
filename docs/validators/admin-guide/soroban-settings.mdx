...
```bash
curl -G 'http://localhost:11626/tx' --data-urlencode 'blob=<LINE_1_OUTPUT>'
curl -G 'http://localhost:11626/tx' --data-urlencode 'blob=<LINE_3_OUTPUT>'
curl -G 'http://localhost:11626/tx' --data-urlencode 'blob=<LINE_5_OUTPUT>'
curl -G 'http://localhost:11626/tx' --data-urlencode 'blob=<LINE_7_OUTPUT>'
```
...
```bash
curl -G 'http://localhost:11626/dumpproposedsettings' --data-urlencode 'blob=<LINE_9_OUTPUT>'
```
