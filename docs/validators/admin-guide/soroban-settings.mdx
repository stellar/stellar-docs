...
## Propose a Settings Upgrade {#propose-a-settings-upgrade}
...
### 1. Create an Upgrade Set {#1-create-an-upgrade-set}
...
### 2. Generate Settings Upgrade Transactions {#2-generate-settings-upgrade-transactions}
...
### 3. Submit Settings Upgrade Transactions {#3-submit-settings-upgrade-transactions}
...
### 4. Verify Proposed Upgrades {#4-verify-proposed-upgrades}
...
### 5. Schedule the Upgrades {#5-schedule-the-upgrades}
...
### 6. Update Stellar Expert {#6-update-stellar-expert}
...
## Examine a Proposed Upgrade {#examine-a-proposed-upgrade}
...
## Examine Current Settings {#examine-current-settings}
