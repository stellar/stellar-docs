...
## Interacting With Your Instance {#interacting-with-your-instance}
...
### Establish Connection to Other Peers. {#establish-connection-to-other-peers}
...
### Observing Consensus {#observing-consensus}
