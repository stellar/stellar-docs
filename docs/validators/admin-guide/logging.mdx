...
Please take a look at the [HTTP Commands reference](https://github.com/stellar/stellar-core/blob/master/docs/software/commands.md#http-commands) for more information about the partitions available for use in the `ll` command.
