...
| stellar-archivist-rs | none | installs the `stellar-archivist-rs` cli tool for scanning, repairing, and mirroring stellar-core history archives |
| stellar-archivist (deprecated) | none | installs the legacy Go `stellar-archivist` cli tool |
