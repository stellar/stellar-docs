...
## Important Notes on Network Wide Settings {#important-notes-on-network-wide-settings}
...
## Upgrading Soroban Settings {#upgrading-soroban-settings}
...
## Example Upgrade Command {#example-upgrade-command}
