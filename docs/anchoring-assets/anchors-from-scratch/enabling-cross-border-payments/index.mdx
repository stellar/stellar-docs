...
Unlike with SEP-24, SEP-31 involves a sending user (**SU**) and receiving user (**RU**), so both users' experience is described [here](../../anchoring-assets/anchoring-assets/enabling-cross-border-payments/setting-up-test-server/).
