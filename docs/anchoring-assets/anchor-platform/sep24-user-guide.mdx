...
In the next major release (version 3.0) of the Anchor Platform, we'll be replacing the `PATCH /transactions` Platform API endpoint with a JSON RPC endpoint that will simplify the request schema, provide better validiation of data, and make the interface easier to understand in general.
...
app.post("/transaction", async (req, res) => {
  ...
  let patchTransactionBody = {
    "id": "e26cf292-814f-4918-9b40-b4f76a300f98",
