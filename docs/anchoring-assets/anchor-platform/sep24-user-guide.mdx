...
Stellar provides an example business server implementation for SEP-24. It's split into 2 parts: web UI, accessible for the
end user and back-end implementation, used to get and push updates from/to the Anchor Platform.
...
## Interacting with Anchor Platform endpoints
