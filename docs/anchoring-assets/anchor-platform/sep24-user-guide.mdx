...
The Anchor Platform supports [PostgreSQL][postgresql] and [Aurora PostgreSQL][aurora] for use in production, but also supports [H2][h2] or [SQLite][sqlite] for use in development. For managing migrations, the Anchor Platform uses [Flyway][flyway].
