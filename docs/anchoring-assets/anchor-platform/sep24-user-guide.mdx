...
The easiest way to install the Anchor Platform is to pull the [docker image][anchor-platform-image]. SEP-24 support is not yet officially released, but is available using the `2.0.0-preview-1` tag.
