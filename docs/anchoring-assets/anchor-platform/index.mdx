...
The documentation for the Anchor Platform is a work in progress. Developers are welcome to dive into the code and existing documentation on the [github repository][anchor-platform-github], or if you're looking to build an on & off ramp service compatible with SEP-10, see our [getting started guide][sep24-getting-started].
