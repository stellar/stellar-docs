...
`SEP24_MORE_INFO_URL_BASE_URL` is the URL that the Anchor Platform will provide to wallet applications when they want to show information about a transaction your business provide. In the flow, user will open this Url after transaction has been initiated, and your business can show arbitrary information about the transaction in this web-widget.
