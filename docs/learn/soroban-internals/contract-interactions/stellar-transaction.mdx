...
Soroban's [authorization framework](../authorization.mdx)
...
[Soroban resource fee](../fees-and-metering.mdx).
...
`refundableFee` is to use the [`simulateTransaction` mechanism](transaction-simulation.mdx).
