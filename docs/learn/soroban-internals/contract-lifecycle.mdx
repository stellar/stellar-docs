...
<head>
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/soroban-internals/contract-lifecycle"
  />
</head>
...
See the [Upgrading Contracts](https://soroban.stellar.org/docs/guides/conventions/upgrading-contracts) page for details on this.
