...
The [custom types example] demonstrates how to define your own types. [custom types example]: https://soroban.stellar.org/docs/tutorials/custom-types.mdx

:::

:::info

Error enum types are another type contracts can define that have some unique behaviors. See [Errors] for more information. [Errors]: ../errors.mdx
