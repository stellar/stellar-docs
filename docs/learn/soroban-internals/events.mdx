...
<head>
  ...
  <link
    rel="canonical"
    href="https://soroban.stellar.org/docs/soroban-internals/events"
  />
</head>
...
example](https://soroban.stellar.org/docs/tutorials/events) to learn more about how to emit an event
in your contract.
...
Due to the fact that a node with diagnostic events enabled will be executing code
