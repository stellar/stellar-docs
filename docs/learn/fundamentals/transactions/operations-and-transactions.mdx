...
## Operations and transactions: how they work {#operations-and-transactions-how-they-work}
...
## Transaction and operation validity {#transaction-and-operation-validity}
...
#### Minimum sequence number {#minimum-sequence-number}
...
#### Minimum sequence age {#minimum-sequence-age}
...
#### Minimum sequence ledger gap {#minimum-sequence-ledger-gap}
...
### Operation validity {#operation-validity}
...
#### The signatures on the transaction must be valid for the operation {#the-signatures-on-the-transaction-must-be-valid-for-the-operation}
...
#### The operation must be well-formed {#the-operation-must-be-well-formed}
...
#### The operation must be valid in the current protocol version of the network {#the-operation-must-be-valid-in-the-current-protocol-version-of-the-network}
...
#### Fee-bump (if applicable) {#fee-bump-if-applicable}
