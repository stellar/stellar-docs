...
description: How digital signatures authorize transactions, how threshold weights work, and how multisig setups protect accounts.
sidebar_position: 20
---
...
let's walk though creating a custodied solution akin to FT [`href`] and then break down the implications re CAP23 pending merges

:::

starting from minimal singing basis at https://developers.stellar.org/docs/build/guides/basics/create-account
...
const primaryPubKey =
  "GC5AT5GU7WI5NHHRM4XH2ALBOQS5I2MTLNYH5RTEJZC5LWCKVN52SVBV";
