...
Learn more about passive sell offers: [Liquidity on Stellar: the DEX and Liquidity Pools](../../encyclopedia/sdex/liquidity-on-stellar-sdex-liquidity-pools.mdx)
...
| Home domain | string | Sets the home domain of an account. See [Federation](../../encyclopedia/network-configuration/federation.mdx). |
...
Learn more [here](../../encyclopedia/contract-development/contract-interactions/stellar-transaction.mdx#invokehostfunctionop).
