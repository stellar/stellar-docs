...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.CreateAccount) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.createAccount) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/CreateAccountOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#CreateAccount)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.Payment) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.payment) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/PaymentOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#Payment)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.PathPaymentStrictSend) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.pathPaymentStrictSend) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/PathPaymentStrictSendOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#PathPaymentStrictSend)  
**Threshold**: Medium  
...
| Path | list of assets | The assets (other than `send asset` and `destination asset`) involved in the path a route takes. For example, the conversion `AstroDollar` -> _CryptoToken_ -> _AstroEuro_ -> _GoldReserves_ -> `AstroPeso` uses three assets to send from dollars to pesos, included in the `path` [found](../../glossary.mdx#pathfinding). |
...
| `PATH_PAYMENT_STRICT_SEND_TOO_FEW_OFFERS` | -10 | There is no path of offers connecting the `send asset` and `destination asset`. Paths can contain up to 5 intermediate assets. |
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.PathPaymentStrictReceive) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.pathPaymentStrictReceive) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/PathPaymentStrictReceiveOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#PathPaymentStrictReceive)  
**Threshold**: Medium  
...
| `PATH_PAYMENT_STRICT_RECEIVE_UNDERFUNDED` | -2 | The source account (sender) does not have enough funds to send and still satisfy its selling liabilities. Note that if sending XLM, the sender must additionally maintain its minimum XLM reserve. |
...
| `PATH_PAYMENT_STRICT_RECEIVE_TOO_FEW_OFFERS` | -10 | There is no path of offers connecting the `send asset` and `destination asset`. Paths can contain up to 5 intermediate assets. |
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.ManageBuyOffer) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.manageBuyOffer) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/ManageBuyOfferOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#ManageBuyOffer)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.ManageSellOffer) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.manageSellOffer) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/ManageSellOfferOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#ManageSellOffer)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.CreatePassiveSellOffer) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.createPassiveSellOffer) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/CreatePassiveSellOfferOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#CreatePassiveSellOffer)  
**Threshold**: Medium  
**Result**: `ManageSellOfferResult`  
**Parameters**:
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.SetOptions) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.setOptions) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/SetOptionsOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#SetOptions)  
**Threshold**: High if updating signers or other thresholds; Medium for everything else  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.ChangeTrust) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.changeTrust) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/ChangeTrustOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#ChangeTrust)  
**Threshold**: Medium  
...
Updates the authorization flag of an existing trustline. This operation can only be performed by the asset issuer.

Protocol 17 deprecated this operation in favor of [`SetTrustlineFlags`](#set-trustline-flags), in order to independently manipulate newer trustline flags.

**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.AllowTrust) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.allowTrust) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/AllowTrustOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#AllowTrust)  
**Threshold**: Low  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.AccountMerge) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.accountMerge) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/AccountMergeOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#AccountMerge)  
**Threshold**: High  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.ManageData) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.manageData) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/ManageDataOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#ManageData)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.BumpSequence) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.bumpSequence) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/BumpSequenceOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#BumpSequence)  
**Threshold**: Low  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.CreateClaimableBalance) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.createClaimableBalance) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/CreateClaimableBalanceOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#CreateClaimableBalance)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.ClaimClaimableBalance) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.claimClaimableBalance) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/ClaimClaimableBalanceOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#ClaimClaimableBalance)  
**Threshold**: Low  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.BeginSponsoringFutureReserves) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.beginSponsoringFutureReserves) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/BeginSponsoringFutureReservesOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#BeginSponsoringFutureReserves)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.EndSponsoringFutureReserves) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.endSponsoringFutureReserves) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/EndSponsoringFutureReservesOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#EndSponsoringFutureReserves)  
**Threshold**: Medium  
...
Removes or transfers the sponsoring account's sponsorship of existing [`ledgerEntries`](../stellar-data-structures/ledgers/entries.mdx) or signers.

The logic of this operation depends on the state of the source account.

Learn more about sponsored reserves: [Sponsored Reserves Guide](../../../build/guides/transactions/sponsored-reserves.mdx)

**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.RevokeSponsorship) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.revokeAccountSponsorship) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/RevokeAccountSponsorshipOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#RevokeSponsorship)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.Clawback) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.clawback) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/ClawbackOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#Clawback)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.ClawbackClaimableBalance) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.clawbackClaimableBalance) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/ClawbackClaimableBalanceOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#ClawbackClaimableBalance)  
**Threshold**: Medium  
**Result**: `ClaimClaimableBalanceResult`  
**Parameters**:
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.SetTrustLineFlags) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.setTrustLineFlags) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/SetTrustlineFlagsOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#SetTrustLineFlags)  
**Threshold**: Low  
...
Parameters to this operation depend on the ordering of assets in the liquidity pool: $\mathrm{A}$ refers to the first asset in the liquidity pool, and $\mathrm{B}$ refers to the second asset in the liquidity pool.

If the pool is empty, then this operation deposits `maxAmountA` of $\mathrm{A}$ and `maxAmountB` of $\mathrm{B}$ into the pool. If the pool is not empty, then this operation deposits at most `maxAmountA` of $\mathrm{A}$ and `maxAmountB` of $\mathrm{B}$ into the pool. The actual amounts deposited are determined using the current reserves of the pool. You can use these parameters to control a percentage of slippage.

Learn more about liquidity pools: [Liquidity Pools section](../liquidity-on-stellar-sdex-liquidity-pools.mdx)

**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.LiquidityPoolDeposit) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.liquidityPoolDeposit) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/LiquidityPoolDepositOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#LiquidityPoolDeposit)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.LiquidityPoolWithdraw) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.liquidityPoolWithdraw) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/LiquidityPoolWithdrawOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#LiquidityPoolWithdraw)  
**Threshold**: Medium  
...
- Upload reusable contract Wasm (`HOST_FUNCTION_TYPE_UPLOAD_CONTRACT_WASM`), and
- Deploy new contracts using available Wasm or built-in implementations (`HOST_FUNCTION_TYPE_CREATE_CONTRACT`).

:::info

Soroban transactions can only contain one operation per transaction.

:::

Learn more [here](../../fundamentals/contract-development/contract-interactions/stellar-transaction.mdx#invokehostfunctionop).

**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.InvokeHostFunction) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.invokeHostFunction) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/InvokeHostFunctionOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#InvokeHostFunction)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.ExtendFootprintTTL) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.extendFootprintTtl) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/ExtendFootprintTTLOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#ExtendFootprintTtl)  
**Threshold**: Medium  
...
**SDKs**: [Python](https://stellar-sdk.readthedocs.io/en/stable/api.html#stellar_sdk.operation.RestoreFootprint) | [JavaScript](https://stellar.github.io/js-stellar-base/Operation.html#.restoreFootprint) | [Java](https://javadoc.io/doc/network.lightsail/stellar-sdk/latest/org/stellar/sdk/operations/RestoreFootprintOperation.html) | [Go](https://pkg.go.dev/github.com/stellar/go-stellar-sdk/txnbuild#RestoreFootprint)  
**Threshold**: Medium  
