...
- Upload contract Wasm (`HOST_FUNCTION_TYPE_UPLOAD_CONTRACT_WASM`), and
- Deploy new contracts using uploaded Wasm or built-in implementations (`HOST_FUNCTION_TYPE_CREATE_CONTRACT`).
