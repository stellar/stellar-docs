...
Smart contract transactions on Stellar employ a different fee structure based on an inclusion fee and resource consumption (which includes [rent](#rent)). Learn more in the [Fees and Metering section](./fees-resource-limits-metering.mdx).
