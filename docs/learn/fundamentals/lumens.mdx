...
**`sdfMandate` -** The SDF Mandate is described in detail [here](https://stellar.org/foundation/mandate). The Foundation was funded by lumens generated at Stellar’s inception; all of those lumens will eventually be spent or distributed to enhance and promote Stellar.
...
Read [this blog post](https://stellar.org/blog/foundation-news/sdfs-next-steps) for more context around the SDF's resource allocation:

[![SDF mandate accounts](/assets/sdf/mandate-accounts.png)](https://stellar.expert/directory/tos?tag[]=sdf)
