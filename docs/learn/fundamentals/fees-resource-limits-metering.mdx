...
- **Ledger space rent:** the payment for the ledger entry TTL extensions (i.e., rent payments) and rent payments for increasing ledger entry size. Refer to the [state archival](../encyclopedia/storage/state-archival.mdx) section for more information about smart contract rent.
...
Find current resource fees in the [Resource Limits & Fees](../../networks/resource-limits-fees.mdx) page in the Reference section.
...
Find current resource limits in the [Resource Limits & Fees](../../networks/resource-limits-fees.mdx) page in the Reference section.
