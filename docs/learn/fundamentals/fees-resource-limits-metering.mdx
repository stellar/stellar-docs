...
It is recommended to apply [ledger bounds](./stellar-data-structures/operations-and-transactions.mdx#ledger-bounds) or [time bounds](./stellar-data-structures/operations-and-transactions.mdx#time-bounds) to transactions — either your transaction makes it to the ledger or fails, depending on your time and/or ledger parameters.
