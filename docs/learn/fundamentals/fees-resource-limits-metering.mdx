...
![Soroban Fees Diagram](/assets/diagrams/soroban-fees.png) _\* Diagram: Solid line boxes are what is actually present in the transaction, while dotted lines are derivable._
