...
"Classic" assets issued by Stellar accounts (`G...` addresses) and their built-in Stellar Asset Contract (SAC) implementation, and custom tokens issued by a deployed Wasm contract (`C...` addresses).
