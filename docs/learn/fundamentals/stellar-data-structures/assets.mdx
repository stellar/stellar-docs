...
Learn more about asset codes in the [Naming an Asset section](../../../tokens/issued/control-asset-access.mdx#naming-an-asset)
...
Learn more in the [SAC section](../../../tokens/issued/stellar-asset-contract.mdx).
...
Custom token contracts can be deployed on Stellar by deploying a contract that implements the [Token Interface](../../../tokens/custom/token-interface.mdx), which is the same interface implemented by the [Stellar Asset Contract (SAC)](../../../tokens/issued/stellar-asset-contract.mdx) for Stellar assets.
