...
## Using Stellar assets in smart contracts {#using-stellar-assets-in-smart-contracts}
...
## Relevance in Horizon and Stellar Client Libraries {#relevance-in-horizon-and-stellar-client-libraries}
...
## Deleting or burning assets {#deleting-or-burning-assets}

To delete, or "burn", an asset, you must send it back to the account that issued it.

## Custom token contracts {#custom-token-contracts}
