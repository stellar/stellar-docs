...
Learn about liquidity pool shares in the [Liquidity Pool Encyclopedia Entry](../../encyclopedia/liquidity-on-stellar-sdex-liquidity-pools.mdx).

Learn more about asset codes in the [Naming an Asset section](../../../issuing-assets/control-asset-access.mdx#naming-an-asset)
...
Learn more in the [SAC section in the Soroban docs](../../../smart-contracts/tokens/stellar-asset-contract.mdx).
...
Custom token contracts can be deployed on Stellar by deploying a contract that implements the [Token Interface](../../../smart-contracts/tokens/token-interface.mdx), which is the same interface implemented by the [Stellar Asset Contract (SAC)](../../../smart-contracts/tokens/stellar-asset-contract.mdx) for Stellar assets.
