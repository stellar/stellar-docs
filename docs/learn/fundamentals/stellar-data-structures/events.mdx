...
3. `DIAGNOSTIC` events are meant for debugging and will not be emitted unless the host instance explicitly enables it. Learn more in the Event Types section below.
