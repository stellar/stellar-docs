...
The fee the network charges per operation in a transaction. Calculated in stroops. Learn more in the [Fees section](../../fundamentals/fees-resource-limits-metering.mdx).
