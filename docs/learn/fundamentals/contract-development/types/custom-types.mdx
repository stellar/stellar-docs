---
sidebar_position: 20
title: "Struct, union, and enum types defined by contracts."
sidebar_label: "Custom Types"
description: "View the struct, union, and enum types that are usable as contract inputs, contract outputs, or for storage."
---
