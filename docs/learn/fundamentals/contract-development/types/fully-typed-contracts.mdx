---
sidebar_position: 30
title: Smart contract WASM files contain a machine-readable description of the interface type.
description: All smart contract interface types will be available on-chain right away with no secondary API calls to external services, no secondary API management, and more.
