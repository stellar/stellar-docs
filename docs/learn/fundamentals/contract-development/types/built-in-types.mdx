...
Built-in types are available to all contracts for use as contract function inputs and outputs, and are defined by the [environment](../environment-concepts.mdx) and the [Rust SDK](../../../../tools/sdks/contract-sdks.mdx#soroban-rust-sdk).
