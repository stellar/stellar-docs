---
sidebar_position: 10
title: Built-in types used as smart contract inputs and outputs.
sidebar_label: "Built-In Types"
description: Learn about the built-in types that are available in Soroban smart contracts, including primitive types, symbols, bytes, strings, vecs, maps, and addresses.
---
