---
sidebar_position: 20
title: "Debug smart contracts natively and as WASM."
sidebar_label: "Debugging Modes"
description: "Compile smart contracts natively for local testing or into WASM for deployment in order to debug."
---
