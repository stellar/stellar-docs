...
So instead of being invoked like other functions, its arguments are passed to `deploy_contract`, which deploys the contract and runs its constructor in the same invocation:
