---
sidebar_position: 50
title: "The process of developing, deploying, and maintaining smart contracts."
sidebar_label: "Contract Lifecycle"
description: "Learn about how smart contracts work from development to deployment to execution and then how to monitor and upgrade them."
---
...
[Verify your contract on StellarExpert](https://stellar.expert/explorer/public/contract/validation).

This GitHub Actions process compiles and optimizes your Stellar contract, publishes a GitHub release with the build artifacts and SHA256 hashes, and sends the hash, repo name, and commit to StellarExpert.

Once validated, StellarExpert displays a link to the exact GitHub commit so anyone can review the original source code and confirm it matches the deployed contract.
