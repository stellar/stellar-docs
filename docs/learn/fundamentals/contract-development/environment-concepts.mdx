---
sidebar_position: 7
title: The interface that defines objects, functions, and data available to smart contracts.
sidebar_label: "Environment Concepts"
description: Learn about the interface environment that defines the objects, functions, data sources, and more that are available in smart contracts.
---
