...
- SDF offers free [Horizon Testnet and Futurenet Instances](/network/horizon/horizon-providers#sdf-provided-horizon) to interact with the Testnet and Futurenet. The ecosystem has [Horizon providers](/network/horizon/horizon-providers#ecosystem-horizon-providers) whom offer instances for Testnet and Mainnet. You can [run your own Horizon](/network/core-node/admin-guide) or use an instance offered by an [infrastructure provider](/network/horizon/horizon-providers#ecosystem-horizon-providers).
