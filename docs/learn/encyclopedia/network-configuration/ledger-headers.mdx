...
## Ledger header fields {#ledger-header-fields}

### Version {#version}

The protocol version of this ledger.

### Previous ledger hash {#previous-ledger-hash}
...
### Transaction set result hash {#transaction-set-result-hash}
...
### Bucket list hash {#bucket-list-hash}
...
### Inflation sequence {#inflation-sequence}
