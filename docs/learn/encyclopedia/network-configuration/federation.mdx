...
## Federated addresses {#federated-addresses}
...
## Supporting federation {#supporting-federation}
...
## Federation Response {#federation-response}
...
## Looking up federation provider via a home domain entry {#looking-up-federation-provider-via-a-home-domain-entry}
