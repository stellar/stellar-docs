...
## Limited (ideally zero) dynamic memory allocation {#limited-ideally-zero-dynamic-memory-allocation}
...
## Non-standard I/O {#non-standard-io}
...
## Immediate panic {#immediate-panic}
...
## Pure-functional collections {#pure-functional-collections}
