...
### Unsigned 32-bit Integer (`u32`) {#unsigned-32-bit-integer-u32}

### Signed 32-bit Integer (`i32`) {#signed-32-bit-integer-i32}

### Unsigned 64-bit Integer (`u64`) {#unsigned-64-bit-integer-u64}

### Signed 64-bit Integer (`i64`) {#signed-64-bit-integer-i64}

### Unsigned 128-bit Integer (`u128`) {#unsigned-128-bit-integer-u128}

### Signed 128-bit Integer (`i128`) {#signed-128-bit-integer-i128}
...
## Bytes, Strings (`Bytes`, `BytesN`, `String`) {#bytes-strings-bytes-bytesn-string}
