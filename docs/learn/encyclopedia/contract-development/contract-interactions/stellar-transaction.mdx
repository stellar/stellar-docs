...
- Deploy new contracts using the uploaded Wasm or built-in implementations (this currently includes only the [token contract](../../../../tokens/issued/stellar-asset-contract.mdx)).
...
- [`Operation.createStellarAssetContract`](https://stellar.github.io/js-stellar-sdk/Operation.html#.createStellarAssetContract) and [`Operation.createCustomContract`](https://stellar.github.io/js-stellar-sdk/Operation.html#.createCustomContract) are abstractions to instantiate contracts: the former is for wrapping an existing [Stellar asset](../../../../tokens/issued/how-to-issue-an-asset.mdx) into a smart contract and the latter is for deploying your own contract.
