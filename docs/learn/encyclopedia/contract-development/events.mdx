...
Events are ephemeral, the data retention window is roughly 7 days. See the [ingestion guide](../../../build/guides/events/ingest.mdx) to learn how to work with this constraint.
