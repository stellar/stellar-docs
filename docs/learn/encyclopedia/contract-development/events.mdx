...
## How are events emitted? {#how-are-events-emitted}
...
## What are diagnosticEvents? {#what-are-diagnosticevents}
...
### When should diagnostic events be enabled? {#when-should-diagnostic-events-be-enabled}
