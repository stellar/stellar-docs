...
## General Transaction Flow {#general-transaction-flow}
...
## Detailed Soroban Errors {#detailed-soroban-errors}
...
### 2. Core Accepts the Transaction {#2-core-accepts-the-transaction}
...
### 3. Core Includes the Transaction in the Ledger {#3-core-includes-the-transaction-in-the-ledger}
...
### 4. Core Applies the Transaction to the Ledger {#4-core-applies-the-transaction-to-the-ledger}
