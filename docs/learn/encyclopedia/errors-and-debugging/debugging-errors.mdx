...
1. **Simulate Transaction (optional):**
   ...
   - **Common failures:** Simulate Transaction is akin to running transactions in Core with maxed-out resources, unrestricted ledger access, and no fees. Therefore, errors typically involve exceeding the network limit or encountering contract logic issues.
