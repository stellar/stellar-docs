...
### Existing transaction envelope (inner transaction) {#existing-transaction-envelope-inner-transaction}
...
### Fee-bump transaction envelope {#fee-bump-transaction-envelope}
...
## Validity of a fee-bump transaction {#validity-of-a-fee-bump-transaction}
...
## Example: implementing a fee-bump transaction {#example-implementing-a-fee-bump-transaction}
