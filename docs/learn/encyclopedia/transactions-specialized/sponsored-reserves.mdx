...
## Sponsored reserves operations {#sponsored-reserves-operations}

### Begin and end sponsorships {#begin-and-end-sponsorships}
...
## Effect on minimum balance {#effect-on-minimum-balance}
...
## Effect on claimable balances {#effect-on-claimable-balances}
...
### 1. Sponsoring trustlines {#1-sponsoring-trustlines}
...
### 2. Transferring sponsorship {#2-transferring-sponsorship}
...
### 3. Sponsorship revocation {#3-sponsorship-revocation}
...
### Sponsorship Source Accounts {#sponsorship-source-accounts}
