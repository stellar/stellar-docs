...
For more information on muxed accounts, see our [Pooled Accounts - Muxed Accounts & Memos Encyclopedia Entry](../../../build/guides/transactions/pooled-accounts-muxed-accounts-memos.mdx)
