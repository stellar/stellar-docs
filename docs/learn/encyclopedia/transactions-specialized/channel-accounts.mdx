...
for channelIndex, channels in enumerate(channelAccounts):
  ...
  # The channel index here is just iterating over channelAccountSecrets[]
...
func main() {
  ...
  // Channel index just iterates over the channelAccountSecrets slice
