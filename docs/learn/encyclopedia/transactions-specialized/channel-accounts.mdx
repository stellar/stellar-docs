...
Channel accounts let you reliably send transactions without waiting for submission acknowledgements. While this greatly increases your potential transaction rate, channels also introduce operational requirements. These considerations keep your operations in sync with Stellar Core while maintaining high throughput.

### Codified Restrictions

Review of internal systemic operations via _A_P_.

Also case of minimum sequence number preconditions, incl implications
