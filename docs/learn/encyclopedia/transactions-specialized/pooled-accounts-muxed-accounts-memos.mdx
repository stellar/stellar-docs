...
## Pooled accounts {#pooled-accounts}
...
#### Muxed Operations Model {#muxed-operations-model}
...
#### Muxed to Unmuxed {#muxed-to-unmuxed}
...
## Memo - differentiated accounts {#memo---differentiated-accounts}
...
## Why are muxed accounts better in the long term? {#why-are-muxed-accounts-better-in-the-long-term}
