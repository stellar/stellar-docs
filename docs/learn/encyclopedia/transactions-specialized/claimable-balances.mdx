...
There is no recovery mechanism for a claimable balance. [Currently](https://github.com/stellar/stellar-protocol/discussions/1504#discussioncomment-10117060), you cannot recover the balance if none of the predicates can be fulfilled. The reclaim example below acts as a safety net for this situation.
