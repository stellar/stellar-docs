...
Either party could also check the [`/effects`](../../../data/horizon/api-reference/list-all-effects.api.mdx) of the transaction, query [`/claimable_balances`](../../../data/horizon/api-reference/resources/claimablebalances/README.mdx) with different filters, etc.
