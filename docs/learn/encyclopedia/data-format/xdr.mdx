...
## JSON and XDR Conversion Schema {#json-and-xdr-conversion-schema}
...
### Key Characteristics of the JSON and XDR Conversion Schema {#key-characteristics-of-the-json-and-xdr-conversion-schema}
