...
## Contract Data Type Descriptions {#contract-data-type-descriptions}
...
## Contract Data Best Practices {#contract-data-best-practices}
...
## Contract Code and Contract Instance lifetimes {#contract-code-and-contract-instance-lifetimes}
...
## Behavior of transactions that try to access an archived Persistent entry {#behavior-of-transactions-that-try-to-access-an-archived-persistent-entry}
...
## Terms and Semantics {#terms-and-semantics}

### Live Until Ledger {#live-until-ledger}
...
#### Transaction resources {#transaction-resources-1}
...
### Example: My data is archived! {#example-my-data-is-archived}
...
### Example: My contract is archived! {#example-my-contract-is-archived}
