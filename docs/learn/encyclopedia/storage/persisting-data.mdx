...
## Footprints and parallel contention {#footprints-and-parallel-contention}
...
### Account State vs. Shared State {#account-state-vs-shared-state}
...
### Owned Contracts vs. Autonomous Contracts {#owned-contracts-vs-autonomous-contracts}
