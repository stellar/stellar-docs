...
transaction = TransactionBuilder(
  ...
  selling = Asset("AstroDollar", publicKey),
  buying = Asset.native(),
  amount = "50",
  price = "5.0" # 5 XLM per AstroDollar
...
(async function() {
  ...
  const transaction = new TransactionBuilder(account, {
    ...
    .addOperation({
      ...
      selling: new Asset('AstroDollar', publicKey),
      buying: Asset.native(),
      amount: '50',
      price: '5.0' // 5 XLM per AstroDollar
    })
...
public static void main(String[] args) throws Exception {
  ...
  Transaction transaction = new TransactionBuilder(account, Network.TESTNET)
    ...
    .addOperation(new ManageSellOfferOperation.Builder(
      new AssetTypeCreditAlphaNum4("AstroDollar", publicKey),
      new AssetTypeNative(),
      "50", // Sell 50 AstroDollar
      "5.0" // 5 XLM per AstroDollar
    ).build())
    .setTimeout(360)
    .build();
