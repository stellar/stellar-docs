...
The [founders](https://stellar.org/blog/foundation-news/introducing-stellar) of the network, particularly Jed McCaleb, understoof firsthand the quandaries of of centralized [order books](WIKIPEDIA_WHAT_IS_ORDER_BOOK_L@). IN 2012, Jed [wrote](https://bitcointalk.org/index.php?topic=108782.msg1182508#msg1182508): "One thing you can do with it is exchange bitcoins for fiat without the need of a centralized market such as mtgox. Which will be very useful for bitcoin" when disucssing preliminary ideas for Stellar.
