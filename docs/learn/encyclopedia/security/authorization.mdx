...
## Soroban Authorization Framework {#soroban-authorization-framework}
...
### Contract-Specific Authorization {#contract-specific-authorization}
...
#### Authorizing Sub-contract Calls {#authorizing-sub-contract-calls}
...
#### When to `require_auth` {#when-to-require_auth}
...
#### Authorizing Multiple `Address`es {#authorizing-multiple-addresses}
...
#### Types of Account Implementations {#types-of-account-implementations}
...
##### Transaction Invoker {#transaction-invoker}
...
### Secp256r1, passkeys and smart wallets {#secp256r1-passkeys-and-smart-wallets}
...
#### `require_auth` implementation details {#require_auth-implementation-details}
...
#### Matching Authorized Invocation Trees {#matching-authorized-invocation-trees}
