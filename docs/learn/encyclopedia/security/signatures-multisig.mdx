...
### Alternate signature types {#alternate-signature-types}
...
#### Pre-authorized Transaction {#pre-authorized-transaction}
...
### Example 1: Anchors {#example-1-anchors}
...
### Example 2: Joint accounts {#example-2-joint-accounts}
...
### Example 3: Expense accounts {#example-3-expense-accounts}
...
### Example 4: Company accounts {#example-4-company-accounts}
