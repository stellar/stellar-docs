...
## HTTP strict-transport-security headers {#http-strict-transport-security-headers}
...
## Lockdown unused ports {#lockdown-unused-ports}
...
## Scan your website and libraries for vulnerabilities {#scan-your-website-and-libraries-for-vulnerabilities}
...
## Cross-Site Request Forgery Protection (CSRF), SQL injections {#cross-site-request-forgery-protection-csrf-sql-injections}
