...
## Soroban and Hardhat Comparison {#soroban-and-hardhat-comparison}
...
### Soroban Framework {#soroban-framework}
...
## Hardhat vs. Soroban SDKs {#hardhat-vs-soroban-sdks}
...
### Soroban Scripts {#soroban-scripts}
...
### Soroban Testing {#soroban-testing}
...
## Developing Smart Contracts with Rust and Soroban {#developing-smart-contracts-with-rust-and-soroban}
...
### Vault Contract Deployment and Interaction {#vault-contract-deployment-and-interaction}
