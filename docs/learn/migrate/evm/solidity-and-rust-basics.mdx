...
The [Soroban Rust SDK](https://docs.rs/soroban-sdk/latest/soroban_sdk/index.html) supports a variety of [Built-In Types](../../smart-contract-internals/types/built-in-types.mdx) which consist of both Primitive and [Custom Types](../../smart-contract-internals/types/custom-types.mdx), such as:
...
To learn more about Rust's Contract Dialect, check out the [Contract Rust Dialect Page](../../smart-contract-internals/rust-dialect.mdx).
...
> _Note_: For a detailed explanation of the `Cargo.toml` configuration used in this tutorial, check out the [Hello World Example](https://soroban.stellar.org/docs/getting-started/hello-world#import-soroban-sdk-and-features).
