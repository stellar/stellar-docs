...
### Solidity Syntax {#solidity-syntax}
...
### A Brief Introduction to Modules, Macros, Structs, Traits, and Attribute Macros {#a-brief-introduction-to-modules-macros-structs-traits-and-attribute-macros}
...
### Smart Contract Dialect {#smart-contract-dialect}
...
## Writing and Interacting with Simple Smart Contracts {#writing-and-interacting-with-simple-smart-contracts}

In this section, we'll learn how to write and interact with simple smart contracts in Solidity and Rust.

### Writing a Smart Counter in Solidity {#writing-a-smart-counter-in-solidity}
...
### Interacting with the Solidity Smart Counter {#interacting-with-the-solidity-smart-counter}
...
### Writing a Smart Counter in Rust {#writing-a-smart-counter-in-rust}
...
### Interacting with the Rust Smart Counter {#interacting-with-the-rust-smart-counter}
