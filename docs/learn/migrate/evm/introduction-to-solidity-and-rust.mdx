...
You can learn more about Soroban's features and benefits in the [Soroban Overview](../../smart-contract-internals/high-level-overview.mdx).

## Setting Up the Development Environment for Rust and Soroban

To get started with Rust and Soroban, follow the steps on the [Setup Page](../../../smart-contracts/getting-started/setup.mdx).
