...
You can learn more about Soroban's features and benefits in the [Soroban Welcome Page](https://soroban.stellar.org/docs).

## Setting Up the Development Environment for Rust and Soroban

To get started with Rust and Soroban, follow the steps on the [Setup Page](https://soroban.stellar.org/docs/getting-started/setup).
