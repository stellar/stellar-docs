...
## Advanced Solidity Concepts {#advanced-solidity-concepts}
...
## Advanced Rust Concepts {#advanced-rust-concepts}
...
#### Inheriting Functionality from Other Crates {#inheriting-functionality-from-other-crates}
...
#### Inheriting Functionality using `contractimport!` {#inheriting-functionality-using-contractimport}
...
#### A Note on Inheritance and Composability {#a-note-on-inheritance-and-composability}
...
## Writing Safe and Efficient Rust Code for Smart Contracts {#writing-safe-and-efficient-rust-code-for-smart-contracts}
...
## Solidity to Soroban: Common Concepts and Best Practices {#solidity-to-soroban-common-concepts-and-best-practices}
...
### Address-Related Functionality {#address-related-functionality}
...
#### Why Soroban Differs {#why-soroban-differs}
...
### Time-Based Variables {#time-based-variables}
