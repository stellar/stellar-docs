...
_See_ [Claimable Balances Guide](../build/guides/transactions/claimable-balances.mdx).
...
Learn more in our [Liquidity on Stellar](./fundamentals/liquidity-on-stellar-sdex-liquidity-pools.mdx#orderbook) section.
...
An order to trade between two assets at a specific price. The order data structure can be retrieved from the network while active. Exchange execution decreases the offer amount.
...
Learn more in our [Liquidity on Stellar: SDEX and Liquidity Pools section](./fundamentals/liquidity-on-stellar-sdex-liquidity-pools.mdx#orderbook).
...
It is currently only done on marketable Core execution and in [Horizon aggregation](../data/apis/horizon/api-reference/aggregations/README.mdx).
...
A combination of native protocol features enabling seamless asset conversions.

Learn more in our [Liquidity on Stellar](./fundamentals/liquidity-on-stellar-sdex-liquidity-pools.mdx) section.
