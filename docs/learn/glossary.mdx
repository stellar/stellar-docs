...
An atomic swap is a decentralized method of exchanging one asset for another without the need for a trusted third-party intermediary. The process ensures that the interchange will either be completed fully by both parties or not at all&mdash;hence the term “atomic,” meaning indivisible. If one party fails to fulfill the required conditions, the trade is automatically canceled, and both parties retain their assets.
...
Learn more in the [Ledgers section](./fundamentals/stellar-data-structures/ledgers/index).
...
Learn more about network passphrases in the [Networks section](./fundamentals/networks.mdx#network-passphrases).
...
Read more in our [Networks section](./fundamentals/networks.mdx).
...
Read more in our [Networks](./fundamentals/networks.mdx).
