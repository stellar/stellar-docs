...
LedgerKey holds information to identify a specific LedgerEntry. It is a union that can be any one of the LedgerEntryTypes (Account, Trustline, Offer, Data, Claimable Balance, Liquidity Pool, Contract Data, Contract Code, Config Setting, or TTL).
