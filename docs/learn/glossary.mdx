...
See the [Assets section](./fundamentals/stellar-data-structures/assets) to learn more.
...
Learn more in our [Lumens section](./fundamentals/lumens#base-reserves).
...
Flags control access to an asset on the account level. Learn more about flags in our [Controlling Access to an Asset section](../issuing-assets/control-asset-access.mdx#controlling-access-to-an-asset-with-flags).
...
Learn more in the [Ledgers section](./fundamentals/stellar-data-structures/ledgers).
...
Learn more about lumens in our [Lumens section](./fundamentals/lumens).
...
Learn more in our [Lumens section](./fundamentals/lumens#minimum-balance).
...
Learn more in our [Operations and Transactions](./fundamentals/stellar-data-structures/operations-and-transactions) section.
...
See the [Operation and Transaction Validity section](./fundamentals/stellar-data-structures/operations-and-transactions#preconditions) for more information.
...
Read more in our [Networks section](./fundamentals/networks).
...
Learn more in our [SEPs section](./fundamentals/stellar-ecosystem-proposals).
...
See our [SCP section](./fundamentals/stellar-consensus-protocol) to learn more.
...
Read more in our [Networks](./fundamentals/networks).
...
Read more about operation thresholds in the [Operations and Transactions section](./fundamentals/stellar-data-structures/operations-and-transactions#operations).

Learn more about quorum set validators in our [Stellar Consensus Protocol section](./fundamentals/stellar-consensus-protocol).
...
Read more about time bounds in our [Operation and Transaction Validity section](./fundamentals/stellar-data-structures/operations-and-transactions#transaction-and-operation-validity).

### Transaction

A group of 1 to 100 operations that modify the ledger state.

Read more in the [Operations and Transactions section](./fundamentals/stellar-data-structures/operations-and-transactions#transactions).
...
Learn more in our [Lumens section](./fundamentals/lumens#transaction-fees).
...
Learn more in our [Accounts section](./fundamentals/stellar-data-structures/accounts#trustlines).

### TTL (Time To Live)

A smart contract's TTL is how many ledgers remain until the data entry is no longer live.

Read more in the [State Archival section](./smart-contract-internals/state-archival.mdx#ttl).
