...
### Core Advancement Proposals (CAPs) {#core-advancement-proposals-caps}
...
### Create account operation {#create-account-operation}
...
### Cross-asset payments {#cross-asset-payments}
...
### Number of subentries {#number-of-subentries}
...
### Mainnet or Pubnet {#mainnet-or-pubnet}
...
### SEPs (Stellar Ecosystem Proposals) {#seps-stellar-ecosystem-proposals}
...
### Stellar Development Foundation (SDF) {#stellar-development-foundation-sdf}
