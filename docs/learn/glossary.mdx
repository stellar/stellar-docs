...
Flags control access to an asset on the account level. Learn more about flags in our [Controlling Access to an Asset section](../tokens/issued/control-asset-access.mdx#controlling-access-to-an-asset-with-flags).
