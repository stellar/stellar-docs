...
See the [Clawback Encyclopedia Entry](./encyclopedia/transactions-specialized/clawbacks.mdx) for more information.
...
Learn more in our [Liquidity on Stellar Encyclopedia Entry](./encyclopedia/sdex/liquidity-on-stellar-sdex-liquidity-pools.mdx#sdex).
...
Learn more in our [Liquidity on Stellar Encyclopedia Entry](./encyclopedia/sdex/liquidity-on-stellar-sdex-liquidity-pools.mdx#new-order).

### Orderbook

A record of outstanding orders on the Stellar network.

Learn more in our [Liquidity on Stellar Encyclopedia Entry](./encyclopedia/sdex/liquidity-on-stellar-sdex-liquidity-pools.mdx#orderbook).
...
Learn more about network passphrases in the [Network Passphrases Encyclopedia Entry](./encyclopedia/network-configuration/network-passphrases.mdx).
...
See our [Signature and Multisignature Encyclopedia Entry](./encyclopedia/security/signatures-multisig.mdx) for more information.
...
Read more in the [State Archival section](./encyclopedia/storage/state-archival.mdx#ttl).
