...
Contract tokens used to be referred to as "custom tokens", which is being deprecated.
...
This term is being deprecated in favor of [contract tokens](#contract-token).
