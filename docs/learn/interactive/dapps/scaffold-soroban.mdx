...
## Demonstrative Soroban Dapps {#demonstrative-soroban-dapps}
...
### [1. Payment Dapp](https://github.com/stellar/soroban-react-payment) {#1-payment-dapp}
...
### [2. Mint Token Dapp](https://github.com/stellar/soroban-react-mint-token) {#2-mint-token-dapp}
...
### [3. Atomic Swap Dapp](https://github.com/stellar/soroban-react-atomic-swap) {#3-atomic-swap-dapp}
...
## How To Explore the Dapps on Scaffold-Soroban {#how-to-explore-the-dapps-on-scaffold-soroban}
...
## Functionality Behind the Dapps {#functionality-behind-the-dapps}
