...
To get started, simply head over to the [Dashboard](/docs/learn/interactive/dapps/dashboard), [connect your wallet](../../../build/guides/freighter/connect-testnet.mdx), and see what challenges await you!
