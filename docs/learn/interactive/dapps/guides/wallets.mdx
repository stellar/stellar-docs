...
import gear_icon from "@site/static/img/gear_icon.png";
import preferences_menu from "@site/static/img/preferences_menu.png";
import connect_freighter_example from "@site/static/img/connect_freighter_example.png";
...
<img
  src={connect_freighter_example}
  alt="connect freighter example"
  width="50%"
/>
