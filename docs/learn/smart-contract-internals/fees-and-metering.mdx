...
![Soroban Fees](/img/soroban_fees.png) _\* Chart: Solid line boxes are what is actually present in the transaction, while dotted lines are derivable._
...
ResourceFee is calculated with a non-refundable fees portion and a refundable fees portion. `Resource Fee(sorobanData.resourceFee) = Non-refundable resource fees + Refundable resource fees`
