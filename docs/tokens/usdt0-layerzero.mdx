...
sidebar_label: USDT0
description: "Use Tether's USDT0, delivered over LayerZero's OFT standard, on Stellar. Mainnet addresses, how LayerZero fits, integration pointers, constraints to check before listing, and a read-only pre-listing check."
---
