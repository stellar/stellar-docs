...
1. Assets issued by Stellar accounts (`G...` addresses) and their built-in [Stellar Asset Contract (SAC)](./issuing-assets/stellar-asset-contract.mdx) implementation, and
