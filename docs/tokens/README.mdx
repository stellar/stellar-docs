...
| **Token Model** | Trustlines + native ops + SEP-41 via SAC | SEP-41 interface implemented by a smart contract, fully extensible | [SEP-41][sep-41] with extensible compliance logic |
