...
| **Relevant SEPs** | **SEP-0001** (Stellar Info File) <br /> **SEP-0014** (Dynamic Asset Metadata) <br />**SEP-41** (Soroban Token Interface) | **SEP-41** (Soroban Token Interface) | **SEP-41** (Soroban Token Interface) <br /> **SEP-0057** (T-REX / Token for Regulated Exchanges) |
