...
### Issuer account keypair {#issuer-account-keypair}
...
### Distribution account keypair {#distribution-account-keypair}
...
##### Import an existing keypair {#import-an-existing-keypair}
...
##### Employ [multiple signatures](../learn/encyclopedia/security/signatures-multisig.mdx) {#employ-multiple-signatures}
...
### Local asset object {#local-asset-object}
...
### Establish distributor trustline {#establish-distributor-trustline}
...
### Issuer payment to distributor {#issuer-payment-to-distributor}
...
#### Configure maximum supply {#configure-maximum-supply}
...
#### Approve distributor trustline {#approve-distributor-trustline}
