---
title: Assets Overview and Comparison
description: Asset Overview and Comparison of Stellar Classic Asset (with SAC), SEP-41 Contract Token, and T-REX (Token for Regulated Exchanges)
sidebar_position: 20
---
...
- **Classic Asset**  
  Held in trustlines and transferred via payment operations.
...
- Higher execution costs compared to Classic Asset operations.
- Less widespread ecosystem support compared to Classic Assets, including centralized exchange support.
