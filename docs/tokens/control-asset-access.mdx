...
#### Authorization Required (0x1) {#authorization-required-0x1}
...
#### Authorization Revocable (0x2) {#authorization-revocable-0x2}
...
#### Clawback Enabled (0x8) {#clawback-enabled-0x8}
...
#### Authorization Immutable (0x4) {#authorization-immutable-0x4}
