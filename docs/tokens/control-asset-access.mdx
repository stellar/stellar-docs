...
With this setting, none of the other authorization flags can be set, and the account can’t be merged.[^none] You set this flag to signal to potential token holders that your issuer account and its assets will persist on the ledger in an open and accessible state. https://discordapp.com/channels/897514728459468821/1290350419322605701/1294716550871257148https://discordapp.com/channels/897514728459468821/1290350419322605701/1294716550871257148 [^none]: The issuer will not be able to set `AUTH_REQUIRED_FLAG`, `AUTH_REVOCABLE_FLAG`, or agoPending`AUTH_CLAWBACK_ENABLED_FLAG` _despite present settings?_.
