...
## What is a Stellar info file? {#what-is-a-stellar-info-file}
...
## Completing your `stellar.toml` {#completing-your-stellartoml}
...
#### Suggested fields for asset issuers: {#suggested-fields-for-asset-issuers}
...
### 2. Organization Documentation {#2-organization-documentation}
...
#### Required field for all asset issuers: {#required-field-for-all-asset-issuers}
...
#### Suggested fields for asset issuers: {#suggested-fields-for-asset-issuers-1}
...
### 3. Point of Contact Documentation {#3-point-of-contact-documentation}
...
#### Required field for all asset issuers: {#required-field-for-all-asset-issuers-1}
...
#### Suggested fields for asset issuers: {#suggested-fields-for-asset-issuers-2}
...
### 4. Currency Documentation {#4-currency-documentation}
...
#### Required field for all asset issuers: {#required-field-for-all-asset-issuers-2}
...
#### Suggested fields for asset issuers: {#suggested-fields-for-asset-issuers-3}
...
## How to publish your Stellar info file {#how-to-publish-your-stellar-info-file}
...
## Sample code to set the home domain of your issuing account {#sample-code-to-set-the-home-domain-of-your-issuing-account}
...
## Sample `stellar.toml` {#sample-stellartoml}
