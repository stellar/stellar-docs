...
- `SEP10_HOME_DOMAINS="localhost:8000, *.stellar.local:8000"`: una lista separada por comas de dominios principales utilizados para [SEP-10](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0010.md). Esto debería contener los dominios de las instancias de inquilino de la SDP.
