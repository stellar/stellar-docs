...
En `docker-compose-sdp.yml`, actualiza lo siguiente:

<CodeExample>

```yaml
# The public/private key of the Stellar account used for SEP-10 authentication:
SEP10_SIGNING_PUBLIC_KEY:
SEP10_SIGNING_PRIVATE_KEY:

# An encryption key used to sign JWT tokens used for the SEP-24 flow:
SEP24_JWT_SECRET:
