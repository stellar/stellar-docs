...
La especificación de OpenRPC para la API JSON-RPC está disponible [aquí](https://playground.open-rpc.org/?schemaUrl=https://raw.githubusercontent.com/stellar/stellar-docs/main/static/assets/rpc-methods/open-rpc.json).
...
|   | [request_customer_info_update](request_customer_info_update.mdx)           |
