...
Si configuras el tipo de autenticación `api_key` o `jwt`, entonces necesitas añadir una variable de entorno.
...
docker run stellar/anchor-platform:2.8.4 --custody-server
```
