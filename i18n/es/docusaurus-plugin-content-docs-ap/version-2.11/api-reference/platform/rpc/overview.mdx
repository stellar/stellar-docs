...
Todos los nombres de miembros intercambiados entre el Cliente y el Servidor que se consideren para emparejamiento de cualquier tipo deben considerarse sensibles a mayúsculas y minúsculas.
