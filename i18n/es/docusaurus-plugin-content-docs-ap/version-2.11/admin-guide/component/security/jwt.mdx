...
Anchor Platform utiliza el algoritmo HMAC SHA-256 (HS256) para firmar los tokens JWT. Asegúrate de que `SECRET_PLATFORM_API_AUTH_SECRET` tenga al menos 32 caracteres de longitud por motivos de seguridad.
