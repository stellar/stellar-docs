...
Consulta la [especificación de API KYC de Anchor Platform][platform-api-kyc] para detalles sobre los endpoints que deben implementarse en el servidor de tu negocio.
