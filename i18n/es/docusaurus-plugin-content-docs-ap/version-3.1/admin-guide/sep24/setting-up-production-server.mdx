...
Para cambiar a la red pública (mainnet) de Stellar, solo tienes que cambiar la [passphrase de la red](/docs/learn/fundamentals/networks#network-passphrases) (para autenticar las solicitudes) y la [URL de Horizon](https://horizon.stellar.org/).
