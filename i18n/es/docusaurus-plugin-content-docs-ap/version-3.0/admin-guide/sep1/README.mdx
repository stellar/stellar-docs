...
Ten en cuenta que necesitarás crear otro archivo para tu implementación en producción que utilice la frase de paso de la red pública, las URLs de tus servicios de producción, tus cuentas de distribución de Mainnet y clave de firma, así como las cuentas emisoras de Mainnet de los activos que utiliza tu servicio.
...
Alternativamente, tu archivo `stellar.toml` podría ser alojado utilizando un servidor de archivos estático adecuado como [nginx]. Siempre que tu archivo de información incluya las URLs apropiadas que apunten a la Anchor Platform, esto funcionará muy bien.
