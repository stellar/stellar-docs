...
Para cambiar a la red pública (mainnet) de Stellar, solo tienes que cambiar la [frase de contraseña](/docs/learn/fundamentals/networks#network-passphrases) de la red (para autenticar solicitudes) y la [URL de Horizon](https://horizon.stellar.org/).
