...
Para cambiar a la red pública (mainnet) de Stellar, lo único que tienes que hacer es cambiar la [frase de paso](/docs/networks#network-passphrases) de la red (para autenticar las solicitudes) y la [URL de Horizon](https://horizon.stellar.org/).
