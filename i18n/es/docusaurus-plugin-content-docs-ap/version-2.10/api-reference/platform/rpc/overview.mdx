...
Todos los nombres de miembros intercambiados entre el Cliente y el Servidor que se consideren para la coincidencia de cualquier tipo deben considerarse con distinción entre mayúsculas y minúsculas.
