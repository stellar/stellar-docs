...
A continuación, vamos a modificar el archivo `stellar.toml` creado [anteriormente](../sep1/README.mdx). Las billeteras necesitan saber que la funcionalidad SEP-10 está admitida por tu negocio.
