...
![Fundamental Anchor Platform Architecture](../assets/architecture-1.png)
...
<div style={{ width: "800px" }}>
  [![Complete Anchor Platform Architecture](../assets/architecture-2.png)](../assets/architecture-2.png)
</div>
#### Event Service
