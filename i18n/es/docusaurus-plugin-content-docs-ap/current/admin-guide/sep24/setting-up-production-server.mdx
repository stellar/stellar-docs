...
Para cambiar a la red pública (mainnet) de Stellar, solo tienes que cambiar la [clave de red](/docs/learn/fundamentals/networks#network-passphrases) (para autenticar solicitudes) y la [URL de Horizon](https://horizon.stellar.org/).
