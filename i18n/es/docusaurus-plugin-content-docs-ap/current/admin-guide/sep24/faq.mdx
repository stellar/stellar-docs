...
El estándar [SEP-24](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0024.md) proporciona un endpoint `/fee` para permitir a las empresas establecer tarifas estáticas para sus transacciones. Sin embargo, actualmente no está admitido por la Anchor Platform.
