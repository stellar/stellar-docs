...
Antes de continuar con esta sección, asegúrate de haber [instalado][installation-ap] la Anchor Platform y de haber configurado las características necesarias requeridas por SEP-31: [SEP-1 (Archivo de información de Stellar)][sep1-ap] y [SEP-10 (Autenticación de Stellar)][sep10-ap].
