...
Se proporciona una implementación del contrato SEP-45 en el [repositorio Anchor Platform](https://github.com/stellar/anchor-platform/tree/feature/c-accounts/soroban). Una instancia de este contrato está desplegada en `CD3LA6RKF5D2FN2R2L57MWXLBRSEWWENE74YBEFZSSGNJRJGICFGQXMX` en testnet.
...
Puedes usar un proveedor público de Stellar RPC, o puedes ejecutar el tuyo propio. Se puede encontrar una lista de proveedores públicos [aquí](/docs/data/apis/rpc/providers). El siguiente ejemplo usa el RPC testnet de SDF.
...
El archivo `stellar.toml` creado [anteriormente](../sep1/README.mdx) debe actualizarse para incluir el nuevo endpoint de autenticación y la ID del contrato.
