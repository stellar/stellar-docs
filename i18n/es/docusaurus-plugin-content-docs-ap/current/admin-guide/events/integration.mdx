...
Anchor Platform solo enviará eventos a los clientes que estén listados en la configuración del cliente. Consulta la [documentación de configuración del cliente](../../sep-guide/sep10/README.mdx#config-with-client-attribution) para más información.
