...
[![Flujo de Dep Sito Sep6](../../assets/sep6-deposit-flow-diagram.png)](../../assets/sep6-deposit-flow-diagram.png)
...
El sistema de procesamiento de pagos verifica periódicamente si la trustline se configuró. Si lo estuvo, enviará automáticamente un pago y cambiará el estado de la transacción a `pending_stellar`.
...
Este método será llamado por el observador de pagos Stellar cuando detecte que se han recibido fondos en cadena.
