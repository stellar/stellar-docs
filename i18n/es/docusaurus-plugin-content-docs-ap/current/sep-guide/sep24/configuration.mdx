...
![Demo Wallet Connected Anchor Platform](/assets/anchor-platform/sep24/demo-wallet.png)
...
![Demo Wallet Initiating Transaction](/assets/anchor-platform/sep24/demo-wallet-widget.png)
