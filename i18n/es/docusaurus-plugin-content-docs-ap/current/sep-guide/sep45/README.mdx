...
Puedes usar un proveedor público de Stellar RPC o ejecutar el tuyo propio. Una lista de proveedores públicos se encuentra [aquí][rpc-providers]. El siguiente ejemplo usa el RPC de testnet de SDF.
...
El archivo `stellar.toml` creado [anteriormente][sep1-ap] debe actualizarse para incluir el nuevo endpoint de autenticación y el ID del contrato.
