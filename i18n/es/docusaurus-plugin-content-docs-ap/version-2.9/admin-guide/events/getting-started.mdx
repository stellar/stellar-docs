...
Los esquemas de eventos para servidores comerciales están definidos en la [referencia de la API](../../api-reference/callbacks/post-event.api.mdx).
...
- [SEP-12 Eventos de Cliente](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0012.md#response)
...
Esto elimina la necesidad de que los servidores de negocios y las aplicaciones de clientes consulten continuamente las API en busca de actualizaciones.
