...
<iframe
  src="https://www.youtube.com/embed/fuX07T1HUf0?si=NH6BEOkgg755oIoh"
  width="640"
  height="480"
  allow="autoplay"
></iframe>

Estamos cerca de completar la implementación de los CAPs del Protocolo 23, el siguiente paso en el ciclo de vida de los CAP es la votación por el equipo principal de CAP. En esta reunión del protocolo se proporcionó una actualización sobre los CAPs y se respondieron las preguntas finales de la comunidad.
