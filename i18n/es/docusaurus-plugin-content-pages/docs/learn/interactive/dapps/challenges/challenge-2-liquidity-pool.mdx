...
{/_ <ParentChallengeContractForm id={2} progress={1} /> _/}
...
{/_ <CompleteStepButton id={2} progress={2}>Transactions completed</CompleteStepButton> _/}
