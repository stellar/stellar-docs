...
English SDF has open-sourced some "platforms" that make it easier to accomplish certain things on the network.
...
[Learn more about the Anchor Platform API here!](/platforms/anchor-platform)
...
[Learn more about the Stellar Disbursement Platform API here!](/platforms/stellar-disbursement-platform)
