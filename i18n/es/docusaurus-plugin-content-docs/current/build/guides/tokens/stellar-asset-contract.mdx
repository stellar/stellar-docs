...
Al interactuar con activos en un contrato inteligente, el [Contrato de Activos Stellar](../../../tokens/stellar-asset-contract.mdx) no es diferente de cualquier otro token que implemente la [Interfaz de Token SEP-41](../../../tokens/token-interface.mdx) de Stellar.
...
Un cliente creado por [`token::TokenClient`](https://docs.rs/soroban-sdk/latest/soroban_sdk/token/struct.TokenClient.html) implementa las funciones definidas por cualquier contrato que implemente la [Interfaz de Token SEP-41](../../../tokens/token-interface.mdx). Pero con [el activo estandarizado de contrato inteligente CAP-46-6], el Contrato de Activos Stellar expone funciones adicionales como `mint`. Para acceder a las funciones adicionales, se necesita usar otro cliente: [`token::StellarAssetClient`](https://docs.rs/soroban-sdk/latest/soroban_sdk/token/struct.StellarAssetClient.html). Este cliente solo implementa las funciones de CAP-46-6, que no son parte de la interfaz SEP-41.
