...
Este contrato se despliega, y la dirección podría ser (por ejemplo) `CBCGKTU6CD25S2E7SEMJ72MQUL4XEGAXAJ43GQE3HSYOZKZ4C4LOH756`. Ahora podemos establecer la dirección `Admin` del SAC en este contrato:
...
stellar contract invoke \
    ...
    --id CBVYF2KJ72BRPLVPCUL3PGWDO5RK2XP4AJDHKX7GDDBJW42L2C6VT3SF \
    -- \
    set_admin --new_admin CBCGKTU6CD25S2E7SEMJ72MQUL4XEGAXAJ43GQE3HSYOZKZ4C4LOH756
```
...
stellar contract invoke \
    ...
    -- \
    admin
# CBCGKTU6CD25S2E7SEMJ72MQUL4XEGAXAJ43GQE3HSYOZKZ4C4LOH756
```
...
stellar contract invoke \
    ...
    --id CBCGKTU6CD25S2E7SEMJ72MQUL4XEGAXAJ43GQE3HSYOZKZ4C4LOH756 \
    -- \
