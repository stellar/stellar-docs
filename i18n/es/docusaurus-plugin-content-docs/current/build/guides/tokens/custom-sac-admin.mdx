...
No demostraremos cómo establecer una nueva cuenta `G...` como un administrador SAC en esta guía. Cualquier caso de uso que necesite que la administración de activos sea delegada a otra cuenta `G...` probablemente se beneficiarían más al aprovechar las [capacidades multisig](../../../learn/encyclopedia/security/signatures-multisig.mdx) existentes de las cuentas Stellar.
