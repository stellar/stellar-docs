...
3. Escribe una prueba que ejecute la misma lógica para el contrato desplegado y el contrato local, comparando el resultado. Asumiendo que el [ejemplo de incremento] está en uso, la prueba se vería algo así como lo siguiente.
...
[Comenzar]: ../../smart-contracts/comenzar
[ejemplo de incremento]: https://github.com/stellar/soroban-examples/blob/main/increment/src/lib.rs
[Pruebas Diferenciales con Imágenes de Prueba]: ./differential-tests-with-test-snapshots.mdx
[fetch de contrato stellar]: ../../../tools/cli/stellar-cli.mdx#stellar-contract-fetch
