...
Las imágenes de prueba son una herramienta para realizar pruebas diferenciales. Consulta [Pruebas Diferenciales](./differential-tests.mdx) para otras maneras.
...
Para probar esto, consulta el contrato [Comenzar](../../smart-contracts/getting-started/README.mdx) o cualquiera de los [ejemplos](../../smart-contracts/example-contracts/README.mdx), ejecuta las pruebas y busca las imágenes de prueba en el disco.
