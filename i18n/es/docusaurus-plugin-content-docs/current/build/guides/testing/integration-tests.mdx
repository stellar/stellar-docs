...
El [Soroban Rust SDK](../../../tools/sdks/contract-sdks.mdx#soroban-rust-sdk) facilita igualmente las pruebas de integración al proporcionar utilidades para probar contra contratos reales obtenidos de mainnet, testnet o el sistema de archivos local.
