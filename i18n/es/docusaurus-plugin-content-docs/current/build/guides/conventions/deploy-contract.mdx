...
Al desplegar un contrato inteligente en la red, debes especificar una identidad que se utilizará para firmar las transacciones. Cambia la [identidad](../../smart-contracts/getting-started/setup.mdx#configure-an-identity) `alice` por la tuya.
