---
title: Usar __check_auth de maneras interesantes
description: Dos guías que explican cómo usar __check_auth
---

<head>
  <title>Usar __check_auth de maneras interesantes</title>
  <meta charSet="utf-8" />
  <meta property="og:title" content="Usar __check_auth de maneras interesantes" />
  <meta
    property="og:description"
    content="Esta guía te explicará maneras interesantes en las que puedes usar __check_auth en tus aplicaciones Soroban"
  />
</head>
...
2. Usa la función [ed25519_verify](https://docs.rs/soroban-sdk/latest/soroban_sdk/crypto/struct.Crypto.html#method.ed25519_verify) para verificar cada firma
...
El crédito de código de este tutorial va al trabajo de [@kalepail](https://github.com/kalepail) sobre claves de acceso, que puedes explorar más [aquí](https://github.com/kalepail/passkey-kit).
