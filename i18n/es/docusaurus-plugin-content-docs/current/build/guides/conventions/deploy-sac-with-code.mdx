...
description: Esta es una guía paso a paso para ayudarte a desplegar un SAC para un activo Stellar utilizando el SDK de Stellar.
---
## Resumen
...
- [Conocimiento sobre cómo emitir un activo en Stellar](../../../tokens/how-to-issue-an-asset.mdx)
