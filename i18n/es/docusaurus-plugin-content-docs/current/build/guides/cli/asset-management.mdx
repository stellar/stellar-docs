...
El [stellar-cli](https://developers.stellar.org/docs/tools/cli) puede usarse para emitir y administrar activos en la red Stellar.

La siguiente guía asume que el [stellar-cli](https://developers.stellar.org/docs/tools/cli) ha sido configurado para usar testnet o una red de prueba local. Para usar testnet, ejecuta el siguiente comando.
...
Para crear un Activo Stellar usando el [stellar-cli](https://developers.stellar.org/docs/tools/cli), se realizan varios pasos:
...
Para otras opciones, consulta el manual del comando [stellar tx new set-options](https://developers.stellar.org/docs/tools/cli/stellar-cli#stellar-tx-new-set-options).
