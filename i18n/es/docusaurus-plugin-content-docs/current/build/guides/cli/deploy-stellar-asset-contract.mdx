...
El CLI de Stellar puede desplegar un [Contrato de Activo Stellar](../../../tokens/stellar-asset-contract.mdx) para un activo Stellar de manera que cualquier contrato inteligente Stellar pueda interactuar con el activo.
