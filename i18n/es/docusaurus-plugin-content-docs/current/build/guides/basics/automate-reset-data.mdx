...
description: Automatizar los datos de restablecimiento de Testnet y Futurenet en Stellar
---
## Resumen

Stellar opera dos entornos de prueba principales: el [Testnet y el Futurenet](../../../networks/README.mdx). Estas redes permiten a los desarrolladores experimentar con las características de Stellar sin arriesgar activos reales. Periódicamente, estas redes se restablecen para asegurarse de que permanezcan limpias y manejables.
...
Puedes consultar las fechas actuales de reinicio [aquí](../../../networks/README.mdx#testnet-and-futurenet-data-reset).
