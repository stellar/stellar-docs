...
Para usar el ejemplo RPC que aparece a continuación, primero debes generar los enlaces del contrato para que el cliente pueda utilizarse correctamente. Esto se puede lograr mediante el [Stellar CLI](../../../tools/cli/README.mdx).
