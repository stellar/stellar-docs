...
Una vez que los eventos han sido ingeridos en una base de datos, por ejemplo, como se hace en la [guía de ingestión](ingest.mdx), pueden ser consumidos sin que sea necesario consultar nuevamente el RPC de Stellar. A continuación, mostraremos cómo podemos consumir estos eventos.

¡Vamos a comenzar!

## Primero, obtén algunos eventos en una base de datos

Siguiendo justo donde lo dejamos en la [guía de ingestión](ingest.mdx), utilizaremos los modelos ORM para añadir varias más eventos.
...
Recuerda que los eventos publicados por Soroban están codificados en XDR. Podemos utilizar [stellar-sdk](https://stellar-sdk.readthedocs.io) para convertir entre valores y la representación XDR.
...
Mientras tanto, podemos hacer que los resultados sean más legibles o utilizables en Python utilizando el asistente de conversión proporcionado por [stellar-sdk](https://stellar-sdk.readthedocs.io).
