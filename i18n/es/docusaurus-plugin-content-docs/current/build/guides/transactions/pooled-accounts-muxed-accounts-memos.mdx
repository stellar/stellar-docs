...
Las cuentas muxed están definidas en [CAP-0027](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0027.md), introducidas en el Protocolo 13, y su representación en cadena está descrita en [SEP-0023](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0023.md).
...
Debes usar los métodos de validación proporcionados por tu SDK o seguir cuidadosamente el [SEP-23](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0023.md). Por ejemplo, el SDK de JavaScript proporciona los siguientes métodos para validar direcciones Stellar:
