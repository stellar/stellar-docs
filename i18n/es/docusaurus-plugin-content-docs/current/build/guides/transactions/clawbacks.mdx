...
Este ejemplo resaltará cómo el emisor del activo mantiene el control sobre su activo sin importar cómo se distribuya al mundo.
...
- Finalmente, la Cuenta A recuperará la mitad del saldo de la Cuenta C, quemando 250 tokens para siempre.
