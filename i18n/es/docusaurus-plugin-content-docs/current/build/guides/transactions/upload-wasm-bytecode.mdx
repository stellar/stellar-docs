...
Podemos usar uno de los [SDKs](https://developers.stellar.org/docs/tools/sdks/library), instala las dependencias necesarias para el lenguaje de programación que elijas:
