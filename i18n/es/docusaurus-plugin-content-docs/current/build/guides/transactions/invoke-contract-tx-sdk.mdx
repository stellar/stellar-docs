---
title: Invocar una función de contrato en una transacción usando SDKs
hide_table_of_contents: true
description: Usa el Stellar SDK para crear, simular y ensamblar una transacción.
---

import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";

Este es un ejemplo simple que utiliza el SDK de Stellar para crear, simular y luego ensamblar una transacción Stellar que invoca una función `increment` del [contrato de ejemplo auth](../../smart-contracts/example-contracts/auth.mdx).
...
Por favor, dirígete a [la página de inicio del proyecto](https://github.com/stellar/js-stellar-sdk) del SDK de JavaScript para aprender cómo instalarlo.

:::

Primero, sube los bytes de [el contrato de ejemplo](../../smart-contracts/example-contracts/auth.mdx) a la blockchain usando [Stellar CLI](../../../tools/cli/stellar-cli.mdx). Esto se llama "instalar" porque, desde la perspectiva de la blockchain misma, este contrato ha sido instalado.
...
:::tip Cliente de un contrato existente
...
Por favor, dirígete a [la página de inicio del proyecto](https://github.com/StellarCN/py-stellar-base) del SDK de Python para aprender cómo instalarlo.

Además, Python proporciona mucho código de ejemplo, que puedes encontrar [aquí](https://github.com/StellarCN/py-stellar-base/tree/main/examples).
...
Por favor, dirígete a [la página de inicio del proyecto](https://github.com/lightsail-network/java-stellar-sdk) del SDK de Java para aprender cómo instalarlo.
...
Por favor, visita [la página principal del proyecto](https://github.com/rahul-soshte/rs-soroban-client) de la biblioteca Rust Soroban Client para aprender cómo instalarla.

Otros ejemplos se encuentran en la carpeta [`examples/`](https://github.com/rahul-soshte/rs-soroban-client/tree/main/examples) del repositorio.

:::

Primero, despliega [el contrato de ejemplo](../../smart-contracts/example-contracts/auth.mdx) en la blockchain usando [Stellar CLI](../../../tools/cli/stellar-cli.mdx).
