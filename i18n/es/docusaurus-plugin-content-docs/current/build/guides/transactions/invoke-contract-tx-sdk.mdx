---
title: Invocar una función de contrato en una transacción Stellar utilizando SDKs
hide_table_of_contents: true
description: Usar el SDK de Stellar para crear, simular y ensamblar una transacción
---
...
Primero, sube los bytes de [el contrato de ejemplo](https://developers.stellar.org/docs/build/smart-contracts/example-contracts/auth) a la blockchain usando [Stellar CLI](../../../tools/cli/stellar-cli). Esto se llama "instalar" porque, desde la perspectiva de la blockchain misma, este contrato ha sido instalado.
