---
title: Invocar una función de contrato en una transacción estelar usando SDKs
hide_table_of_contents: true
description: Usa el SDK Estelar para crear, simular y ensamblar una transacción.
---

import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";

Este es un ejemplo simple usando el SDK Stellar para crear, simular, y luego ensamblar una transacción Stellar que invoca una función 'increment' del [contrato de ejemplo de autor](. /../smart-contracts/example-contracts/auth.mdx).
...
Por favor, ve a [la página principal del proyecto](https://github.com/stellar/js-stellar-sdk) de JavaScript SDK para aprender cómo instalarlo.
...
Por favor, ve a [la página principal del proyecto](https://github.com/StellarCN/py-stellar-base) de Python SDK para aprender cómo instalarlo.

Además, Python proporciona un montón de código de ejemplo, que puedes encontrar [here](https://github.com/StellarCN/py-stellar-base/tree/main/examples).
...
Por favor, ve a [la página principal del proyecto](https://github.com/lightsail-network/java-stellar-sdk) de Java SDK para aprender cómo instalarlo.
