...
La Stellar Development Foundation proporciona un servicio RPC de testnet en `http://soroban-testnet.stellar.org`. Para los proveedores de red pública, consulta la lista de [Ecosystem RPC Providers](../../../data/apis/rpc/providers.mdx).
...
**SimulateTransactionResult** es el resultado devuelto de la llamada. ¡Incluye [muchas cosas útiles](../../../data/apis/rpc/api-reference/methods/simulateTransaction.mdx)!
...
- [Documentación openRpc](../../../data/apis/rpc/api-reference/methods/simulateTransaction.mdx)
