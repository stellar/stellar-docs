...
description: Realiza una llamada de contrato cruzado invocando otro contrato usando su ID de contrato.
---
import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";
import { getPlatform } from "@site/src/helpers/getPlatform";

El [ejemplo de llamada de contrato cruzado](https://github.com/stellar/soroban-examples/tree/v23.0.0/cross_contract) demuestra cómo llamar a un contrato desde otro contrato.
...
Si tienes [`stellar-cli`](../getting-started/setup.mdx#install-the-stellar-cli) instalado, puedes invocar funciones de contrato. Ambos contratos deben ser desplegados.
