...
[ejemplo de token]: https://github.com/stellar/soroban-examples/tree/v23.0.0/token
[interfaz de token]: ../../../tokens/token-interface.mdx

:::tip[Whisk Cambios]

Con el lanzamiento de Whisk, Protocolo 23, la [interfaz de token] ha sufrido algunos cambios para incorporar el tipo `MuxedAddress` en la función `transfer`. Consulta la [documentación del SDK de Rust](https://docs.rs/soroban-token-sdk/latest/soroban_token_sdk/_migrating/v23_token_transfer/index.html) para más detalles.
