...
title: Tokens
description: Utiliza la Interfaz de Token para construir un token de contrato inteligente que tenga una interfaz uniforme y predecible para pagos, transferencias de saldo, consultas de saldo, y más.
---
