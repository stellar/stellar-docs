...
[ejemplo de fondo de liquidez]: https://github.com/stellar/soroban-examples/tree/v23.0.0/liquidity_pool
[código fuente]: https://github.com/stellar/soroban-examples/tree/v23.0.0/liquidity_pool/src/lib.rs#L143
...
[creando su propio token `pool`]: #minting-and-burning-lp-shares
