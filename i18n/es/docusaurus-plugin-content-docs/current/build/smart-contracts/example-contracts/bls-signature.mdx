---
title: Firma BLS
description: Una cuenta de contrato básica que implementa la función `FastAggregateVerify` en el borrador de [BLS Signatures](https://www.ietf.org/archive/id/draft-irtf-cfrg-bls-signature-05.html#name-fastaggregateverify).
sidebar_position: 17
---
