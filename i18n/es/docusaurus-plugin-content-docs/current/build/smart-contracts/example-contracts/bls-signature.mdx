...
El [ejemplo de firma BLS] muestra cómo implementar la verificación de firmas BLS dentro de una cuenta de contrato.

Este ejemplo se basa en el [ejemplo de cuenta compleja]. Aunque el objetivo principal es ilustrar el uso práctico de las funcionalidades de BLS12-381 en un contexto relevante.

Es bueno comprender cómo funciona una cuenta de contrato, por lo que primero recorre el [ejemplo de cuenta simple], aunque no es obligatorio.
...
[Ejemplo de cuenta compleja]: ./complex-account.mdx
[Ejemplo de cuenta simple]: ./simple-account.mdx
