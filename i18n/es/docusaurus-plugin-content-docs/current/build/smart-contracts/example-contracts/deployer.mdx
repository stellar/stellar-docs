...
[ejemplo del desplegador]: https://github.com/stellar/soroban-examples/tree/v23.0.0/deployer

## Ejecutar el Ejemplo

Primero completa el proceso de [Configuración] para tener tu entorno de desarrollo listo, luego clona la etiqueta `v23.0.0` del repositorio `soroban-examples`:
