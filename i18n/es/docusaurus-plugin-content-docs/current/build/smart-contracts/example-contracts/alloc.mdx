---
title: Asignador
description: Utiliza la función de asignador en el SDK. El asignador liviano de punteros de aumento se puede usar para emular la asignación de memoria heap en un contrato inteligente Wasm.
sidebar_position: 80
---
El [ejemplo de asignador](https://github.com/stellar/soroban-examples/tree/v23.0.0/alloc) demuestra cómo utilizar la función de asignador al escribir un contrato.
