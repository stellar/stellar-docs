...
description: Implementar un contrato simple que admite políticas de autorización multisig y personalizables; las cuentas personalizadas se pueden usar con el marco de autenticación y son exclusivas de Soroban.
