...
[ejemplo de incremento]: https://github.com/stellar/soroban-examples/tree/v23.0.0/increment

## Ejecutar el ejemplo

Primero completa el proceso de [Configuración] para tener tu entorno de desarrollo configurado, luego clona la etiqueta `v23.0.0` del repositorio `soroban-examples`:
...
[el entorno]: ../../../learn/fundamentals/contract-development/environment-concepts.mdx
