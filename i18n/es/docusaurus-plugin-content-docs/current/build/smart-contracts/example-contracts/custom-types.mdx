...
[ejemplo de tipos personalizados]: https://github.com/stellar/soroban-examples/tree/v23.0.0/custom_types
[ejemplo de almacenamiento de datos]: ../getting-started/storing-data.mdx

## Ejecutar el Ejemplo

Primero, realiza el proceso de [Configuración] para tener tu entorno de desarrollo configurado, luego clona la etiqueta `v23.0.0` del repositorio `soroban-examples`:
