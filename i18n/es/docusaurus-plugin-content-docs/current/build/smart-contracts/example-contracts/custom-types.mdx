...
description: Define las estructuras de datos que pueden almacenarse en el ledger o usarse como entradas y salidas en las invocaciones de contratos. Pueden ser tanto structs como enums.
---
import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";
import { getPlatform } from "@site/src/helpers/getPlatform";

El [ejemplo de tipos personalizados](https://github.com/stellar/soroban-examples/tree/v23.0.0/custom_types) muestra cómo definir tus propias estructuras de datos que pueden almacenarse en el ledger o usarse como entradas y salidas en las invocaciones de contratos. Este ejemplo es una extensión del [ejemplo de almacenamiento de datos](../getting-started/storing-data.mdx).
...
Primero, realiza el proceso de [Configuración](../getting-started/setup.mdx) para tener tu entorno de desarrollo configurado, luego clona la etiqueta `v23.0.0` del repositorio `soroban-examples`:
...
Referencia: https://github.com/stellar/soroban-examples/tree/v23.0.0/custom_types
...
Si tienes [`stellar-cli`](../getting-started/setup.mdx#install-the-stellar-cli) instalado, puedes [desplegar](../getting-started/deploy-to-testnet) e invocar la función del contrato.
