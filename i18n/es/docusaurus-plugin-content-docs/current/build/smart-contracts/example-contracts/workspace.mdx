...
[ejemplo de espacio de trabajo]: https://github.com/stellar/soroban-examples/tree/v23.0.0/workspace

## Ejecutar el Ejemplo

Primero sigue el proceso de [Configuración] para preparar tu entorno de desarrollo, luego clona el 'tag' `v23.0.0` del repositorio `soroban-examples`:
