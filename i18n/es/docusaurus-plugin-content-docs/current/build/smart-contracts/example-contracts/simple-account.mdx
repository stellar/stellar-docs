...
3. Si prefieres no instalar nada localmente, lanza el repositorio en [GitHub Codespaces][open-in-github-codespaces] o [Codeanywhere][open-in-code-anywhere].
...
[ejemplo de cuenta simple]: https://github.com/stellar/soroban-examples/tree/v23.0.0/simple_account
