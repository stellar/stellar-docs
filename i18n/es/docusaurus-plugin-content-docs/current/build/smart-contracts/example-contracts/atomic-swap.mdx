...
description: Intercambiar dos tokens entre dos partes autorizadas atómicamente usando el marco de autenticación; el precio mínimo solicitado debe ser respetado por ambas partes.
---
El [ejemplo de intercambio atómico](https://github.com/stellar/soroban-examples/tree/v23.0.0/atomic_swap) intercambia dos tokens entre dos partes autorizadas atómicamente mientras sigue los límites que establecen.
...
Primero completa el proceso de [Configuración](../getting-started/setup.mdx) para preparar tu entorno de desarrollo, luego clona la etiqueta `v23.0.0` del repositorio `soroban-examples`:
...
O, salta la configuración del entorno de desarrollo y abre este ejemplo en [GitHub Codespaces](https://github.com/codespaces/new?repo=stellar/soroban-examples&editor=web) o en [Code Anywhere](https://app.codeanywhere.com/#https://github.com/stellar/soroban-examples).
...
Referencia: https://github.com/stellar/soroban-examples/tree/v23.0.0/atomic_swap
...
Abre el archivo [`atomic_swap/src/test.rs`](https://github.com/stellar/soroban-examples/tree/v23.0.0/atomic_swap/src/test.rs) para seguir.
