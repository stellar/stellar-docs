...
[ejemplo de intercambio atómico]: https://github.com/stellar/soroban-examples/tree/v23.0.0/atomic_swap

## Ejecutar el Ejemplo

Primero completa el proceso de [Configuración] para preparar tu entorno de desarrollo, luego clona la etiqueta `v23.0.0` del repositorio `soroban-examples`:
