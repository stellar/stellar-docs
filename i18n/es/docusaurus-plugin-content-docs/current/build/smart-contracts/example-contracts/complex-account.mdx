...
description: Desarrollada sobre el ejemplo de Cuenta Simple para añadir reglas multisig y lógica de políticas que se ejecutan cada vez que esta cuenta autoriza una llamada.
---
...
Abre el archivo [`account/src/test.rs`](https://github.com/stellar/soroban-examples/tree/v23.0.0/account/src/test.rs) para seguir el ejemplo.
