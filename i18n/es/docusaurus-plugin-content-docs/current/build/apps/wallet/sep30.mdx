...
2. Establecer todos los umbrales de operación en 10. Puedes leer más sobre el umbral en la [documentación](../../../learn/encyclopedia/security/signatures-multisig.mdx#thresholds)
