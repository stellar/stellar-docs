...
A veces las cosas salen mal. Como primer paso al resolver problemas, es posible que desees [clonar nuestro repositorio del tutorial](https://github.com/theahaco/soroban-tutorial-project) y ver si el problema ocurre allí también. Si ocurre allí también, entonces puede ser un problema temporal con la red de Soroban.
