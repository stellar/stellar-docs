...
**Fuente:** [`github.com/stellar/basic-payment-app/src/routes/dashboard/transfers/+page`](https://github.com/stellar/basic-payment-app/blob/main/src/routes/dashboard/transfers/+page.js)
