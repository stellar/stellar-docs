...
<img
  src={useBaseUrl("/assets/basic-pay/sep6/transfer-details.png")}
  width="45%"
/>
...
<img src={useBaseUrl("/assets/basic-pay/sep6/kyc.png")} width="45%" />
...
<img src={useBaseUrl("/assets/basic-pay/kyc-accepted.png")} width="50%" />
