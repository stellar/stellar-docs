...
![Autenticar Tutorial Screenshot](/assets/basic-pay/authenticate.png)
...
**Fuente:** [`github.com/stellar/basic-payment-app/src/lib/stellar/sep10`](https://github.com/stellar/basic-payment-app/blob/main/src/lib/stellar/sep10.js)
...
<img src="/assets/basic-pay/auth-valid.png" width="70%" alt="Insignia Autenticación Válida" />
