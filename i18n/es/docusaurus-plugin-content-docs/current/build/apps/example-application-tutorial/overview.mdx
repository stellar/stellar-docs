...
Este tutorial describe cómo crear una aplicación con el [`js-stellar-sdk`](https://github.com/stellar/js-stellar-sdk), para construir con el Wallet SDK, por favor sigue el [tutorial de creación de una billetera](../wallet/overview.mdx). Para construir con contratos inteligentes, navega a la [sección de Contratos Inteligentes](../../../build/smart-contracts/getting-started/setup.mdx).
...
Para este tutorial, revisaremos los pasos mientras creamos una aplicación de ejemplo que hemos llamado [BasicPay](https://basicpay.pages.dev), que se utilizará para mostrar diversas características.
...
- Marco de aplicación: estamos utilizando [SvelteKit](https://kit.svelte.dev) optando por JavaScript con tipado JSDoc. SvelteKit es bastante flexible y podría usarse para mucho, pero principalmente lo utilizamos por sus capacidades de enrutamiento para minimizar que esto se convierta en un "tutorial de SvelteKit".
- Marco de frontend: estamos utilizando [DaisyUI](https://daisyui.com) para simplificar el uso de [Tailwind CSS](https://tailwindcss.com).
- Una manera de interactuar con la red Stellar: estamos utilizando el [`js-stellar-sdk`](https://github.com/stellar/js-stellar-sdk), pero podrías utilizar solicitudes fetch tradicionales. El [`js-stellar-sdk`](https://github.com/stellar/js-stellar-sdk) también se utiliza para construir transacciones que se envían a la red Stellar.
...
- Estamos desplegando esto como una "aplicación de una sola página" estática con [Cloudflare Pages](https://pages.cloudflare.com). Tus propias decisiones de despliegue tendrán un impacto en tu configuración y proceso de construcción.
...
- [Stellar Lab](https://lab.stellar.org): un parque experimental para interactuar con la red Stellar
