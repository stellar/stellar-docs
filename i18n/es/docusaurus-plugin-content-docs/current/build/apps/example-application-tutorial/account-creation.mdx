...
Las cuentas son la estructura central de datos en Stellar y sólo pueden existir con un par de claves válido (una clave pública y secreta) y el balance mínimo requerido de XLM. Read more in the [Accounts section].
