...
¡Este es otro ayudante, pero del lado de la API! [Friendbot](../../../networks/README.mdx#friendbot) no admite direcciones `C...` para la financiación de Testnet. Así que, estamos configurando un endpoint para poder añadir algunos fondos a las billeteras de los usuarios de la dapp. Esto les da algunos tokens para jugar, y nos permite _a nosotros_ recibir esas donaciones del libro de visitas!
