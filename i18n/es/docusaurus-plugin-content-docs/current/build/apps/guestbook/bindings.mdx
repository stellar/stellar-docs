...
Para una visión más completa del proceso de crear, personalizar y usar scripts de inicialización como este, consulta la [guía de plantilla frontend](https://developers.stellar.org/docs/build/guides/dapps/soroban-contract-init-template).
