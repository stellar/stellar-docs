...
Para más información, consulta nuestra guía sobre [asegurar productos basados en la web](https://developers.stellar.org/docs/build/security-docs/securing-web-based-projects).
