...
Friendbot es un bot que financia cuentas con XLM falso en Testnet o Futurenet. Puedes solicitar XLM a Friendbot usando el [Stellar Lab](../tools/lab/account.mdx#fund-account) o con varios SDKs.
