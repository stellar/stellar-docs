...
| XDR                                       | `v24.0`                                           |
| Rust XDR                                  | `24.0.1`                                          |
| Entorno de host de contratos inteligentes | `23.0.0`                                          |
| Stellar Core                              | `24.0.0`                                          |
...
| XDR                                    | `v23.0`                                           |
| Rust XDR                               | `v23.0.0`                                         |
| Entorno host para contrato inteligente | `v23.0.2`                                         |
| Stellar Core                           | `v23.0.1`                                         |
| SDK Rust para contrato inteligente     | `v23.0.2`                                         |
| CLI de Stellar                         | `v23.1.1`                                         |
| Stellar RPC                            | `v23.0.2`                                         |
...
| XDR                                     | `v23.0`                                           |
| Rust XDR                                | `23.0.0`                                          |
| Entorno de Ejecución del Smart Contract | `23.0.0`                                          |
| Stellar Core                            | `23.0.0`                                          |
| SDK de Rust para Smart Contract         | `23.0.0-rc.2.4`                                   |
| Stellar CLI                             | `23.0.1`                                          |
| Stellar RPC                             | `v23.0.0`                                         |
| Horizonte de Stellar                    | `v23.0.0`                                         |
| Stellar Galexie                         | `v23.0.0`                                         |
| Inicio rápido de Stellar                | `docker pull stellar/quickstart`                  |
| Base Stellar JS                         | `v14.0.0`                                         |
| SDK de Stellar JS                       | `v14.0.0`                                         |
| Cliente de Stellar Horizon y TxnBuild   | `v23.0.0`                                         |
| Cliente RPC de Stellar                  | `v23.0.0`                                         |
| Freighter                               |                                                   |
| Laboratorio                             | `N/A`                                             |
| Frase secreta de la red Futurenet       | `Test SDF Future Network ; octubre 2022`          |
| Frase secreta de la red Testnet         | `Test SDF Network ; septiembre 2015`              |
...
| ---------------------------- | --------------- | ------------------------------------------------------------------------------------------------------ |
| XDR                          | `v23.0`         | `n/a`                                                                                                  |
| XDR de Rust                  | `23.0.0-rc.2`   | `rust crate: stellar-xdr:23.0.0-rc.2`                                                                  |
...
| CLI de Stellar               | `23.0.0`        | `rust crate: stellar-cli:23.0.0`                                                                       |
...
| SDK Stellar JS                    | [`v11.2.0`](https://github.com/stellar/js-stellar-sdk/releases/tag/v11.2.0)                                                        |
| Freighter                         | `5.9.0`                                                                                                                            |
...
| Base de Stellar JS                | [`v10.0.0`](https://github.com/stellar/js-stellar-base/releases/tag/v10.0.0)                                                       |
...
| SDK JS Stellar de Stellar         | [`v11.0.0-beta.5`](https://github.com/stellar/js-stellar-sdk/releases/tag/v11.0.0-beta.5)                                          |
...
| Stellar Friendbot                        | `soroban-v0.0.2-alpha`                                                                                                             |
| Inicio Rápido de Stellar                 | `stellar/quickstart:soroban-dev@sha256:8a99332f834ca82e3ac1418143736af59b5288e792d1c4278d6c547c6ed8da3b`                           |
...
| Stellar Friendbot                 | `soroban-v0.0.2-alpha`                                                                                                             |
| Inicio Rápido de Stellar          | `stellar/quickstart:soroban-dev@sha256:a057ec6f06c6702c005693f8265ed1261e901b153a754e97cf18b0962257e872`                           |
...
| Núcleo Stellar                    | `19.7.1-1204.871accefc.focal~soroban`                                                                                              |
| SDK de Rust de Soroban            | `v0.6.0`                                                                                                                           |
| CLI de Soroban                    | `v0.6.0`                                                                                                                           |
| RPC de Soroban                    | `0.6.1-13`                                                                                                                         |
| Horizon Stellar                   | `stellar-horizon:2.24.61~soroban-335`                                                                                              |
| Stellar Friendbot                 | `soroban-v0.0.2-alpha`                                                                                                             |
