...
| XDR                                       | `v23.0`                                           |
| Rust XDR                                  | `v23.0.0`                                         |
| Entorno de host de contratos inteligentes | `tbd`                                             |
| Stellar Core                              | `v23.0.1`                                         |
| SDK de Rust para Contratos Inteligentes   | `v23.0.0-rc.3`                                    |
...
Nuevas características en el Protocolo 23:

- [Notas de publicación](https://github.com/stellar/stellar-core/releases/tag/v23.0.0rc4)
- Eventos unificados: [CAP-67](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0067.md)
- Archivado de estado: [CAP-62](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0062.md) e [CAP-66](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0066.md)

## Versión candidata del Protocolo 23 (solo Testnet, 17 de julio de 2025)
