...
| XDR                                       | `v23.0`                                           |
| Rust XDR                                  | `v23.0.0`                                         |
| Entorno de host de contratos inteligentes | `v23.0.2`                                         |
| Stellar Core                              | `v23.0.1`                                         |
| SDK de Rust para Contratos Inteligentes   | `v23.0.2`                                         |
...
| Stellar Core                           | `23.0.0`                                          |
| SDK Rust para contrato inteligente     | `23.0.0-rc.2.4`                                   |
...
| Horizonte de Stellar              | `v23.0.0-rc2`   | `debian: stellar-horizon:23.0.0~rc2-508`                                                               |
...
| Base Stellar JS                   | `v14.0.0-rc.2`  | `NPM: 14.0.0-rc.2`                                                                                     |
| SDK de Stellar JS                 | `v14.0.0-rc.3`  | `NPM: 14.0.0-rc.3`                                                                                     |
| Freighter                         | `n/a`           | `n/a`                                                                                                  |
| Laboratorio                       | `n/a`           | `n/a`                                                                                                  |
| Frase secreta de la red Futurenet | `n/a`           | `Test SDF Future Network ; octubre 2022`                                                               |
| Frase secreta de la red Testnet   | `n/a`           | `Test SDF Network ; septiembre 2015`                                                                   |
| Frase secreta de la red Mainnet   | `n/a`           | `Public Global Stellar Network ; septiembre 2015`                                                      |
...
| SDK Stellar JS                    | [`v11.0.1`](https://github.com/stellar/js-stellar-sdk/releases/tag/v11.0.1)                                                        |
...
| Base de Stellar JS              | [`v10.0.0-beta.3`](https://github.com/stellar/js-stellar-base/releases/tag/v10.0.0-beta.3)                                         |
...
| Base Stellar JS Stellar           | `8.2.2-soroban.12`                                                                                                                 |
...
| Stellar Friendbot                 | `soroban-v0.0.2-alpha`                                                                                                             |
| Inicio Rápido de Stellar          | `stellar/quickstart:soroban-dev@sha256:81c23da078c90d0ba220f8fc93414d0ea44608adc616988930529c58df278739`                           |
...
| Núcleo Stellar                    | `19.6.1-1158.c0ad35aa1.focal~soroban`                                                                                            |
| SDK de Rust de Soroban            | `v0.4.2`                                                                                                                         |
| CLI de Soroban                    | `v0.5.0`                                                                                                                         |
| RPC de Soroban                    | `0.4.0-10`                                                                                                                       |
| Horizon Stellar                   | `stellar-horizon:2.22.0~soroban-323`                                                                                             |
| Stellar Friendbot                 | `soroban-v0.0.2-alpha`                                                                                                           |
