...
El esquema XDR-JSON está definido por la [biblioteca stellar-xdr](https://docs.rs/stellar-xdr) y proporciona un método reversible para convertir valores Stellar [XDR] a JSON y convertir ese JSON de vuelta al XDR idéntico.
