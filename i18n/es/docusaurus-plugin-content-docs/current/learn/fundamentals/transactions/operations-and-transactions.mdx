...
Una transacción puede necesitar más de una firma: esto ocurre si tiene operaciones que afectan a más de una cuenta o si tiene un peso de umbral alto. Consulta la [entrada del enciclopedia sobre firma y multisisgnature](../../fundamentals/transactions/signatures-multisig.mdx) para más información.
