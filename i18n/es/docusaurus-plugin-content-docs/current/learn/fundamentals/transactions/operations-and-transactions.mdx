...
Para aprender más sobre el peso de la firma, consulta la [Entrada de la Enciclopedia de Firma y Multifirma](../../encyclopedia/security/signatures-multisig.mdx).
...
Una transacción puede necesitar más de una firma: esto ocurre si tiene operaciones que afectan a más de una cuenta o si tiene un peso de umbral alto. Consulta la [Entrada de la Enciclopedia de Firma y Multifirma](../../encyclopedia/security/signatures-multisig.mdx) para más información.
...
- [Lista de firmas](../../encyclopedia/security/signatures-multisig.mdx)
- [Memo o cuenta multiplexada](../../encyclopedia/transactions-specialized/pooled-accounts-muxed-accounts-memos.mdx)
...
Consulta la validez de la [Sección de Transacciones de Aumento de Tarifa](../../encyclopedia/transactions-specialized/fee-bump-transactions.mdx#validity-of-a-fee-bump-transaction)
