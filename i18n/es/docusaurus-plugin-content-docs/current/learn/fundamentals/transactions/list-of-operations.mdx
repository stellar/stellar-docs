...
Aprende más sobre los flags: [Entrada de la Enciclopedia de Flags](../../glossary.mdx#flags)\
Aprende más sobre el dominio de casa: [Propuestas del Ecosistema Stellar SEP-0001](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0001.md)\
Aprende más sobre las operaciones de firmantes y el peso de las claves: [Entrada de la Enciclopedia de Firmas y Multifirma](../../encyclopedia/security/signatures-multisig.mdx)
...
| Umbral bajo          | entero                | Un número del 0 al 255 (inclusive) que representa el umbral que esta cuenta establece en todas las operaciones que realiza que tienen [un umbral bajo](../../encyclopedia/security/signatures-multisig.mdx).                                                                                                                                                                                                                                                                                                                |
| Umbral medio         | entero                | Un número del 0 al 255 (inclusive) que representa el umbral que esta cuenta establece en todas las operaciones que realiza que tienen [un umbral medio](../../encyclopedia/security/signatures-multisig.mdx).                                                                                                                                                                                                                                                                                                               |
| Umbral alto          | entero                | Un número del 0 al 255 (inclusive) que representa el umbral que esta cuenta establece en todas las operaciones que realiza que tienen [un umbral alto](../../encyclopedia/security/signatures-multisig.mdx).                                                                                                                                                                                                                                                                                                                |
