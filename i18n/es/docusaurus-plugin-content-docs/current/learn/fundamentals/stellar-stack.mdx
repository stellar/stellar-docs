...
SDF no proporciona un punto final de RPC disponible públicamente para Mainnet. Los desarrolladores deben [seleccionar un proveedor de ecosistema](../../data/apis/api-providers.mdx) que funcione para su proyecto antes de migrar a Mainnet. En algunos casos, los proyectos pueden elegir ejecutar su propia instancia de RPC.
