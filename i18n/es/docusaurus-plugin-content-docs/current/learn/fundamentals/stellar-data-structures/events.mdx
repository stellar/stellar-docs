...
Para una demostración rápida y a alto nivel, usaremos el [SDK de TypeScript](../../../tools/sdks/README.mdx) para obtener infinitamente todos los eventos `transfer` (definidos por la [Interfaz de Token Soroban](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0041.md#interface)) que involucren el [contrato XLM](https://stellar.expert/explorer/testnet/contract/CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC) y mostrarlos en un formato amigable para humanos.
