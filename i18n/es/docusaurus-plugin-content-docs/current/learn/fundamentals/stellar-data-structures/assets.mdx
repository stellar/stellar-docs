...
El término "custom token" ha sido reemplazado por "contract token". Ve la conversación en el [Stellar Developer Discord](https://discord.com/channels/897514728459468821/966788672164855829/1359276952971640953).
...
Activos "Clásicos" emitidos por cuentas de Stellar (direcciones `G...`) y su implementación integrada del Contrato de Activos de Stellar (SAC), y tokens de contrato emitidos por un contrato Wasm desplegado (direcciones `C...`).
