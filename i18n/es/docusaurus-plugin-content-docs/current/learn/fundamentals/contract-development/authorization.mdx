...
Para la interfaz exacta y más detalles, consulta el [ejemplo de cuenta simple].

[Ejemplo de cuenta simple]: ../../../build/smart-contracts/example-contracts/simple-account.mdx
