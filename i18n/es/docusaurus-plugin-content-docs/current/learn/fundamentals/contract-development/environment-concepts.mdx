...
description: Aprende sobre la interfaz de entorno que define los objetos, funciones, fuentes de datos y más que están disponibles en los contratos inteligentes.
---
...
![Diagram Screenshot Screenshot](/assets/diagrams/environment-concepts.png)
