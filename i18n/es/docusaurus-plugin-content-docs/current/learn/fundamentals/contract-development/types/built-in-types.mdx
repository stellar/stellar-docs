...
description: Conoce los tipos incorporados disponibles en contratos inteligentes Soroban, incluyendo tipos primitivos, símbolos, bytes, cadenas, vecs, mapas y direcciones.
---
