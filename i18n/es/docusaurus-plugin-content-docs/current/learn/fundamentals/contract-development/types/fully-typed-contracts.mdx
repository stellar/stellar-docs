---
description: Todos los tipos de interfaz de contratos inteligentes estarán disponibles en la cadena inmediatamente, sin llamadas secundarias a APIs externas, sin gestión secundaria de APIs y mucho más.
sidebar_position: 30
