...
description: Consulta los tipos struct, union y enum que se pueden usar como entradas de contrato, salidas de contrato o para almacenamiento.
---
...
El [ejemplo de tipos personalizados] muestra cómo definir tus propios tipos.
