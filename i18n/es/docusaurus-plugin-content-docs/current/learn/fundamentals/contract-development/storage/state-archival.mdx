...
description: Aprende cómo funciona el archivado de estado en la plataforma de contratos inteligentes Soroban.
---
...
La entrada restaurada tendrá su live until ledger extendido al [mínimo](https://github.com/stellar/stellar-core/blob/2109a168a895349f87b502ae3d182380b378fa47/src/ledger/NetworkConfig.h#L77-L78) que la red permite para entradas recién creadas, que es `current_ledger_number + 4095` para entradas persistent. El valor mínimo de TTL es un parámetro de configuración de la red y puede actualizarse (probablemente aumentado) mediante actualizaciones de red.
