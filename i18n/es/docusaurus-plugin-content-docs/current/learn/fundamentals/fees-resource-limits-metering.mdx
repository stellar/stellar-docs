...
Las tarifas se deducen de la cuenta fuente a menos que haya una transacción de incremento de tarifas que indique lo contrario. Descubre sobre las transacciones de incremento de tarifas en la [sección de transacciones de aumento de tarifas](../encyclopedia/transactions-specialized/fee-bump-transactions.mdx).
