...
![Contador Migration Screenshot](/img/migrating/counter.png)
...
![Desplegar Migration Screenshot](/img/migrating/deploy-counter.png)

El contrato debería aparecer bajo la pestaña `Deployed Contracts`:

![Desplegado Migration Screenshot](/img/migrating/deployed-contracts.png)
...
![Incrementar Migration Screenshot](/img/migrating/increment.png)
