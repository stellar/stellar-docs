...
![Contador Migration Screenshot](/assets/migrating/counter.png)
...
![Desplegar Migration Screenshot](/assets/migrating/deploy-counter.png)

El contrato debería aparecer bajo la pestaña `Deployed Contracts`:

![Desplegado Migration Screenshot](/assets/migrating/deployed-contracts.png)
...
![Incrementar Migration Screenshot](/assets/migrating/increment.png)
