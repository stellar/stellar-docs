...
Usa el [Calculador de Patrocinio de Billeteras Stellar](../../../tools/developer-tools/wallets.mdx#stellar-wallet-sponsorship-calculator) para estimar los requisitos de XLM para billeteras que buscan usar reservas patrocinadas y transacciones con aumento de tarifas para cubrir la creación de cuentas, tarifas de transacción, líneas de confianza y más.
