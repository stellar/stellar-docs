...
Utiliza el [Calculador de patrocinio de billeteras Stellar](../../../tools/developer-tools/wallets.mdx#stellar-wallet-sponsorship-calculator) para estimar los requisitos de XLM para las billeteras que desean usar reservas patrocinadas y transacciones con aumento de tarifas para cubrir la creación de cuentas, las tarifas de transacción, las líneas de confianza y más.
