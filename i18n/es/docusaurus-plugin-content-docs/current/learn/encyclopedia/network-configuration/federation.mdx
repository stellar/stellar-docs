...
Para facilitar la configuración de un servidor de federación, puedes usar la [implementación de referencia](https://github.com/stellar/go-stellar-sdk/tree/master/services/federation) diseñada para ser integrada en tu infraestructura existente.
