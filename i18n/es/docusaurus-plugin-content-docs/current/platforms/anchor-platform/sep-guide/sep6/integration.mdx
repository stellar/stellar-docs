...
Puedes obtener más información sobre el flujo y los estados de la transacción en el [documento del protocolo SEP-6](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0006.md).
