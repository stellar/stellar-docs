...
Para cambiar a la red pública (mainnet) de Stellar, todo lo que tienes que hacer es cambiar la [frase de contraseña](/docs/networks#network-passphrases) de la red (para autenticar peticiones) y la [URL de Horizon](https://horizon.stellar.org/).
