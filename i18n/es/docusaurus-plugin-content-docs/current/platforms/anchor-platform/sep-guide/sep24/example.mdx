...
Ejecuta esto junto con el servidor de la plataforma y la base de datos, e inicia una nueva transacción con la [demo wallet](https://demo-wallet.stellar.org). Luego, enviaremos el token a nuestro servidor.
...
El código para la UI web puede encontrarse [aquí](https://github.com/stellar/sep24-reference-ui).

El código para el backend forma parte de Anchor Platform, y está disponible como un [submódulo](https://github.com/stellar/java-stellar-anchor-sdk/tree/develop/kotlin-reference-server).
