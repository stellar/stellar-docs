...
**Probar Tu Configuración**: Puedes probar la autenticación SEP-10 usando curl y Stellar CLI. Para más información sobre Stellar CLI, consulta la [documentación de Stellar CLI](https://developers.stellar.org/docs/tools/cli).
