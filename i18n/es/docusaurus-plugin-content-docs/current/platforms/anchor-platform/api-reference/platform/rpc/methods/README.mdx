...
Esta sección enumera los métodos de la API JSON-RPC de Anchor Platform que deben ser invocados por los clientes Stellar para actualizar el estado de la transacción.
