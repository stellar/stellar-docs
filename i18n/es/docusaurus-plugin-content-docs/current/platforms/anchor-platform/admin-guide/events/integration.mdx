...
Anchor Platform solo enviará eventos a clientes listados en la configuración de clientes. Consulta la [documentación de configuración de clientes][clients-config] para más información.
