...
- **Servicio Central SDP**: el servicio principal de backend que realiza varias funciones:
  ...
  - **API Admin**: la API que usa la organización anfitriona para administrar la provisión y configuración de inquilinos. La API está documentada [aquí](../api-reference/admin.tag.mdx)
