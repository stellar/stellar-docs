...
Aquí cubriremos una selección de los comandos y la sintaxis _esenciales_, pero el **mejor recurso** para utilizar la línea de comandos `stellar-core` se encuentra en el [repositorio de GitHub de stellar-core](https://github.com/stellar/stellar-core/blob/master/docs/software/commands.md).
...
Para reiterar, esta página cubre una selección de los comandos _esenciales_, pero solo hemos rozado la superficie. El **mejor, más completo recurso** para utilizar la línea de comandos `stellar-core` se encuentra en el [repositorio de GitHub de stellar-core](https://github.com/stellar/stellar-core/blob/master/docs/software/commands.md).
