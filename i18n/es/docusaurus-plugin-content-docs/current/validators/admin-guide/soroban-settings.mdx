...
[binario precompilado]: https://github.com/stellar/stellar-cli/releases/latest
[página del historial de protocolo]: https://stellar.expert/explorer/pubnet/protocol-history
