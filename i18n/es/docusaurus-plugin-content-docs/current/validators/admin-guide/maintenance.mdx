...
1. Apaga stellar-core correctamente: `sudo systemctl stop stellar-core`
2. `apt list --upgradable | grep postgresql`
3. `sudo apt-get install postgresql-16 postgresql-client-16 # o el paquete de versión específica`
4. Reinicia stellar-core: `sudo systemctl start stellar-core`
5. Espera a que el core se sincronice: `stellar-core-cmd info`
