...
- El `HTTP_PORT` es utilizado por otros sistemas (como Horizon) para enviar transacciones, así que este puerto puede tener que ser expuesto al resto de tus direcciones IP internas.
