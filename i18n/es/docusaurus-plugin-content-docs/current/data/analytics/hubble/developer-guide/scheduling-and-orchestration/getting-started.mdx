...
import history_table_export from "/img/hubble/history-table-export.png";
import state_table_export from "/img/hubble/state-table-export.png";
import dbt_enriched_base_tables from "/img/hubble/dbt-enriched-base-tables.png";
...
![Alternar DAGs Screenshot](/img/hubble/airflow-dag-toggle.png)
