...
description: Entrada del diccionario de datos de Hubble para la tabla Instantánea de claves desalojadas (capa Silver), incluyendo metadatos de la tabla y definiciones de columnas.
---
