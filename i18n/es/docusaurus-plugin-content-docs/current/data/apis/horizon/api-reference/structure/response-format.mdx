...
Si una respuesta es un único registro, la sección `_links` proporcionará enlaces a los registros padres o hijos, y no habrá propiedad `_embedded`.

Si una respuesta es una colección, la sección `_links` proporcionará enlaces de [paginación](./pagination/README.mdx), y la lista de registros de la respuesta estará anidada debajo de la propiedad `_embedded`.
...
<ExampleResponse title="Respuesta de ejemplo">
