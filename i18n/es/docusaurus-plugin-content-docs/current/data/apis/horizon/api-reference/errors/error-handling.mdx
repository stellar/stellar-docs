...
- Los costos de transacción también son un ajuste seguro al modificar los costos a través de una [transacción de fee-bump](../../../../../learn/encyclopedia/transactions-specialized/fee-bump-transactions.mdx) si recibes un error `tx_insufficient_fee`. Consulta la sección [Costos Insuficientes y Precios Altos](#insufficient-fees-and-surge-pricing) más adelante en este documento para obtener más información sobre la gestión de costos y estrategias al respecto.
