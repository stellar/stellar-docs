...
Para el desarrollo local, recomendamos [descargar](https://hub.docker.com/r/stellar/quickstart) y ejecutar una instancia local a través de [Docker Quickstart](https://github.com/stellar/quickstart) y ejecutar una red local o comunicarte con un [Testnet] de desarrollo en vivo.
