...
3. **Configurar backend de Ledger:** Configura cómo se lee la información del almacenamiento de datos a través de [BufferedStorageBackend](../../../../data/indexers/build-your-own/ingest-sdk/developer_guide/ledgerbackends/bufferedstoragebackend.mdx).
