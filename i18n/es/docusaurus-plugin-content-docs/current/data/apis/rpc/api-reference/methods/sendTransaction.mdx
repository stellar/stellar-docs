...
A diferencia de Horizon, este método **no espera confirmación**. En cambio, **valida y encola** la transacción. Para seguir su resultado final, los clientes deben hacer un seguimiento con una llamada a [`getTransaction`](/docs/data/apis/rpc/api-reference/methods/getTransaction).
...
![Laboratorio: sendTransaction](/assets/api/rpc/sendtransaction.gif)
