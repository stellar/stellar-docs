...
Stellar-RPC aceptará solicitudes HTTP POST utilizando la especificación [JSON-RPC <b>2.0</b>]. Los errores se devuelven a través del [jsonrpc error object] siempre que sea posible (y tenga sentido).
...
[JSON-RPC <b>2.0</b>]: https://www.jsonrpc.org/specification
...
[métodos]: ../métodos
[documento de especificación aquí]: https://raw.githubusercontent.com/stellar/stellar-docs/main/static/stellar-rpc.openrpc.json
