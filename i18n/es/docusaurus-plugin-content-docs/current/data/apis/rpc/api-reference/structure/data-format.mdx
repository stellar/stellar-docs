...
En la red Stellar, las transacciones se codifican utilizando un protocolo estandarizado llamado [External Data Representation](../../../../../learn/fundamentals/data-format/xdr.mdx) (XDR).
