...
[BufferedStorageBackend](https://github.com/stellar/go-stellar-sdk/blob/main/ingest/ledgerbackend/buffered_storage_backend.go) es un backend de ledger en el [ingest SDK](https://github.com/stellar/go-stellar-sdk/tree/main/ingest) de Stellar que recupera metadatos del ledger desde un lago de datos en la nube, típicamente completada por [Galexie](/docs/data/indexers/build-your-own/galexie). Aunque Galaxie actualmente sólo admite [GCS](/docs/data/indexers/build-your-own/galexie/admin_guide/configuring), `BufferedStorageBackend` está diseñado para funcionar con cualquier almacén de datos que implemente la [interfaz de datastore](https://github.com/stellar/go-stellar-sdk/blob/main/support/datastore/datastore.go). Devuelve metadatos del ledger en formato [XDR](https://developers.stellar.org/docs/learn/encyclopedia/data-format/xdr).
