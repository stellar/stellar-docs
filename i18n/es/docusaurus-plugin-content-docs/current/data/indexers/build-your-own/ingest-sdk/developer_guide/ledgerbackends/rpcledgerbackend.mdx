...
El [RPCLedgerBackend](https://github.com/stellar/go-stellar-sdk/blob/master/ingest/ledgerbackend/rpc_backend.go) es una implementación de [LedgerBackend](https://github.com/stellar/go-stellar-sdk/blob/master/ingest/ledgerbackend/ledger_backend.go) en el [SDK de Ingesta](https://github.com/stellar/go-stellar-sdk/tree/master/ingest) de Stellar que utiliza un Servidor RPC como fuente de metadatos del ledger.

Las aplicaciones pueden usar este backend de ledger para obtener metadatos del ledger de la red Stellar a través de los métodos estándar de la interfaz [LedgerBackend](https://github.com/stellar/go-stellar-sdk/blob/master/ingest/ledgerbackend/ledger_backend.go). Este backend de ledger se considera el más ligero entre los disponibles ya que solo requiere un cliente HTTP para acceder a un servidor RPC remoto.
