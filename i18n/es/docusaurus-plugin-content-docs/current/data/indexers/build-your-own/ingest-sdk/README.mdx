...
Accede a todas las transacciones y sus operaciones anidadas que se incluyeron en cada ledger cerrado. También contiene los cambios (antes y después) para cada entrada del libro mayor cuando se modifican debido a la actividad de la transacción y todos los [eventos de contrato Soroban](../../../../learn/fundamentals/stellar-data-structures/events.mdx) emitidos como resultado de las invocaciones de [contrato](../../../../learn/fundamentals/stellar-data-structures/contracts.mdx) durante la ejecución de la transacción. Es, efectivamente, un registro de confirmación para las entradas de ledger.
