...
Accede a todas las transacciones y sus operaciones anidadas que se incluyeron en cada ledger cerrado. También contiene los cambios (antes/después) de cada entrada del libro mayor cuando se modifica debido a la actividad de una transacción y todos los [eventos de contrato Soroban](../../../../learn/fundamentals/events.mdx) emitidos como resultado de las invocaciones de [contratos](../../../../learn/fundamentals/stellar-data-structures/contracts.mdx) durante la ejecución de la transacción. Es, efectivamente, un registro de confirmación para las entradas de ledger.
