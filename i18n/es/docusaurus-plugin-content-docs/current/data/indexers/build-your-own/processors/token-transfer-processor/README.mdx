...
Antes de [CAP-67 Eventos Unificados](https://stellar.org/protocol/cap-67), rastrear transferencias de tokens requería lógica personalizada significativa para manejar distintos tipos de operaciones, interpretar cambios en el ledger y reconstruir el flujo de activos. CAP-67 introdujo un formato estandarizado de eventos que simplifica este proceso al proporcionar una manera unificada de representar todas las actividades de transferencia de tokens.
...
- Captura movimientos de tokens resultantes de:
  ...
  - Eventos de token compatibles con [SEP-41](https://stellar.org/protocol/sep-41)
...
| `operationIndex`  | `uint32*` | El índice uno basado en la operación dentro de la transacción que causó este evento según se define en [SEP-35](https://stellar.org/protocol/sep-35). Este campo es `nil` para eventos a nivel de transacción como las tarifas.                                                                                             |
...
- [CAP-67: Eventos unificados](https://stellar.org/protocol/cap-67)
- [SEP-41: Especificación de Contrato de Token de Activo](https://stellar.org/protocol/sep-41)
- [CAP-38: Creadores de Mercado Automatizados](https://stellar.org/protocol/cap-38)
- [SEP-35: Esquema de ID para operaciones Stellar](https://stellar.org/protocol/sep-35)
