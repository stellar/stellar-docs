...
Antes de [CAP-67 Eventos Unificados](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0067.md), rastrear transferencias de tokens requería lógica personalizada significativa para manejar distintos tipos de operaciones, interpretar cambios en el ledger y reconstruir el flujo de activos. CAP-67 introdujo un formato estandarizado de eventos que simplifica este proceso al proporcionar una manera unificada de representar todas las actividades de transferencia de tokens.
...
- Captura movimientos de tokens resultantes de:
  ...
  - Eventos de token compatibles con [SEP-41](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0041.md)
...
| `operationIndex`  | `uint32*` | El índice uno basado en la operación dentro de la transacción que causó este evento según se define en [SEP-35](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0035.md). Este campo es `nil` para eventos a nivel de transacción como las tarifas.                                                                                             |
...
Consulta [esta](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0067.md#prohibit-the-transaction-memo-and-muxed-source-accounts-from-being-set-on-soroban-transactions) sección en CAP-67 para saber más sobre qué esperar en el campo `toMuxedInfo`.
...
- [CAP-67: Eventos unificados](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0067.md)
- [SEP-41: Especificación de Contrato de Token de Activo](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0041.md)
- [CAP-38: Creadores de Mercado Automatizados](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0038.md)
- [SEP-35: Esquema de ID para operaciones Stellar](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0035.md)
