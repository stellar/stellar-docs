---
title: El objeto de agregación comercial
sidebar_position: 10
---
...
Cuando Horizon devuelve información sobre una agregación de intercambio, utiliza el siguiente formato:
...
- fecha
  - cadena
  - Hora de inicio de esta agregación comercial. Representado como milisegundos desde el époco.
- contador_comercio
  - entero
...
- volumen_contador
  - cadena
  - Volumen total del activo contador.
- media
  - cadena
  - Precio medio ponderado de los activos contrarios en términos de activo base.
- alto
  - cadena
  - El precio más alto para este periodo de tiempo.
- alta
  - objeto
  - El precio más alto para este período de tiempo como un número racional.
    - n
      - número
      - El numerador.
    - d
...
- bajo
  - cadena
  - El precio más bajo para este periodo de tiempo.
- bajo_r
  - objeto
  - El precio más bajo para este período de tiempo como un número racional.
    - n
      - número
      - El numerador.
    - p
...
- abierto
  - cadena
  - El precio tal como se ve en el primer comercio agregado.
- abrir_r
  - objeto
  - El precio tal y como se ve en el primer comercio se agregó como un número racional.
    - n
      - número
      - El numerador.
    - p
...
- cerrar
  - cadena
  - El precio tal como se vio en el último comercio agregado.
- cerrar_r
  - objeto
  - El precio tal como se vio en el último comercio se agregó como un número racional.
    - n
      - número
      - El numerador.
    - p
