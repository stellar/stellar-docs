...
- <https://horizon-testnet.stellar.org/> for interacting with the [testnet](../../learn/fundamentals/networks.mdx)
- <https://horizon-futurenet.stellar.org/> for interacting with the [futurenet](../../learn/fundamentals/networks.mdx)
