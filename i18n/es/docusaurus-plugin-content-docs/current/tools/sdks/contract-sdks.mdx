...
Solang es un compilador basado en llvm para Solidity que puede dirigirse a múltiples blockchains, incluyendo Stellar.

Los ejemplos admitidos de Solidity se pueden encontrar dentro del [repositorio Solang](https://github.com/hyperledger-solang/solang/tree/main/examples/soroban).
...
Consulta la página de [OpenZeppelin para Contratos Stellar](../openzeppelin-contracts.mdx#openzeppelin-stellar-contracts-and-utilities) para obtener información adicional.
