...
- `stellar-xdr` – [Code](https://github.com/stellar/rs-stellar-xdr) | [Docs](https://docs.rs/stellar-xdr)
  ...
  Proporciona codificación/decodificación [XDR](../../learn/fundamentals/data-format/xdr) e implementación de referencia de [XDR-JSON](../../learn/fundamentals/data-format/xdr-json.mdx). **Mantenido por SDF.**

- `stellar-strkey` – [Código](https://github.com/stellar/rs-stellar-strkey) | [Docs](https://docs.rs/stellar-strkey)

  Proporciona codificación/decodificación de Stellar Strkey (Dirección) [SEP-23](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0023.md). **Mantenido por SDF.**
...
Este SDK está dividido en paquetes separados, todos los cuales puedes encontrar en el [Go SDK](https://github.com/stellar/go-stellar-sdk). Las bibliotecas clave son:

- `txnbuild` [SDK](https://github.com/stellar/go-stellar-sdk/tree/main/txnbuild) | [Documentación](https://godoc.org/github.com/stellar/go-stellar-sdk/txnbuild): permite la construcción, firma y codificación de transacciones Stellar.
- `Horizon Client` [SDK](https://github.com/stellar/go-stellar-sdk/tree/main/clients/horizonclient) | [Documentación](https://godoc.org/github.com/stellar/go-stellar-sdk/clients/horizonclient): proporciona un cliente web para interactuar con los puntos finales REST del servidor Horizon para recuperar información del ledger y enviar transacciones desarrolladas con `txnbuild`.
