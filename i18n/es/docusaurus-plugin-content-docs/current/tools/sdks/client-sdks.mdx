...
Este SDK está dividido en paquetes separados, todos los cuales puedes encontrar en el [README del monorepo de Go](https://github.com/stellar/go-stellar-sdk/blob/master/docs/reference/readme.md). Las bibliotecas clave son:

- `txnbuild` [SDK](https://github.com/stellar/go-stellar-sdk/tree/master/txnbuild) | [Docs](https://godoc.org/github.com/stellar/go-stellar-sdk/txnbuild): permite la construcción, firma y codificación de transacciones de Stellar.
- `Horizon Client` [SDK](https://github.com/stellar/go-stellar-sdk/tree/master/clients/horizonclient) | [Docs](https://godoc.org/github.com/stellar/go-stellar-sdk/clients/horizonclient): proporciona un cliente web para interactuar con los puntos finales REST del servidor Horizon para recuperar información del ledger y enviar transacciones construidas con `txnbuild`.
