...
1. Instala [Visual Studio Code](https://code.visualstudio.com) (VSCode)

2. Instala la [extensión Jupyter Notebook](https://marketplace.visualstudio.com/items?itemName=ms-toolsai.jupyter) en VSCode
...
![Un Cuaderno de Jupyter en](/assets/dev-tools/jupyter-notebooks.png)

## Comunidad

¿Tienes ideas sobre cómo mejorar los contratos Soroban en Jupyter Notebooks? Únete a la comunidad en [Discord](https://discord.com/channels/897514728459468821/1263811925813366794).
