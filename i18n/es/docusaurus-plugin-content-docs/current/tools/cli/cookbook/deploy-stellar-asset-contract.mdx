...
El CLI de Stellar puede implementar un [Stellar Asset Contract](../../../tokens/stellar-asset-contract.mdx) para un activo Stellar de modo que cualquier contrato inteligente de Stellar pueda interactuar con el activo.
...
Lo mismo puede hacerse para el activo nativo [Lumens](../../../learn/fundamentals/lumens.mdx):
