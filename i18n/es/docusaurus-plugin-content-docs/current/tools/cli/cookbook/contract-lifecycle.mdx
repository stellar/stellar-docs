...
Para aprender más sobre cómo construir archivos `.wasm` para contratos, consulta nuestro [tutorial de introducción](https://developers.stellar.org/docs/build/smart-contracts/getting-started/setup).
