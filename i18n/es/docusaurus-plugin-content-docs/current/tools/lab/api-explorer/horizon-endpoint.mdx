...
![Lab P Gina de Horizon](/assets/lab/horizon/endpoints.png)
...
![Lab Horizon Ver Docs](/assets/lab/horizon/view-docs.png)
...
![Lab Horizon Cuenta Nica](/assets/lab/single-account.png)
...
![Lab Horizon Respuesta de Cuenta](/assets/lab/single-account-response.png)
...
![Lab Horizon P Gina de](/assets/lab/horizon/assets.png)
...
![Lab Horizon P Gina de](/assets/lab/horizon/assets-usdc.png)

Cuando hago clic en el botón **Enviar**, el punto final `/assets` devuelve los detalles del activo `USDC` en formato `JSON`.

![Lab Horizon P Gina de](/assets/lab/horizon/assets-usdc-response.png)

La respuesta JSON para el activo `USDC` incluye [el objeto asset](../../../data/apis/horizon/api-reference/resources/assets/object.mdx), que contiene detalles sobre USDC, como el archivo TOML del activo (también conocido como [el archivo de información Stellar](../../../tokens/publishing-asset-info.mdx)), el número de saldos reclamables, pools de liquidez, contratos, cuentas, balances y flags.
...
![Lab Horizon Funci N Compartir](/assets/lab/horizon/share.png)
...
Los endpoints guardados se encuentran en el menú principal bajo el menú "Guardados", en el submenú "[Solicitudes](../saved/requests.mdx)".
