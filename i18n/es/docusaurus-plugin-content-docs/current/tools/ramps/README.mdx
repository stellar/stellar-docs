...
Puedes configurar un anchor usando la [Anchor Platform](../../platforms/anchor-platform/README.mdx) mantenida por SDF, que es la forma más fácil de desplegar un servicio de anchor compatible con las Propuestas del Ecosistema Stellar (SEP).
