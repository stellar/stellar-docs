...
## Checkpoint 3: 🌟 Powering the Campaign {#checkpoint-3--powering-the-campaign}
...
#### Open Dapp and Mint {#open-dapp-and-mint}
...
#### Fund the Campaign {#fund-the-campaign}
...
#### Check Updated Pledged Amount {#check-updated-pledged-amount}
...
{/* <CompleteStepButton id={0} progress={2}>Funding completed</CompleteStepButton> */}
...
## Checkpoint 5: 💪 Pass the Challenge! {#checkpoint-5--pass-the-challenge}
...
## Checkpoint 6: ✅ Check your work! {#checkpoint-6--check-your-work}
...
🌐 Explore [Stellar Lab] to inspect your account assets on Futurenet.
