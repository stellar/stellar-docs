...
## Checkpoint 1: 📝 Setup the `initialize.sh` Script {#checkpoint-1--setup-the-initializesh-script}
...
## Checkpoint 3: ⏯️ Create a CRON task {#checkpoint-3-️-create-a-cron-task}
...
## Checkpoint 4: 🤝 Connect the Frontend to the Backend {#checkpoint-4--connect-the-frontend-to-the-backend}
...
## Checkpoint 5: 🧿 Oracle Insights {#checkpoint-5--oracle-insights}
...
#### Deposit into the Donation Contract {#deposit-into-the-donation-contract}
...
## Checkpoint 6: 🚢 Ship it! 🚁 {#checkpoint-6--ship-it-}
...
## Checkpoint 7: 💪 Pass the Challenge! {#checkpoint-7--pass-the-challenge}
...
## Checkpoint 8: ✅ Check your work! {#checkpoint-8--check-your-work}
