...
clients:
  ...
  #   - signing_keys: (required) the custodial SEP-10 signing key of the client. In the existence of signing_keys, the signing_key field is ignored.
  #   - signing_key: (optional) DEPRECATED in favour of signing_keys. the custodial SEP-10 signing key of the client.
  ...
  #   - domain: (optional) DEPRECATED in favour of domains. the domain of the client. In the existence of domains, the domain field is ignored.
  #   - callback_url: (optional) the URL of the client's callback API endpoint
  ...
  - name: custodial-client1
    ...
    signing_key: "the signing key will be ignored"
  ...
  - name: noncustodial-client1
    ...
    domain: theDomainWillBeIgnored.com
...
CLIENTS[0]_SIGNING_KEY="the signing key will be ignored"
...
CLIENTS[2]_DOMAIN=theDomainWillBeIgnored.com
