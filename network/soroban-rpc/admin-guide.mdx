...
For example, you can build an application and have it [send a transaction](./methods/sendTransaction.mdx), [get ledger](./methods/getLedgerEntries.mdx) and [event data](./methods/getEvents.mdx), or [simulate transactions](./methods/simulateTransaction.mdx).
...
[Run on Sandbox]: /docs/getting-started/hello-world#run-on-sandbox
