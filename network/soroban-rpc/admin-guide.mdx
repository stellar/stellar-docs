...
It's also possible to run a contract in the local sandbox environment without a network using just the Rust testing harness. See [Run the Tests] for more details.
...
[Run the Tests]: /docs/smart-contracts/getting-started/hello-world#run-the-tests
