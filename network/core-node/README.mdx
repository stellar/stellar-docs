...
5. [Prepare](./admin-guide/environment-preparation.mdx) your node instance and environment. This includes settingt up your node to [publish history archives](./admin-guide/publishing-history-archives.mdx) of the ledger.
...
10. [Soroban settings](./admin-guide/soroban-settings.mdx) are network-wide, configurable, and changes can be proposed by anyone. Similar to protocol upgrades, changes to these settings will require validator consensus.
