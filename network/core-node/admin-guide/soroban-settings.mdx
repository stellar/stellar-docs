...
Soroban has a large collection of settings stored on-ledger that can be modified through a validator vote. Headers, we will describes how you can propose a new settings upgrade, and how to examine a proposed upgrade. You can also look at the [Commands page](./commands.mdx) for more details on the stellar-core commands used below.
