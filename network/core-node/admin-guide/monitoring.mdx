...
- `network` is the [network passphrase](/docs/encyclopedia/network-passphrases) that this core instance is using to decide whether to connect to the testnet or the public network
