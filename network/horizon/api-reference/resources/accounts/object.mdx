...
- sequence_ledger
  - number
  - The unsigned 32-bit ledger number of the sequence number's [age](../../../../../docs/learn/glossary/#sequence-number).
- sequence_time
  - string
  - The unsigned 64-bit UNIX timestamp of the sequence number's [age](../../../../../docs/learn/glossary/#sequence-number).
- subentry_count
  - number
