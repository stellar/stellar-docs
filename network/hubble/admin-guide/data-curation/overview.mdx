...
Data curation in Hubble is done through [stellar-dbt-public](https://github.com/stellar/stellar-dbt-public). stellar-dbt-public transforms base Stellar network data from BigQuery datasets and tables into aggregates and more user analytics friendly tables.
